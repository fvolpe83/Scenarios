Name=1wall9000targets small hesitation therapy
...
WeaponHeroTag=LG
DifficultyTag=2
AuthorsTag=bozott, Lac, blally
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=true
Description=improve fine motor control with your mouse. its 1wall9000targets small but with the LG, no penalty for inaccuracy. recommended for those stuggling with hesitant/slow microflicks when aiming at small targets.
GameVersion=1.0.8.0
