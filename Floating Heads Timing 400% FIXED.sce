...
AddedBots=TileFrenzyStrafing Cube.bot;TileFrenzyStrafing Cube.bot;TileFrenzyStrafing Cube.bot;TileFrenzyStrafing Cube.bot;TileFrenzyStrafing Cube.bot;TileFrenzyStrafing Cube.bot
PlayerMaxLives=0
...
DifficultyTag=4
AuthorsTag=maruta, Huddled, Pauer
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Click the floating heads! No accuracy multiplier, ammo is reloaded on kill. Fixed inconsistent speed at low fps, FOV lock
GameVersion=2.0.2.0
