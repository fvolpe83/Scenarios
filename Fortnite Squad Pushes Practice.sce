Name=Fortnite Squad Pushes Practice
...
GameTag=Fortnite Squad Pushes Practice
WeaponHeroTag=Pistol
DifficultyTag=2
AuthorsTag=twerkopolis
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=There are 4 targets that are pushing from different angles. Practice Flicks and taps.
GameVersion=1.0.6.2
