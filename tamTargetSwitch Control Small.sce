Name=tamTargetSwitch Control Small
...
BlockFCT=false
Description=Small regenerating dots wiggle back and forth around you, 0.5s ttk, up to 1s to regen to full, starts regening 0.3s after going off target, ~50% less 2d surface area
GameVersion=2.0.2.0
