Name=Close Long Strafes Thin Invincible Headshots
...
DifficultyTag=4
AuthorsTag=KovaaK, Huddled, banDiscord, Aeshteticgoose, Watsyurdeal
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Close Long Strafes, but now you aim for the head. Simple right?
GameVersion=2.0.2.0
