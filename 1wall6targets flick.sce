Name=1wall6targets flick
PlayerCharacters=TileFrenzy Challenger;TileFrenzy Weapon Overrides;TileFrenzy Zooms 10sec
BotCharacters=TileFrenzy Cube.bot;TileFrenzy Sphere.bot;target.bot
IsChallenge=true
Timelimit=30.0
...
BlockFCT=true
Description=Flick as fast as you can. Work on training acceleration. 
GameVersion=2.0.0.1
