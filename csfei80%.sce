Name=csfei80%
PlayerCharacters=Quaker80%
BotCharacters=Quaker Bot Fast Strafes 80%.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Quaker80%
AddedBots=Quaker Bot Fast Strafes 80%.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=2
...
DifficultyTag=2
AuthorsTag=KovaaK, patys, Huddled
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Close fast strafes easy invincible but 20% slower
GameVersion=2.0.2.0
...
[Bot Profile]
Name=Quaker Bot Fast Strafes 80%
