Name=patTargetSwitch 360 Small reload 3clip
...
BlockFCT=false
Description=A classic's classic reinvented using patented map adjustment tech. Truely an innovation in target switching.
GameVersion=2.0.1.0
