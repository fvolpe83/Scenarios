Name=Wide Wall 5 Targets Distanced - Small
...
BlockFCT=false
Description=Five small distanced targets spawn on a wide wall, spread apart and just within view. No significant clustering.
GameVersion=2.0.2.0
