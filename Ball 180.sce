...
BotCharacters=Regenerating Ball.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=NoOffset
AddedBots=Regenerating Ball.bot;Regenerating Ball.bot;Regenerating Ball.bot;Regenerating Ball.bot;Regenerating Ball.bot;Regenerating Ball.bot
PlayerMaxLives=0
...
BlockFCT=true
Description=Pokeball Frenzy Auto but it's Tile Frenzy 180 and has no pokeballs
GameVersion=2.0.0.2
...
UseWeapons=false
CharacterProfile=Regenerating Ball
