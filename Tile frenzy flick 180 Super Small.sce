Name=Tile frenzy flick 180 Super Small
PlayerCharacters=TileFrenzy Challenger
BotCharacters=TileFrenzy Cube.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=TileFrenzy Challenger
AddedBots=TileFrenzy Cube.bot;TileFrenzy Cube.bot;TileFrenzy Cube.bot;TileFrenzy Cube.bot;TileFrenzy Cube.bot;TileFrenzy Cube.bot;TileFrenzy Cube.bot
PlayerMaxLives=0
...
BlockFCT=false
Description=tile frenzy 180 but bots have 4hp and u have a 20dps lg 
GameVersion=1.0.8.0
