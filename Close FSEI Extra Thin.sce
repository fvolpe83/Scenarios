Name=Close FSEI Extra Thin
PlayerCharacters=Quaker
BotCharacters=Close FSEI Extra thin.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Quaker
AddedBots=Close FSEI Extra thin.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=2
...
DifficultyTag=4
AuthorsTag=KovaaK, patys, Huddled, creator code elo
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Close FSEI but target is extra thin + slowed groundspeed to train precision + smoothness
GameVersion=1.0.7.2
...
UseWeapons=false
CharacterProfile=Close FSEI Extra Thin char
...
[Character Profile]
Name=Close FSEI Extra Thin char
MaxHealth=300.0
WeaponProfileNames=;;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
