Name=Hyper Scape Bounce Tracking 360
...
GameTag=Hyper Scape, Overwatch, Quake
WeaponHeroTag=Minigun
DifficultyTag=2
AuthorsTag=Popoon
...
BlockFCT=false
Description=To help vertical tracking in all directions
GameVersion=2.0.1.2
...
MaxHealth=100.0
WeaponProfileNames=Popoon Minigun;;;;;;;
MinRespawnDelay=0.1
MaxRespawnDelay=0.1
StepUpHeight=75.0
