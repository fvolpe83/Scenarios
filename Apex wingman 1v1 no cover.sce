Name=Apex wingman 1v1 no cover
PlayerCharacters=Apex purple armor wingman kill hp recover
BotCharacters=Apex_hard_bot_Wingman.bot
IsChallenge=true
Timelimit=90.0
PlayerProfile=Apex purple armor wingman kill hp recover
AddedBots=Apex_hard_bot_Wingman.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=2
BotTeams=1
...
BlockFCT=false
Description=Apex wingman against wingman bot without any cover, hp cover when kills
GameVersion=2.0.2.0
...
[Character Profile]
Name=Apex purple armor wingman kill hp recover
MaxHealth=200.0
