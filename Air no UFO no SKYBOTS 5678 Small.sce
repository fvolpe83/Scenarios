Name=Air no UFO no SKYBOTS 5678 Small
PlayerCharacters=A
BotCharacters=Bot Rotation air 5678.rot
IsChallenge=true
Timelimit=1000.0
PlayerProfile=A
AddedBots=Bot Rotation air 5678.rot
PlayerMaxLives=0
BotMaxLives=4
PlayerTeam=1
BotTeams=2
...
BlockFCT=false
Description=Air no UFO no SKYBOTS Small, bots 5 6 7 8 only.
GameVersion=2.0.1.2
