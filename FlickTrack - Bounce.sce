...
GameTag=Track, Bounce, LG, RL, Pistol, Plasma Gun
WeaponHeroTag=Pistol/LG/RL/Plasma Gun
DifficultyTag=2
AuthorsTag=Faleene
...
BlockFCT=false
Description=Track bouncing targets.  Pistol/LG/RL/Plasma Gun
GameVersion=1.0.6.2
...
Name=Player
MaxHealth=100.0
WeaponProfileNames=pistol;LG;Low speedaoe RL;Plasma Gun;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=3.0
StepUpHeight=30.0
...
ChargeTimeToCap=1.0
ChargeMoveSpeedModifier=1.0
MuzzleVelocityMin=X=3600.000 Y=0.000 Z=0.000
MuzzleVelocityMax=X=3600.000 Y=0.000 Z=0.000
InheritOwnerVelocity=0.0
...
InheritOwnerVelocity=0.0
OriginOffset=X=22.000 Y=0.000 Z=0.000
MaxTravelTime=2.0
MaxHitscanRange=100000.0
GravityScale=0.0
HeadshotCapable=false
