...
BlockFCT=false
Description=Wingman 1v1 against bot(R-99,PK or Wingman) at normal level in dust2 A
GameVersion=2.0.1.2
...
AimingProfileNames=Medium Skill;Medium Skill At Feet;Low Skill;High Skill;Default;Default;Default;Default
...
Name=Apex 3 bot
ProfileNames=Apex_bot_PK;Apex_bot_R-99;Apex_bot_Wingman
...
MaxHealth=200.0
WeaponProfileNames=;Peacekeeper;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
CrouchHeightModifier=0.5
