Name=Close LS Easy Dodge Scattergun TF2
...
WeaponHeroTag=Scattergun
DifficultyTag=3
AuthorsTag=master, Ran33 and Close LS Easy Dodge original map makers
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=strafe map with the scattergun weapon (TF2)
GameVersion=1.0.8.0
...
UseWeapons=false
CharacterProfile=Quaker LS Bot
