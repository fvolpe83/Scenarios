...
BlockFCT=false
Description=Bots regen hp if you miss... Get clean strings of hits to kill. move for a bonus
GameVersion=1.0.7.2
...
DamageReactionMinimumDelay=0.3
DamageReactionMaximumDelay=0.6
DamageReactionCooldown=0.7
