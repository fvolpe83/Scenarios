...
BlockFCT=false
Description=A nimble bot with various close range strafing profiles
GameVersion=2.0.2.0
...
[Bot Profile]
Name=Quaker Evasive
DodgeProfileNames=Close Evasive Short;Close Evasive Slow;Close Evasive;Skrrt
DodgeProfileWeights=2.0;0.7;1.0;0.7
...
JetpackMaxZVelocity=400.0
JetpackAirControlWithThrust=0.25
AbilityProfileNames=Evasive dash.abilmov;;;
HideWeapon=true
AerialFriction=0.0
StrafeSpeedMult=1.0
BackSpeedMult=1.0
