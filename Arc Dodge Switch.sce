Name=Arc Dodge Switch
PlayerCharacters=pistol Launchman
BotCharacters=Pigeon3.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=pistol Launchman
AddedBots=Pigeon3.bot;Pigeon3.bot;Pigeon3.bot;Pigeon3.bot;Pigeon3.bot;Pigeon3.bot
PlayerMaxLives=0
...
DifficultyTag=3
AuthorsTag=Sparky Fallen
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Track arcing targets at different vertical angles, movement score
GameVersion=2.0.2.0
...
CameraOffset=X=0.000 Y=0.000 Z=250.000
HeadshotOnly=false
