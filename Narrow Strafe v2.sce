...
WeaponHeroTag=LG
DifficultyTag=3
AuthorsTag=NFNT, Toast of War
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=false
BlockFCT=true
Description=So, like, check this out. You got a crosshair, yeah? Should be like on the center of your screen. Put that thing on the enemy head and, like... shoot it. Like a lot. And then when it moves, ya follow it. I know, it's crazy.
GameVersion=2.0.2.0
