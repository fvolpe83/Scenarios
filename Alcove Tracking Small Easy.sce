Name=Alcove Tracking Small Easy
...
DifficultyTag=1
AuthorsTag=Stral, Editor=Luqies
BlockHitMarkers=false
BlockHitSounds=true
BlockMissSounds=true
BlockFCT=true
Description=Edited to have small, slightly slower target. Intended for beginners practicing against ADAD strafing enemy.
GameVersion=1.0.8.0
