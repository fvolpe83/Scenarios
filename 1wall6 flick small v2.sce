...
GameTag=Mouse Control, flicks, CSGO, Battlefield, Overwatch
WeaponHeroTag=LG, Track Master
DifficultyTag=2
...
BlockFCT=true
Description=HOLD FIRE THE ENTIRE TIME FOR FULL BENEFIT! Based on 1wall6 flick. No accuracy based scoring. Updated to use higher ROF weapon.
GameVersion=1.0.8.0
...
Name=Player
MaxHealth=100.0
WeaponProfileNames=Track Master 3point9;;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=0.0
