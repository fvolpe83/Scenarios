Name=Apex legends Wingman_R-301
PlayerCharacters=Perso Apex
BotCharacters=Apex.bot;Apex 100.bot
IsChallenge=true
Timelimit=50.0
PlayerProfile=Perso Apex
...
WeaponHeroTag=Apex legends , Wingman , R-301, Training
DifficultyTag=3
AuthorsTag=Chups972
...
BlockFCT=false
Description=wingman/r-301 training
GameVersion=1.0.7.2
...
Name=Perso Apex
MaxHealth=200.0
WeaponProfileNames=R-301;Wingman;;;;;;
MinRespawnDelay=3.0
MaxRespawnDelay=9.0
StepUpHeight=16.0
