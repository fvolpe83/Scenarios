Name=close fast extra thin stares invincible (fg)
...
DifficultyTag=5
AuthorsTag=KovaaK, Huddled, banDiscord, Nocrno
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Low pressure hitscan tracking against an extra thinn target.
GameVersion=2.0.1.0
...
DodgeProfileNames=Close Short Strafes;Close Long Strafes;Close Very Short Strafes
