Name=Rocket Flyer 2v2
PlayerCharacters=Rocket Flyer;Racer;Shinji;McCoy;Sergeant 87;Hansel;OrbMonk;Grandma
...
WeaponHeroTag=Rocket Flyer, Pharah, Rocket Launcher
DifficultyTag=3
AuthorsTag=KovaaK
...
BlockFCT=false
Description=You as Rocket Flyer + random teammate vs 2 random enemies on a control center.
GameVersion=1.0.5
