...
GameTag=Halo Reach HCE H2 H3
WeaponHeroTag=Battle Rifle/DMR HCE Magnum
DifficultyTag=3
AuthorsTag=Doedoes
...
BlockFCT=false
Description=Made For MKB Users That Play Halo PC
GameVersion=2.0.0.2
...
AimingProfileNames=High Skill;High Skill;Low Skill;Default;Default;Default;Default;Default
