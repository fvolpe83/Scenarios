Name=Brant's R6 Aim Trainer
PlayerCharacters=R6 Player
BotCharacters=Quaker Bot Fast Strafes.bot
IsChallenge=true
Timelimit=30.0
PlayerProfile=R6 Player
AddedBots=Quaker Bot Fast Strafes.bot;Quaker Bot Fast Strafes.bot;Quaker Bot Fast Strafes.bot;Quaker Bot Fast Strafes.bot;Quaker Bot Fast Strafes.bot
PlayerMaxLives=0
...
BlockFCT=true
Description=Brant's Rainbow Six Siege Aim Trainer
GameVersion=1.0.8.0
...
DodgeProfileNames=MidStrafes;Short Strafes;cs peek
DodgeProfileWeights=5.0;5.0;5.0
...
AbilityProfileNames=Run-R6.abilsprint;Melee.abilmelee;;
HideWeapon=false
AerialFriction=0.0
StrafeSpeedMult=1.0
BackSpeedMult=1.0
