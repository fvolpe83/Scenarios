...
DifficultyTag=2
AuthorsTag=Sharqosity/ editted by lMerKy_
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=3 targets that respawn instantly when they die. Kill as many as you can in 180 seconds!
GameVersion=1.0.7.2
