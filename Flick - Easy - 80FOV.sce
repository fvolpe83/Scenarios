...
BlockFCT=true
Description=Flick to a short-lived target before it despawns. A test of reflex and flick accuracy. Single 200 size target with 500 ms lifetime. Adapted for 80 FOV.
GameVersion=1.0.6.2
