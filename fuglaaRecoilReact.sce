Name=fuglaaRecoilReact
PlayerCharacters=CameraFrenzy Challenger
BotCharacters=CameraFrenzy Cube.bot;CameraFrenzy Sphere.bot
IsChallenge=true
Timelimit=10.0
PlayerProfile=CameraFrenzy Challenger
AddedBots=CameraFrenzy Cube.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=2
MapName=CameraFrenzy_02x.map
MapScale=1.0
...
BlockFCT=true
Description=Camera will become offset after every shot. Every hit will regain +0.333 seconds. Survive for as long as possible!
GameVersion=1.0.7.2
...
UseWeapons=false
CharacterProfile=CameraFrenzy Cube
SeeThroughWalls=false
NoDodging=false
NoAiming=false

[Bot Profile]
Name=CameraFrenzy Sphere
DodgeProfileNames=Nothing
DodgeProfileWeights=1.0
DodgeProfileMaxChangeTime=100.0
DodgeProfileMinChangeTime=100.0
...
WeaponSwitchTime=60.0
UseWeapons=false
CharacterProfile=CameraFrenzy Sphere
SeeThroughWalls=false
NoDodging=false
NoAiming=false

[Character Profile]
Name=CameraFrenzy Challenger
MaxHealth=1.0
WeaponProfileNames=CameraFrenzy Challenge;;;;;;;
...
global
	...
	entity
		type PlayerSpawn
		Vector3 position 0.000000 -12.000000 -2944.000000
		Bool8 teamA 0
