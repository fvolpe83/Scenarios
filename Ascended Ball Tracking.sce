Name=Ascended Ball Tracking
PlayerCharacters=Ascended Tracking
BotCharacters=air_close_short.bot;air1F_close_long.bot;air1F_far_long.bot
IsChallenge=true
Timelimit=90.0
PlayerProfile=Ascended Tracking
AddedBots=air_close_short.bot;air1F_close_long.bot;air_close_short.bot;air1F_close_long.bot;air1F_far_long.bot;air1F_far_long.bot
PlayerMaxLives=0
...
BlockFCT=true
Description=Track different kinds of targets with unexpectable movements to get your aim to the next level
GameVersion=1.0.8.0
