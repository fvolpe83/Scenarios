Name=FoxyPewPew Apex v2
PlayerCharacters=Quaker
BotCharacters=apexparalympicsv2.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Quaker
AddedBots=apexparalympicsv2.bot;apexparalympicsv2.bot
PlayerMaxLives=0
BotMaxLives=0;0
PlayerTeam=2
BotTeams=1;0
...
DifficultyTag=5
AuthorsTag=FoxyPewPew
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Potatos go here
GameVersion=1.0.7.2
...
[Bot Profile]
Name=apexparalympicsv2
DodgeProfileNames=ADAD - Pro;Long - Pro;Short Strafes;MidStrafes;Long Strafes Jumping
DodgeProfileWeights=0.2;0.8;0.6;0.8;0.2
