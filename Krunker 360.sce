...
AddedBots=Quaker Bot Long Strafes Thin.bot;Quaker Bot Long Strafes Thin.bot;Quaker Bot Long Strafes Thin.bot
PlayerMaxLives=0
BotMaxLives=0;0;0
PlayerTeam=1
BotTeams=2;2;2
...
GameTag=Black Ops 4, Battlefield 5, Krunker
...
BlockFCT=false
Description=3 cube bots, 3 shots to the head; 5 to body.
GameVersion=1.0.8.0
...
Name=QuakerThin
MaxHealth=100.0
WeaponProfileNames=Alcove_Tracking_Weapon;;Alcove_Tracking_Weapon;Alcove Tracking Effect Helper;;;;
MinRespawnDelay=0.001
MaxRespawnDelay=0.001
StepUpHeight=75.0
