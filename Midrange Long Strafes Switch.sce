Name=Midrange Long Strafes Switch
PlayerCharacters=Quaker
BotCharacters=Quaker Bot Long Strafes.bot;Quaker Bot Long Strafes.bot;Quaker Bot Long Strafes.bot
IsChallenge=true
Timelimit=60.0
...
DifficultyTag=3
AuthorsTag=KovaaK, Huddled, Scatterd
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Midrange Long Strafing Target Switching.
GameVersion=1.0.8.0
