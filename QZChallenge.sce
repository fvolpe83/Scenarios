...
BotCharacters=QZFAST.bot
IsChallenge=false
Timelimit=600.0
PlayerProfile=Quaker
AddedBots=QZFAST.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=2
...
GameTag=Quake 3, QuakeLive, QuakeChampions
WeaponHeroTag=Lightning Gun, VQ3\VQL Movement
DifficultyTag=5
...
BlockFCT=false
Description=Scored by accuracy after a 10 minute high pressure training exercise.  Ideally for finding sensitivity and fov settings.
GameVersion=1.0.5
...
[Bot Profile]
Name=QZFAST
DodgeProfileNames=Mimic;Short Strafes
