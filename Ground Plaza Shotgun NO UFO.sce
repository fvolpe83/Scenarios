Name=Ground Plaza Shotgun NO UFO
PlayerCharacters=A Shotgun
BotCharacters=plaza rotation hin hin.rot
IsChallenge=true
Timelimit=100000.0
PlayerProfile=A Shotgun
...
DifficultyTag=4
AuthorsTag=razaplaza, mrg
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Ground Plaza, but with no ufos and fixed spawns and weapon replaced with shotgun
GameVersion=2.0.1.2
