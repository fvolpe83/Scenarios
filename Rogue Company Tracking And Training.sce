Name=Rogue Company Tracking And Training
PlayerCharacters=Roco Player
BotCharacters=Roco Bot Still.bot;Roco Bot Peek.bot;Roco Bot Mimic.bot;Roco Bot Long Strafes.bot;Roco Bot Flick.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Roco Player
AddedBots=Roco Bot Long Strafes.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=2
BotTeams=1
...
GameTag=Rogue Company, Track
WeaponHeroTag=KA30, Spit Fire, HRM-30KS, D40-C, 24S
DifficultyTag=1
AuthorsTag=andandy
...
BlockFCT=false
Description=Train Tracking With Rogue Company Weapons
GameVersion=2.0.1.2
...
WeaponSwitchTime=3.0
UseWeapons=false
CharacterProfile=Roco Bot Flick
SeeThroughWalls=false
NoDodging=true
NoAiming=false
AbilityUseTimer=0.1
...
Name=Roco Player
MaxHealth=100.0
WeaponProfileNames=Rogue Company Tracking Trainer;Rogue Company HRM-30KS;Rogue Company D40-C;Rogue Company 24S;Rogue Company KA30;Rogue Company Spit Fire;;Rogue Company Flick Trainer
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
...
TeamBodyColor=X=0.070 Y=0.380 Z=0.000
...
TPSArmLength=300.0
TPSOffset=X=0.000 Y=100.000 Z=0.000
...
CanCrouchInAir=false
CanJumpFromCrouch=false
EnemyBodyColor=X=1.000 Y=0.412 Z=0.000
EnemyHeadColor=X=1.000 Y=1.000 Z=1.000
TeamBodyColor=X=0.070 Y=0.380 Z=0.000
TeamHeadColor=X=255.000 Y=255.000 Z=255.000
BlockSelfDamage=false
...
[Weapon Profile]
Name=Rogue Company Tracking Trainer
Type=Hitscan
ShotsPerClick=1
DamagePerShot=2.0
KnockbackFactor=4.0
...
DelayAfterSpawn=0.0
BlockedByWorld=false
SpreadSSA=1.0,1.0,-0.75,0.75
SpreadSCA=1.0,1.0,-0.75,0.75
SpreadMSA=1.0,1.0,-0.75,0.75
SpreadMCA=1.0,1.0,-0.75,0.75
SpreadSSH=1.0,1.0,-3.0,3.0
SpreadSCH=1.0,1.0,-3.0,3.0
SpreadMSH=1.0,1.0,-3.0,3.0
SpreadMCH=1.0,1.0,-3.0,3.0
MaxRecoilUp=1.5
MinRecoilUp=1.0
MinRecoilHoriz=-0.1
MaxRecoilHoriz=0.1
...
SpreadMSA=1.0,1.0,-0.75,0.75
SpreadMCA=1.0,1.0,-0.75,0.75
SpreadSSH=1.0,1.0,-1.5,1.5
SpreadSCH=1.0,1.0,-1.5,1.5
SpreadMSH=1.0,1.0,-1.5,1.5
SpreadMCH=1.0,1.0,-1.5,1.5
MaxRecoilUp=1.0
MinRecoilUp=0.5
MinRecoilHoriz=-0.1
MaxRecoilHoriz=0.1
...
[Weapon Profile]
Name=Rogue Company Flick Trainer
Type=Hitscan
ShotsPerClick=1
DamagePerShot=150.0
KnockbackFactor=4.0
...
MagazineMax=1
AmmoPerShot=1
ReloadTimeFromEmpty=0.75
ReloadTimeFromPartial=0.75
DamageFalloffStartDistance=100000.0
DamageFalloffStopDistance=100000.0
DamageAtMaxRange=25.0
DelayBeforeShot=0.0
