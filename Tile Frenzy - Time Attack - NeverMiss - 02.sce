Name=Tile Frenzy - Time Attack - NeverMiss - 02
...
BlockFCT=true
Description=Flick between three cubes that respawn instantly upon death. Every kill recovers +0.181 seconds. Maintain 5.5 kills per second to stop the clock. Miss once and the challenge ends (you won't lose score). Survive for as long as possible!
GameVersion=1.0.7.2
