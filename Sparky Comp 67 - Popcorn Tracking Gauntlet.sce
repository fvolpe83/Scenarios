Name=Sparky Comp 67 - Popcorn Tracking Gauntlet
PlayerCharacters=pistol Launchman
BotCharacters=Pigeon.bot;Pigeon2.bot;Pigeon3.bot;Pigeon4.bot;Pigeon5.bot;rotation.rot
IsChallenge=true
Timelimit=500.0
PlayerProfile=pistol Launchman
AddedBots=rotation.rot
PlayerMaxLives=0
BotMaxLives=5
PlayerTeam=1
BotTeams=2
...
DifficultyTag=3
AuthorsTag=gli, nocrno, Fallen, Daan
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Popcorn goated tracking, but kill every bot from lowest to highest. 10x health.
GameVersion=2.0.2.0
...
Name=rotation
ProfileNames=Pigeon2;Pigeon;Pigeon4;Pigeon5;Pigeon3
