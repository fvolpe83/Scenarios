Name=Leap 180 tracking invincible 1 bot
...
BlockFCT=false
Description=B180 Tracking but the bots are smaller, leap further horizontally, it's faster, and the gravity is higher.
GameVersion=2.0.1.0
