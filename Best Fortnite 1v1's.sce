...
Name=Fortnite
MaxHealth=200.0
WeaponProfileNames=;Tac Shotgun;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=16.0
...
TPSArmLength=220.0
TPSOffset=X=0.000 Y=30.000 Z=10.000
...
SpreadSSA=0.0,0.1,1.0,2.0
SpreadSCA=0.0,0.1,1.0,2.0
SpreadMSA=0.0,0.1,1.5,2.0
SpreadMCA=0.0,0.1,1.5,2.0
SpreadSSH=0.0,0.1,1.0,2.0
SpreadSCH=0.0,0.1,0.5,1.0
SpreadMSH=0.0,0.1,2.0,2.5
SpreadMCH=0.0,0.1,1.0,1.25
MaxRecoilUp=2.0
MinRecoilUp=2.0
MinRecoilHoriz=0.0
MaxRecoilHoriz=0.0
