Name=Plaza Low Ground Easy No UFO
PlayerCharacters=A
...
DifficultyTag=4
AuthorsTag=patys, rem1xAU
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=8 bots with various dodge profiles and speeds. Similar to air, but the bots are on the ground and you are on low ground. Lower movement speed compared to the original.
GameVersion=1.0.7.2
