...
GameTag=track, tracking
WeaponHeroTag=LG, soldier, zarya
DifficultyTag=4
AuthorsTag=kindred
...
BlockFCT=false
Description=The sequel to Popcorn Goated Tracking. Practice tracking small bouncing targets both above and below you.
GameVersion=2.0.1.0
...
UseWeapons=false
CharacterProfile=     pigeon bot vertical hell
