Name=McCoy 1v1 v2 Ashe Edition
...
WeaponHeroTag=Ashe
DifficultyTag=3
AuthorsTag=KovaaK, KROADER, Tyleah
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Right click ashe ADS. Go to Settings -> Weapon -> 0.5147000 Zoom Sens Multiplier for 1:1 sens. Scenario still WIP
GameVersion=2.0.2.0
...
Name=McCoy
MaxHealth=200.0
WeaponProfileNames=Viporizer V2;;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=30.0
