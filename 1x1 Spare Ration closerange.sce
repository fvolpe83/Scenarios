Name=1x1 Spare Ration closerange
...
GameTag=1x1 close range spare ration
WeaponHeroTag=pistol, spare ration
DifficultyTag=2
AuthorsTag=BlackBartVo8
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=practice your closerange 
GameVersion=2.0.1.2
...
Name=QWer
MaxHealth=140.0
WeaponProfileNames=pistol;pistol;pistol;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
...
CanCrouchInAir=true
CanJumpFromCrouch=false
EnemyBodyColor=X=0.267 Y=0.000 Z=1.000
EnemyHeadColor=X=1.000 Y=0.000 Z=1.000
TeamBodyColor=X=1.000 Y=0.888 Z=0.000
TeamHeadColor=X=1.000 Y=1.000 Z=1.000
BlockSelfDamage=false
