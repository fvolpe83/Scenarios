Name=Big Angle Flicks
PlayerCharacters=B
BotCharacters=annoyingthing.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=B
AddedBots=annoyingthing.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=2
...
WeaponHeroTag=
DifficultyTag=4
AuthorsTag=Ku (Air), Bozott
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=false
BlockFCT=false
Description=Flicks for large angles (>90). Modified Air
GameVersion=1.0.7.2
...
Name=B
MaxHealth=10.0
WeaponProfileNames=Flick Master;;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
