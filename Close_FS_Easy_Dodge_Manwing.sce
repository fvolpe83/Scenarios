Name=Close_FS_Easy_Dodge_Manwing
...
BlockFCT=false
Description=Close quarter combat practice against a fast strafing bot. Keep moving for increased score. Modified for Manwing vs 200HP
GameVersion=2.0.1.0
