Name=Target Switching 90 Multi-Targets
PlayerCharacters=Quaker
BotCharacters=Quaker Bot Long Strafes.bot;Quaker Bot Long Strafes.bot
IsChallenge=true
Timelimit=60.0
...
BlockFCT=false
Description=For all your relaa fans, a scenario to train target switching 
GameVersion=1.0.8.0
