Name=Cata IC Long Strafes (krunker long range recoil control)
...
BlockFCT=false
Description=simulates far range movements
GameVersion=2.0.1.0
...
Name=Quaker
MaxHealth=150.0
WeaponProfileNames=krunker ak tester;krunker ak tester;krunker ak tester;krunker ak tester;krunker ak tester;krunker ak tester;krunker ak tester;krunker ak tester
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
