Name=Sparky Comp 58 - Hyperscape VT Dodge
...
BlockFCT=false
Description=Movement aiming scenario focused on verticality. VT = Verticality Training. PGTI + Teleports + some other modifications. Movement scoring mechanics enabled. 
GameVersion=2.0.2.0
