Name=Reactive Flick Angles Only
...
GameTag=MCA-16, Click-timing, Reactive-aiming
...
BlockFCT=true
Description=Practice to recognize a movement direction of a target quickly. A target begins to move when you hit it (lifetime: 500 ms).   ---------------------------------- Note: MCA stands for "Midweek Competitive Aiming", a local event for the competitive aiming community in Japan.
GameVersion=2.0.1.2
...
ProfileNames=RF Target UL UR;RF Target BL BR
