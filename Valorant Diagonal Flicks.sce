Name=Valorant Diagonal Flicks
PlayerCharacters=Clicker_xhair
BotCharacters=td_bad_rotation.rot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Clicker_xhair
AddedBots=td_bad_rotation.rot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=2
BotTeams=1
...
GameTag=Valorant, CSGO, Flick
WeaponHeroTag=Pistol
DifficultyTag=2
AuthorsTag=Weebkiller, ducKing
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=300ms reaction time. Practice flicking towards enemy heads when you have bad crosshair placement. Diagonal flicks are harder than horizontal flicks. Aim lower on the body the worse your crosshair placement is in game. Practice pre-aiming the top of the boxes in game to raise your crosshair placement and use this map as a supplement.
GameVersion=2.0.1.2
...
[Bot Profile]
Name=td good bot
DodgeProfileNames=Close Long Strafes;Close Short Strafes
...
Name=td_bad_rotation
ProfileNames=td_bad_bot;td good bot
...
Name=Clicker_xhair
MaxHealth=100.0
WeaponProfileNames=hitscan;sheriff-ish;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=0.0
...
HitscanVisualOffset=X=0.000 Y=-40.000 Z=-55.000
...
DelayAfterUse=0.0
FullyAuto=true
WeaponProfile=selfdamage 300 ms
