Name=Wingman dot track
PlayerCharacters=A_air_trace_frozen;McCoy
...
WeaponHeroTag=r-99, wingman, lg, trackmaster
DifficultyTag=2
...
BlockFCT=false
Description=Edited version of dot track with a couple of weapons from Apex Legends added.
GameVersion=1.0.7.2
...
MaxHealth=100.0
WeaponProfileNames=Track Master 100;Wingman;ADSable Hitscan Cone;LG;R-99;;;
MinRespawnDelay=0.1
MaxRespawnDelay=0.1
StepUpHeight=75.0
...
Name=McCoy
MaxHealth=200.0
WeaponProfileNames=Six Shooter;ADSable Hitscan Cone;Wingman;R-99;LG;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
CrouchHeightModifier=0.5
