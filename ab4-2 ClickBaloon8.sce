Name=4-1 ClickBaloon8
PlayerCharacters=Balloon Shooter
BotCharacters=Balloon.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Balloon Shooter
AddedBots=Balloon.bot;Balloon.bot;Balloon.bot;Balloon.bot;Balloon.bot;Balloon.bot;Balloon.bot;Balloon.bot
PlayerMaxLives=0
...
BlockFCT=true
Description=ab4 ClickBaloon8 90 Static MidNoStrafe
GameVersion=2.0.1.1
