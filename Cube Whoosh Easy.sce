Name=Cube Whoosh Easy
PlayerCharacters=TileFrenzy Challenger
BotCharacters=cube rotation.rot
IsChallenge=true
Timelimit=60.0
PlayerProfile=TileFrenzy Challenger
AddedBots=cube rotation.rot;cube rotation.rot;cube rotation.rot;cube rotation.rot;cube rotation.rot;cube rotation.rot;cube rotation.rot
PlayerMaxLives=0
...
BlockFCT=false
Description=Yes I know this is basically just Tile Frenzy 180 Strafing. Sue me
GameVersion=2.0.2.0
