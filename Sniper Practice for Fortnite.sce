Name=Sniper practice for Fortnite
...
BlockFCT=false
Description=Sniping practice for Fortnite, but it also works with any similar game.
GameVersion=1.0.8.0
...
ChargeMoveSpeedModifier=1.0
MuzzleVelocityMin=X=128000.000 Y=0.000 Z=0.000
MuzzleVelocityMax=X=128000.000 Y=0.000 Z=0.000
InheritOwnerVelocity=0.0
OriginOffset=X=0.000 Y=0.000 Z=0.000
MaxTravelTime=5.0
MaxHitscanRange=100000.0
