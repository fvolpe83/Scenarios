Name=Target Acquisition Flick Horizontal Far
...
PlayerTeam=1
BotTeams=2;2
MapName=square_1wallhorizontal.map
MapScale=1.5
...
GameTag=Mouse Control, Rainbow Six
WeaponHeroTag=
DifficultyTag=4
AuthorsTag=
...
BlockFCT=true
Description=Aim at Poke-Ball and wait for the other target to spawn. Kill both in one fluid motion, focus on flick speed and accuracy.
GameVersion=1.0.8.0
