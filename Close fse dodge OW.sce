...
BlockFCT=false
Description=Close quarter combat practice against a fast strafing bot with high ground acceleration. Keep moving for increased score.
GameVersion=1.0.8.0
