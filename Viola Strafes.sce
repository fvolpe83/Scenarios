...
BotCharacters=Viola Bot .bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Quaker
AddedBots=Viola Bot .bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=0
...
[Bot Profile]
Name=Viola Bot 
DodgeProfileNames=Viola Long Strafes
...
JetpackMaxZVelocity=400.0
JetpackAirControlWithThrust=0.25
AbilityProfileNames=Jump.abilmov;it do go down.abilmov;;
HideWeapon=true
AerialFriction=0.0
StrafeSpeedMult=16.0
BackSpeedMult=3.0
RespawnInvulnTime=0.0
BlockedSpawnRadius=0.0
BlockSpawnFOV=0.0
