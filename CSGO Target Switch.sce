...
GameTag=OW, Apex, CSGO, flick, hitscan
...
BlockFCT=false
Description=Target switching scenarios (flick + hitscan)
GameVersion=1.0.7.2
...
DodgeProfileNames=Short Strafes;ADAD;cs peek;CsRandom1;Long Strafes 2
DodgeProfileWeights=0.5;0.5;0.5;0.5;0.5
...
MaxHealth=100.0
WeaponProfileNames=AK-47;;Deag;USP-S;;;;
