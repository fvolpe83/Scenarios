Name=Aruru YouTube General practice 180
PlayerCharacters=Aruru YouTube
BotCharacters=aruru.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Aruru YouTube
AddedBots=aruru.bot;aruru.bot;aruru.bot;aruru.bot
PlayerMaxLives=0
BotMaxLives=0;0;0;0
PlayerTeam=1
BotTeams=2;2;2;2
...
UseWeapons=false
CharacterProfile=Aruru YouTube
...
AbilityProfileNames=aruru sprint.abilsprint;aruru movement.abilmov;;
HideWeapon=true
AerialFriction=0.0
StrafeSpeedMult=1.0
BackSpeedMult=1.0
