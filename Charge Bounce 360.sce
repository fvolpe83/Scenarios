...
GameTag=Fortnite
WeaponHeroTag=Charge Shotgun
DifficultyTag=3
AuthorsTag=fareoh, vF KROADER
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=target switch/jumping/third person with charge shotgun practice (influence credit to huddled/kroader)
GameVersion=2.0.1.2
