Name=Ground Plaza Sparky v3 OW Thin
PlayerCharacters=A
...
DifficultyTag=4
AuthorsTag=razaplaza, patys, sarin, KROADER, Ghokury
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Ground Plaza with slightly slower and thinner bots, sinstant ground accel. 6 bots - mid strafe ufo, long strafe ufo, far mid strafe bot, close mid strafe bot, far long strafe, close long strafe. 10s ttk, 1.5 s spawn delay, no movement. Bots are 30% thinner.
GameVersion=2.0.2.0
