Name=Ascended Tracking 90 Thin Hard
...
GameTag=Tracking, Thin
WeaponHeroTag=
DifficultyTag=5
AuthorsTag=KovaaK (Edited by Yagnesh)
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=true
Description=Even harder version of Ascended Tracking 90 Thin, was made for some players who wanted to practice their tracking a lot.
GameVersion=1.0.7.1
