...
BlockFCT=false
Description=1. Shahadah: sincerely reciting the Muslim profession of faith.2. Salat: performing ritual prayers in the proper way five times each day.3. Zakat: paying an alms (or charity) tax to benefit the poor and the needy.4. Sawm: fasting during the month of Ramadan.5. Hajj: pilgrimage to Mecca
GameVersion=1.0.8.0
...
DamageReactionMaximumDelay=0.12
