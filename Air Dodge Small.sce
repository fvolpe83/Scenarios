...
GameTag=Track, Air, Tracking
WeaponHeroTag=
DifficultyTag=5
AuthorsTag=kindred, Ghokury
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description="Air no UFO no SKYBOTS" with movement based scoring and some edited profiles. Bots are 30% small, time is 10 minutes.
GameVersion=1.0.8.0
