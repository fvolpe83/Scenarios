...
DifficultyTag=1
AuthorsTag=nick, ryan
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=tweaked version of 'PoleDodging' scenario. This one has movement mechanics similar to OW, and you can now crouch.
GameVersion=1.0.6.1
