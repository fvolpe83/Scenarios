...
DifficultyTag=3
AuthorsTag=twitch.tv/Akuvo, Fuglaa
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Edited Fuglaa's map to more suit Fortnite's aim system. Some kinks, sorry, uploading mostly for my own use.
GameVersion=1.0.7.2
