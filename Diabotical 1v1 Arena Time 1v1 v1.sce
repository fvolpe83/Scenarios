Name=Diabotical 1v1 Arena Time 1v1 v1
PlayerCharacters=Eggbot
BotCharacters=Eggbot.bot
IsChallenge=true
Timelimit=30.0
PlayerProfile=Eggbot
AddedBots=Eggbot.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=0
...
GameTag=Diabotical
WeaponHeroTag=LG, Lightning Gun, Rail, Railgun, Rocket Launcher, RL
DifficultyTag=4
AuthorsTag=en1gma
...
BlockFCT=false
Description=diabotical 1v1 arena trainer
GameVersion=2.0.0.2
...
[Bot Profile]
Name=Eggbot
DodgeProfileNames=Circle Strafe;Long Strafes;Mimic;Short Strafes;Long Strafes Jumping
DodgeProfileWeights=1.0;2.0;1.0;1.0;3.0
DodgeProfileMaxChangeTime=2.0
DodgeProfileMinChangeTime=0.5
WeaponProfileWeights=1.0;3.0;3.0;0.5;1.0;1.0;1.0;1.0
AimingProfileNames=Aimbot;Aimbot;At Feet;Default;Default;Default;Default;Default
WeaponSwitchTime=5.0
UseWeapons=true
CharacterProfile=Eggbot
...
Name=Eggbot
MaxHealth=300.0
WeaponProfileNames=dbtRail;dbtLG;dbtRL;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=1.0
StepUpHeight=75.0
...
AbilityProfileNames=dbtDash.abilmov;Gravity Boost.abilmov;;
HideWeapon=false
AerialFriction=0.0
StrafeSpeedMult=1.25
BackSpeedMult=1.0
