Name=Close Fast Extra Thin Invincible
PlayerCharacters=Quaker
BotCharacters=Quaker Bot Long Strafes Thin.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Quaker
AddedBots=Quaker Bot Long Strafes Thin.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=2
...
DifficultyTag=5
AuthorsTag=KovaaK, Huddled, banDiscord, Nocrno, aestheticgoose
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Low pressure hitscan tracking against an extra thin, fast strafing target to improve fast strafe tracking.
GameVersion=1.0.7.2
...
[Bot Profile]
Name=Quaker Bot Long Strafes Thin
DodgeProfileNames=Close Long Strafes;Close Short Strafes;Close Very Short Strafes
