Name=flaptisteTargetSwitch_360
...
GameTag=Call of Duty, Battlefield, Overwatch, flick
WeaponHeroTag=Rifle
DifficultyTag=3
AuthorsTag=patys
...
BlockFCT=false
Description=Spawn sounds recommended to be turned for reduced RNG
GameVersion=1.0.8.0
...
Type=Hitscan
ShotsPerClick=1
DamagePerShot=16.700001
KnockbackFactor=0.0
TimeBetweenShots=0.55
Pierces=false
Category=FullyAuto
BurstShotCount=3
TimeBetweenBursts=0.066666
...
SpreadSSH=0.0,0.0001,0.0,0.0
SpreadSCH=0.0,0.1,-0.0001,0.0
SpreadMSH=0.0,0.0001,0.0,0.0
SpreadMCH=0.0,0.1,-0.0001,0.0
MaxRecoilUp=0.0
MinRecoilUp=0.0
MinRecoilHoriz=0.0
MaxRecoilHoriz=0.0
