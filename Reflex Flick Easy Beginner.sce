Name=Reflex Flick Easy Beginner
...
BlockFCT=true
Description=Flick to a short-lived target before it despawns. A test of reflex and flick accuracy. Single 200 size target with 1000 ms (1 Second) lifetime. If you're struggling with Easy or need a slow warmup. Decrease time as needed.
GameVersion=2.0.1.0
