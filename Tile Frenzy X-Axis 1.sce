...
BlockFCT=true
Description=Flick between three cubes that respawn instantly upon death. Kill as many as you can within 30 seconds! Extra wide playfield.
GameVersion=2.0.1.2
