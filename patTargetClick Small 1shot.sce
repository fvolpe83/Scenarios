Name=patTargetClick Small 1shot
...
DifficultyTag=4
AuthorsTag=patys, Tammas
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=pattargetclick with small bots that die in 1 headshot
GameVersion=2.0.2.0
...
DodgeProfileNames=Long Strafes;Mid No FB Strafes
DodgeProfileWeights=4.0;1.0
