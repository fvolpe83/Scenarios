Name=Tile Frenzy - Strafing - 03 (60 s)
...
BlockFCT=true
Description=Flick between three moving cubes that respawn instantly upon death. Kill as many as you can within 60 seconds!
GameVersion=2.0.1.0
