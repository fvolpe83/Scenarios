...
BotCharacters=Pigeon.bot;Pigeon3.bot;Pigeon4.bot;Pigeon5.bot;Pigeon4.bot;Pigeon.bot;Pigeon3.bot
IsChallenge=true
Timelimit=50.0
PlayerProfile=pistol Launchman
AddedBots=Pigeon.bot;Pigeon3.bot;Pigeon4.bot;Pigeon5.bot;Pigeon.bot;Pigeon4.bot;Pigeon3.bot
PlayerMaxLives=0
...
GameTag=Click Timing, Popcorn, Bounce, Small, Goated, Apex, Jump Pad, Fortnite, Justice, Kroader
WeaponHeroTag= Pistol, Rail
DifficultyTag=3
AuthorsTag=LutherCreedXoX
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=false
BlockFCT=false
Description=POPCORN but less wack. The bots actually bounce, 2 extra bots so u can ape. It help aim. 0.5 seconds added on kill to reward speed
GameVersion=1.0.8.0
