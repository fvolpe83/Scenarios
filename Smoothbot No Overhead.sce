Name=Smoothbot No Overhead
PlayerCharacters=Quaker
BotCharacters=SmoothBot.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Quaker
AddedBots=SmoothBot.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=2
MapName=b360curved.map
MapScale=10.0
...
GameTag=
WeaponHeroTag=Ion Cannon, LG, Lightning Gun, Shaft
DifficultyTag=4
AuthorsTag=Xytaglyph, Sackboy_Clank5
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Arm aiming and 360 degree tracking through the air. No acc multiplier.
GameVersion=2.0.2.0
...
CameraOffset=X=0.000 Y=0.000 Z=220.000
HeadshotOnly=false
...
DamageReactionChanceToIgnore=0.66
