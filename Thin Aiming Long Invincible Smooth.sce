Name=Thin Aiming Long Invincible Smooth
PlayerCharacters=A
...
DifficultyTag=3
AuthorsTag=Ku, DevinDTV
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=false
BlockFCT=false
Description=Thinner. More consistent strafes. Shorter timer. No bumping into walls. Minimal RNG. Basically just a test of how smoothly you can move your arm.
GameVersion=2.0.1.2
