Name=Seraph Tracking
PlayerCharacters=A
BotCharacters=seraph rotation.rot
IsChallenge=true
Timelimit=1000.0
PlayerProfile=A
AddedBots=seraph rotation.rot
PlayerMaxLives=0
BotMaxLives=8
PlayerTeam=1
BotTeams=2
...
DifficultyTag=5
AuthorsTag=ryan, nick, ku
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=air angelic but better
GameVersion=2.0.0.2
...
Name=seraph rotation
ProfileNames=seraph_slow_close_long;seraph_slow_far_long;seraph_slow_close_short;seraph_slow_far_short;seraph_fast_close_long;seraph_fast_far_long;seraph_fast_close_short;seraph_fast_far_short
