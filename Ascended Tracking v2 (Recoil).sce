Name=Ascended Tracking v2 (Recoil)
...
GameTag=Tracking, PubG, RoE, Battle Royale
WeaponHeroTag=
DifficultyTag=3
...
BlockFCT=true
Description=Ascended Tracking v2 with a recoil variable meant to replicate that of guns from PubG and RoE. (Warmup Recoil Control)
GameVersion=1.0.8.0
