Name=Close Fast Shogun Jump Crouch
...
DifficultyTag=3
AuthorsTag=patys, KovaaK, Kaspenic
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Shotgun practice against a hard to hit target. That can Jump and Crouch
GameVersion=1.0.8.0
...
DodgeProfileNames=Close Short Strafes;Close Long Strafes;Close Very Short Strafes;Very Short Strafes + Jump;Short Strafes Jumping
DodgeProfileWeights=3.0;1.0;1.0;1.0;1.0
