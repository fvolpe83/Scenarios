Name=Ground Plaza Thin v2 NO UFO
PlayerCharacters=A
...
BlockFCT=false
Description=10 bots with various dodge profiles and speeds. Similar to air, but the bots are on the ground. Thin v2 offers better bot size, fixed spawns, better timers.
GameVersion=1.0.8.0
