Name=76 Duel
PlayerCharacters=McCoy;Sergeant 87
BotCharacters=Sergeant Bot.bot
IsChallenge=true
Timelimit=120.0
PlayerProfile=Sergeant 87
AddedBots=Sergeant Bot.bot
PlayerMaxLives=15
BotMaxLives=15
PlayerTeam=1
BotTeams=2
...
BlockFCT=false
Description=what its like dueling vandy
GameVersion=1.0.5
...
ShootSoundCooldown=0.08
HitSoundCooldown=0.08
HitscanVisualOffset=X=0.000 Y=0.000 Z=-75.000
ADSBlocksShooting=false
ShootingBlocksADS=false
KnockbackFactorAir=0.1
RecoilNegatable=true
...
SpreadSSH=2.0,10.0,-2.6,2.0
SpreadSCH=2.0,10.0,-2.6,2.4
SpreadMSH=1.5,10.0,-2.6,2.0
