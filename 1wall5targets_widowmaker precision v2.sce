Name=1wall5targets_widowmaker precision v2
...
BlockFCT=false
Description=FOV 51 Zoom .4444 (edit in settings) // It's slow for beginners so if you want a challenge just download the map, edit the time and timescale in the challenge tab and save! 
GameVersion=2.0.0.0
