...
WeaponHeroTag=Ashe
DifficultyTag=4
AuthorsTag=Tyleah, based on Reflex Flick by KovaaK
BlockHitMarkers=true
BlockHitSounds=true
BlockMissSounds=true
BlockFCT=true
Description=!!!ADS ONLY!!! Reposition your crosshair at center between each shot.
GameVersion=2.0.2.0
