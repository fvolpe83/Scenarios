Name=SmoothBot Unvincible Sphere
...
GameTag=Reflex, Quake, Diabotical
WeaponHeroTag=Ion Cannon, LG, Lightning Gun, Shaft
DifficultyTag=4
AuthorsTag=Xytaglyph, huekk
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Arm aiming and 360 degree tracking through the air
GameVersion=2.0.1.2
