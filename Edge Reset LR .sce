...
BlockFCT=false
Description=Useful for practicing resetting the mouse when tracking long distances in the same direction
GameVersion=2.0.2.0
...
MinJumpTime=0.3
MaxJumpTime=0.6
LeftStrafeTimeMult=60.0
RightStrafeTimeMult=60.0
