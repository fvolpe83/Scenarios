Name=Ground Plaza Fast Strafe Bots Only
PlayerCharacters=A
...
BlockFCT=false
Description=6 Fast strafe bots taken from the original "Ground Plaza" scenario
GameVersion=1.0.6.2
...
Name=plaza rotation
ProfileNames=air1F_close_short;air_close_short;air1_far_short;Bot Profile;air1F_far_short;air1_UFO
