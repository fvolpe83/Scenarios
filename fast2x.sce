...
BotCharacters=target.bot;target2.bot;target3.bot;target4.bot
IsChallenge=true
Timelimit=1000.0
PlayerProfile=A_air_pistol_frozen
AddedBots=target.bot;target2.bot;target3.bot;target4.bot
PlayerMaxLives=0
BotMaxLives=30;20;10;40
PlayerTeam=1
BotTeams=2;2;2;2
...
BlockFCT=false
Description=lots of different sized targets,  kill 100
GameVersion=0.99.5
