...
BlockFCT=true
Description=Pressure Aiming 10 targets with widowmaker scope from OW and 1x scope from apex
GameVersion=2.0.1.0
...
MaxHealth=2.0
WeaponProfileNames=Ashe (Pistol);wingman;Widow (Pistol);;;;;
MinRespawnDelay=0.3
MaxRespawnDelay=0.5
StepUpHeight=0.0
