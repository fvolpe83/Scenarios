Name=Valorant Horizontal Flicks Big
...
PlayerTeam=1
BotTeams=2
MapName=FLICKTemplateHorizontal.map
MapScale=0.6
...
BlockFCT=true
Description=300ms reaction time. Bot head size is similar to an enemy 20m away
GameVersion=2.0.1.2
...
Name=Clicker
MaxHealth=100.0
WeaponProfileNames=hitscan;sheriff-ish;op-ish;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=0.0
