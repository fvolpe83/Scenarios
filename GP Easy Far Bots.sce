...
BlockFCT=false
Description=8 bots with various dodge profiles and speeds. Similar to air, but the bots are on the ground. Lower movement speed compared to the original.
GameVersion=1.0.7.2
...
ProfileNames=air1_far_short;air1F_far_long;air1F_far_short;air1_UFO
