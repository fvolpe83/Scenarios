...
PlayerTeam=1
BotTeams=2
MapName=cube_1wall_dense_right.map
MapScale=1.5
...
BlockFCT=true
Description=Targets only spawn on the right side of the map.  Re-center to the middle of the map every time you shoot.
GameVersion=1.0.6.1
