Name=pasu extra small reload horizontal
PlayerCharacters=A_air_pistol_frozen
BotCharacters=test.bot;test2.bot
IsChallenge=true
Timelimit=60.0
...
GameTag=click timing,flick,ddtv,overwatch,fortnite,fn,ow,apex,cs,r6,valorant
WeaponHeroTag=Pistol
DifficultyTag=2
AuthorsTag=Fuglaa, Pasutazame, ddtv, berne
