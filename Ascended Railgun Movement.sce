Name=Ascended Railgun Movement
...
DifficultyTag=4
AuthorsTag=decizion, Kovaak, Feli
BlockHitMarkers=true
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=The long awaited sequel to the critically acclaimed Ascended Railgun scenario has finally arrived!!!!
GameVersion=1.0.8.0
