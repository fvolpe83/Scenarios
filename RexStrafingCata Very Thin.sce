Name=RexStrafingCata Very Thin
...
BlockFCT=false
Description=Hey, so the goal with this version of the Cata strafes is to reduce RNG, improve the realisticness of the way the bot strafes, and remove silly things like RL during fights, Jumping, the bot moving straight at you, etc. Any feedback is encouraged.
GameVersion=2.0.1.0
