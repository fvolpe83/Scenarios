...
BotCharacters=EGOBOSS.bot
IsChallenge=true
Timelimit=1000.0
PlayerProfile=EGODEATH
AddedBots=EGOBOSS.bot
PlayerMaxLives=0
BotMaxLives=1
PlayerTeam=1
BotTeams=2
...
[Bot Profile]
Name=EGOBOSS
DodgeProfileNames=Very Short Strafes + Jump;Long Strafes Close;Short Strafes Jumping;ADAD
DodgeProfileWeights=1.0;0.5;0.25;0.5
