Name=ascended tracking pistol
PlayerCharacters=Ascended Tracking;Long Strafer Kid
BotCharacters=Long Strafe Bot.bot;Long Strafe Bot Kid.bot
IsChallenge=true
Timelimit=90.0
PlayerProfile=Long Strafer Kid
AddedBots=Long Strafe Bot Kid.bot;Long Strafe Bot Kid.bot;Long Strafe Bot Kid.bot
PlayerMaxLives=0
BotMaxLives=0;0;0
PlayerTeam=1
BotTeams=2;2;2
...
WeaponSwitchTime=3.0
UseWeapons=false
CharacterProfile=Long Strafer Kid
SeeThroughWalls=false
NoDodging=false
NoAiming=false
AbilityUseTimer=0.1
