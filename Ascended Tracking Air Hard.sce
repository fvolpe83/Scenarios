Name=Ascended Tracking Air Hard
...
WeaponHeroTag=
DifficultyTag=2
AuthorsTag=ikue, KovaaK
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=true
Description=Track 3 targets at a variety of ranges and angles.  The weapon you use is hitscan and does more damage if you are centered on your target.  Difference from v2 is that v3 allows you to ADS/zoom. Spheric bots.
GameVersion=1.0.7.2
