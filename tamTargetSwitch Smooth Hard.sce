Name=tamTargetSwitch Smooth Hard
...
BlockFCT=false
Description=Small regenerating dots circle around you while bouncing slowly, 0.5s ttk, 0.5s max to regen to full, starts regening Immediatey if you go off target
GameVersion=2.0.2.0
