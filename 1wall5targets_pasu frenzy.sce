Name=1wall5targets_pasu frenzy
PlayerCharacters=A_air_pistol_frozen_mod
BotCharacters=test.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=A_air_pistol_frozen_mod
...
DifficultyTag=3
AuthorsTag=Fuglaa (with additions by ckap)
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Joshua asked me to make this
GameVersion=1.0.6.2
