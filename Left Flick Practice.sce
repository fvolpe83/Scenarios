...
PlayerTeam=1
BotTeams=2
MapName=cube_1wall_dense_left.map
MapScale=1.5
...
BlockFCT=true
Description=Targets only spawn on the left side of the map.  Re-center to the middle of the map every time you shoot.
GameVersion=1.0.6.1
