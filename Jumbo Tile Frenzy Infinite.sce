Name=Jumbo Tile Frenzy Infinite
...
BlockFCT=false
Description=Regular Jumbo Tile Frenzy, but each kill adds an extra 0.12 seconds (you would have to sustain ~8.3 kps to go indefinitely)
GameVersion=1.0.8.0
