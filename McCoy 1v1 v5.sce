...
WeaponHeroTag=McCree, McCoy, Six Shooter Updated
DifficultyTag=3
AuthorsTag=KovaaK, KROADER, Felicity, Shazzik
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=You as McCoy vs a single bot in a fixed rotation, separated by an invisible wall. You lose points for every damage taken.Updated with firerate buff, new models and more realistic abilities
GameVersion=2.0.0.2
...
Name=OW Rotation
ProfileNames=Genji Bot;McCoy Bot;Rocket Flyer Bot;Sergeant Bot;Racer Bot
...
Name=McCoy
MaxHealth=200.0
WeaponProfileNames=Six Shooter v2;;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=30.0
...
AbilityProfileNames=Roll.abilmov;Stun Gren.abilwep;;Melee.abilmelee
HideWeapon=false
AerialFriction=0.0
StrafeSpeedMult=1.0
BackSpeedMult=0.9
...
JetpackMaxZVelocity=600.0
JetpackAirControlWithThrust=0.25
AbilityProfileNames=Genji Dash.abilmov;;Triple Star.abilwep;Melee.abilmelee
HideWeapon=false
AerialFriction=0.0
StrafeSpeedMult=1.0
BackSpeedMult=0.9
