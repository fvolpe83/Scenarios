Name=Popcorn sparky pigeons 3&5
PlayerCharacters=pistol Launchman
BotCharacters=Pigeon3.bot;Pigeon5.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=pistol Launchman
AddedBots=Pigeon3.bot;Pigeon5.bot;Pigeon3.bot;Pigeon5.bot;Pigeon3.bot
PlayerMaxLives=0
...
DifficultyTag=3
AuthorsTag=kindred, gli, sini
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=POPCORN but the bots actually bounce, you can use health bars, no accuracy multiplier and a one shot reload system to punish missing. Also fixed scoring.
GameVersion=2.0.1.1
