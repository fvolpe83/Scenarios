Name=Air no UFO no SKYBOTS Click Auto
PlayerCharacters=A
...
GameTag=Click apex overwatch
WeaponHeroTag=
DifficultyTag=4
AuthorsTag=patys, huekk, Ghokury
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Air but there's no UFO and no SKYBOTS, autogun
GameVersion=1.0.8.0
