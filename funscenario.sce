Name=funscenario
PlayerCharacters=A_air_lg_frozen;StaticTarget;MovingTarget
BotCharacters=StaticTarget.bot;MovingTarget.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=A_air_lg_frozen
AddedBots=MovingTarget.bot;MovingTarget.bot;MovingTarget.bot
PlayerMaxLives=0
BotMaxLives=0;0;0
PlayerTeam=1
BotTeams=2;2;2
...
WeaponHeroTag=lg
DifficultyTag=3
AuthorsTag=faleene, apa3
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=flicktrack bounce edit
GameVersion=1.0.6.1
