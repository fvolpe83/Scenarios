Name=Apex_Ascended Tracking 90 Small
PlayerCharacters=Apex_Tracking
BotCharacters=Long Strafe Bot.bot
IsChallenge=true
Timelimit=90.0
PlayerProfile=Apex_Tracking
...
Name=Apex_Tracking
MaxHealth=500.0
WeaponProfileNames=_Tracking_1x Scope, Pistol, SMG, Shotgun;_Tracking_2x Scope;_Tracking_AR, LMG, Sniper;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
...
[Weapon Profile]
Name=_Tracking_1x Scope, Pistol, SMG, Shotgun
Type=Hitscan
ShotsPerClick=10
DamagePerShot=1.0
KnockbackFactor=0.0
