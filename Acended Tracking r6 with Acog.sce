Name=Acended Tracking r6 with Acog
...
BlockFCT=true
Description=I made 1 main adjustment, setting the ads of the weapon to the same zoom as holo and made it so it is 50% ads sens. So if u have 50 ads sens in r6 this is the map 4 u
GameVersion=1.0.8.0
