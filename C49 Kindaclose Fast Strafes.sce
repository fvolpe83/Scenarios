Name=C49 Kindaclose Fast Strafes
...
DifficultyTag=3
AuthorsTag=KovaaK, Tammas
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Kindaclose Fast, but the bot is a little smaller and slower.
GameVersion=2.0.2.0
...
DodgeProfileNames=MID MID MID MID MID MID;MID MID MID MID MID MID FASTER
...
[Dodge Profile]
Name=MID MID MID MID MID MID FASTER
MaxTargetDistance=900.0
MinTargetDistance=500.0
ToggleLeftRight=true
ToggleForwardBack=false
