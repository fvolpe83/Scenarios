...
BlockFCT=false
Description=Projectile Speed Update
GameVersion=2.0.0.1
...
[Bot Profile]
Name=Pigeon
DodgeProfileNames=Long Strafes Jumping;Circle Strafe;Short Strafes Jumping;Very Short Strafes + Jump
...
ChargeStartVelocity=X=4000.000 Y=0.000 Z=-33.000
ChargeTimeToAutoRelease=5.0
ChargeTimeToCap=0.75
ChargeMoveSpeedModifier=0.7
MuzzleVelocityMin=X=12000.000 Y=0.000 Z=-150.000
MuzzleVelocityMax=X=12500.000 Y=0.000 Z=-150.000
