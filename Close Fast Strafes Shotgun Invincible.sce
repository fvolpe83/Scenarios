Name=Close Fast Strafes Shotgun Invincible
...
DifficultyTag=3
AuthorsTag=patys, KovaaK, Cody
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Shotgun practice against a hard to hit target. Invincible version with 1 spawn for better scoring and less restarting.
GameVersion=1.0.8.0
