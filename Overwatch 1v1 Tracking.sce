...
BlockFCT=false
Description=Use a no-recoil assault rifle to train tracking against overwatch bots.
GameVersion=1.0.8.0
...
Name=AR
MaxHealth=100.0
WeaponProfileNames=AR;AR NO DMG;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
CrouchHeightModifier=0.5
CrouchAnimationSpeed=1.0
CameraOffset=X=0.000 Y=0.000 Z=-30.000
HeadshotOnly=false
...
JetpackMaxZVelocity=600.0
JetpackAirControlWithThrust=0.25
AbilityProfileNames=Rush.abilmov;;;Melee.abilmelee
HideWeapon=false
AerialFriction=0.0
StrafeSpeedMult=1.0
BackSpeedMult=0.9
