Name=Smoothness Training Sphere 30
...
DifficultyTag=1
AuthorsTag=Whisper, Pauer
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Horizontal smoothness training, very long and smooth strafes, small target. 
GameVersion=2.0.2.0
...
MaxTargetDistance=3900.0
MinTargetDistance=1000.0
ToggleLeftRight=true
ToggleForwardBack=false
MinLRTimeChange=15.0
MaxLRTimeChange=15.0
MinFBTimeChange=0.2
MaxFBTimeChange=0.5
