Name=1wall6targets 360
PlayerCharacters=target
BotCharacters=holdLeftBot.bot;holdRightBot.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=target
AddedBots=holdLeftBot.bot;holdLeftBot.bot;holdLeftBot.bot;holdRightBot.bot;holdRightBot.bot;holdRightBot.bot
PlayerMaxLives=0
...
GameTag=Track, Click Timing, Precision, 360
...
BlockFCT=false
Description=Shoot strafing bots in 360 degrees.
GameVersion=1.0.7.2
