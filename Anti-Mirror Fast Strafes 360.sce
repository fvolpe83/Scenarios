Name=Anti-Mirror Fast Strafes 360
...
BlockFCT=true
Description=Track targets while strafing in opposite direction than them. Fast Strafes version
GameVersion=1.0.7.2
...
DodgeProfileNames=Short Strafes;Anti-Mirror
