Name=Widowmaker Bounce Far-Small
...
DifficultyTag=5
AuthorsTag=GoCrazy, snow
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Snipe faraway bouncing targets. Now smaller targets and farther distance. Make sure "zoom sens auto-scale" is unchecked in weapon settings. You also can try different distances with map scale of 2 (close) and 4 (medium).
GameVersion=1.0.7.2
