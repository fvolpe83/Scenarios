Name=SAA
PlayerCharacters=AAscended Tracking;SAAscended Tracking;Long Strafer;Ascended Tracking
BotCharacters=LL.bot;LLS.bot;Long Strafe Bot.bot
IsChallenge=true
Timelimit=90.0
...
UseWeapons=false
CharacterProfile=AAscended Tracking
...
WeaponSwitchTime=3.0
UseWeapons=false
CharacterProfile=SAAscended Tracking
SeeThroughWalls=false
NoDodging=false
NoAiming=false
AbilityUseTimer=0.1
...
[Character Profile]
Name=AAscended Tracking
MaxHealth=600.0
WeaponProfileNames=pistol mini;ADSable Hitscan Cone;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
