Name=Variation Switch
PlayerCharacters=Quaker
BotCharacters=Quaker Bot Long Strafes.bot;Pigeon Jumper.bot;Horizontal strafes.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Quaker
AddedBots=Pigeon Jumper.bot;Pigeon Jumper.bot;Horizontal strafes.bot;Horizontal strafes.bot
PlayerMaxLives=0
BotMaxLives=0;0;0;0
PlayerTeam=1
BotTeams=2;2;2;2
...
BlockFCT=false
Description=Targetswitching scenario with horizontal moving and bouncing targets.
GameVersion=2.0.2.0
