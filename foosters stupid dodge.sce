Name=foosters stupid dodge
PlayerCharacters=Quaker
BotCharacters=fooster.bot
IsChallenge=true
Timelimit=30.0
PlayerProfile=Quaker
AddedBots=fooster.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=2
...
BlockFCT=false
Description=Close Fast Strafes, but the bots are invincible and you have to move
GameVersion=1.0.6.2
...
TrackSpeed=5.0
TrackError=2.0
MaxTurnAngleFromPadCenter=125.0
MinRecenterTime=0.3
MaxRecenterTime=0.5
OptimalAimFOV=30.0
OuterAimPenalty=1.0
...
AimingProfileNames=At Feet;Low Skill At Feet;help punish;Default;Default;Default;Default;Default
