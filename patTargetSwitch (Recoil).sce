...
BlockFCT=false
Description=patTargetSwitch with a recoil variable meant to replicate that of guns from PubG and RoE. (Intermediate Recoil Control)
GameVersion=1.0.8.0
