Name=1wall 6targets small Windowmaker
...
GameTag=Overwatch, OW, Mouse Control
...
BlockFCT=true
Description=1 scoped click = 1 kill. Practice your precision on tiny targets. 
GameVersion=1.0.8.0
...
SpreadSSH=15.0,0.1,50.0,50.0
SpreadSCH=15.0,0.1,50.0,50.0
SpreadMSH=15.0,0.1,50.0,50.0
SpreadMCH=15.0,0.1,50.0,50.0
MaxRecoilUp=0.0
MinRecoilUp=0.0
MinRecoilHoriz=0.0
MaxRecoilHoriz=0.0
