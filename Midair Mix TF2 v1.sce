...
GameTag=Team Fortress 2,TF2,Source
WeaponHeroTag=Soldier
DifficultyTag=4
AuthorsTag=KovaaK, Tob
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Midair Mix with Soldier vs Scout Bots. I edited existing scout and soldier profiles to make this feel relatively smooth to play. Uncertain who made the base profiles but credit to them for figuring out what I couldn't
GameVersion=1.0.8.0
...
MaxHealth=9999.0
WeaponProfileNames=TF2 RL (infinite ammo);;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=18.0
