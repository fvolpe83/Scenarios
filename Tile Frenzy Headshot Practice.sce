Name=Tile Frenzy Headshot Practice
...
DifficultyTag=2
AuthorsTag=Sharqosity, G2N921F.ttv
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Go for the headshots! Normal shots won't kill the targets, so you must hit the head.
GameVersion=1.0.7.2
