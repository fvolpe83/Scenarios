...
GameTag=Track, Hyperscape
WeaponHeroTag=
DifficultyTag=4
AuthorsTag=fuglaa, Artefact
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Sped up version of fuglaa's original long strafes. All credit goes to fuglaa
GameVersion=2.0.1.2
