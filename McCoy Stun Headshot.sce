Name=McCoy Stun Headshot
PlayerCharacters=McCoy;Rocket Flyer;Sergeant 87;Shinji;Racer;OrbMonk;Grandma;Hansel
...
Timelimit=60.0
PlayerProfile=McCoy
AddedBots=Racer Bot.bot;Racer Bot.bot
PlayerMaxLives=0
BotMaxLives=0;0
PlayerTeam=1
BotTeams=2;2
...
BlockFCT=false
Description=You as McCoy vs 2 jumpy racer bots.  Very short cooldown on Stun Grenade to practice shooting falling, stunned enemies.
GameVersion=1.0.8.0
