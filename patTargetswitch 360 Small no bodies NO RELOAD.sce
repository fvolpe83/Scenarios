Name=patTargetswitch 360 Small no bodies NO RELOAD
PlayerCharacters=no bodies profile
BotCharacters=no bodies.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=no bodies profile
AddedBots=no bodies.bot;no bodies.bot;no bodies.bot;no bodies.bot;no bodies.bot
PlayerMaxLives=0
...
BlockFCT=false
Description=Target switching scenarios (flick + track)
GameVersion=2.0.1.0
...
UseWeapons=false
CharacterProfile=no bodies profile
