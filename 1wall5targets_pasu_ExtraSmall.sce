Name=1wall5targets_pasu_ExtraSmall
PlayerCharacters=A_air_pistol_frozen
BotCharacters=test 2.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=A_air_pistol_frozen
AddedBots=test 2.bot;test 2.bot;test 2.bot;test 2.bot;test 2.bot
PlayerMaxLives=0
...
GameTag=Click Timing,Flick
WeaponHeroTag=Pistol
DifficultyTag=4
AuthorsTag=Fuglaa,highphive
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=1wall5targets_pasu_small but the targets are even smaller. 
GameVersion=2.0.0.2
...
UseWeapons=true
CharacterProfile=react_ExtraSmall
