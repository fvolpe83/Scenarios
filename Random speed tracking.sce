Name=Random speed tracking
PlayerCharacters=A
BotCharacters=random.rot
IsChallenge=true
Timelimit=90.0
PlayerProfile=A
AddedBots=random.rot
PlayerMaxLives=0
BotMaxLives=8
PlayerTeam=1
BotTeams=2
...
Name=random
ProfileNames=smooth_1;smooth_2;smooth_3;smooth_4;smooth_5;smooth_6;smooth_7
