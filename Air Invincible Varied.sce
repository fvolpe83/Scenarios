...
BlockFCT=false
Description=patys' Air AIO, but the bot moves at regular fastbot speed.
GameVersion=1.0.8.0
...
[Bot Profile]
Name=air1_UFO
DodgeProfileNames=Long Strafes Close;Long Strafes Jumping;Short Strafes Close;Short Strafes Jumping
