Name=Charge - B180 Sparky FN
PlayerCharacters=Character Profile;FortniteMain
...
Name=FortniteMain
MaxHealth=100.0
WeaponProfileNames=Charge Shotgun;;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=16.0
CrouchHeightModifier=0.5
...
BurstShotCount=1
TimeBetweenBursts=0.5
ChargeStartDamage=80.0
ChargeStartVelocity=X=100000.000 Y=0.000 Z=0.000
