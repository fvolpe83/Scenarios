Name=patTargetClick Dodge Manwing Thin
...
DifficultyTag=3
AuthorsTag=patys, Convertible
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Click on moving targets, headshot = oneshot. Modified w/ Manwing.
GameVersion=2.0.0.2
...
DodgeProfileNames=Close Very Short Strafes;Close Short Strafes;Close Long Strafes
DodgeProfileWeights=1.0;2.0;1.0
