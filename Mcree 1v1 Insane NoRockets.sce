Name=Mcree 1v1 Insane NoRockets
PlayerCharacters=McCoy;Sergeant 87;Shinji;Racer;Hansel;OrbMonk;Grandma
BotCharacters=Shinji Bot.bot;McCoy Bot.bot;Rocket Flyer Bot.bot;Sergeant Bot.bot;Racer Bot.bot;Random Bot Watcher No Flyer.rot
IsChallenge=true
Timelimit=120.0
PlayerProfile=McCoy
AddedBots=Random Bot Watcher No Flyer.rot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=2
...
DifficultyTag=5
AuthorsTag=KovaaK / Zimbolt edit
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=You as McCoy vs a single random bot, separated by an invisible wall. But harder, faster, longer and theres no rocket flyer
GameVersion=1.0.6.2
