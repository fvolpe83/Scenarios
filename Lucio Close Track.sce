...
WeaponHeroTag=Lucio
DifficultyTag=4
AuthorsTag=Fusha, fuglaa
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=A small and fast bot that moves horizontally and verticall with slow self healing meant to simulate Lucio's head while he is wallriding at close range.
GameVersion=1.0.5
...
DodgeProfileMinChangeTime=0.75
