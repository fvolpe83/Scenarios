Name=2-3 Dodge ClickTile L xFarStrafe
PlayerCharacters=abChallengerClick
BotCharacters=TileSlowL xFarLongOStrafe.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=abChallengerClick
AddedBots=TileSlowL xFarLongOStrafe.bot;TileSlowL xFarLongOStrafe.bot;TileSlowL xFarLongOStrafe.bot;TileSlowL xFarLongOStrafe.bot;TileSlowL xFarLongOStrafe.bot
PlayerMaxLives=0
...
BlockFCT=false
Description=ab2 Dodge ClickTile 90 SlowL xFarLongOStrafe
GameVersion=2.0.1.1
