Name=Smoothness Trainer Air small
PlayerCharacters=A
...
GameTag=track,overwatch,smooth,ddtv,,overwatch,fortnite,fn,ow,apex,cs,r6
WeaponHeroTag=lg,soldier,tracer
DifficultyTag=3
AuthorsTag=Ku, DevinDTV, sorazmi, Aestheticgoose
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=false
BlockFCT=false
Description=Higher damage for the centre of target. This one is adapted to Air and flies!!
GameVersion=2.0.0.2
...
AimingProfileNames=Default;Default;Default;Default;Default;Default;Default
...
AirJumpVelocity=0.0
MainBBType=Cylindrical
MainBBHeight=76.199997
MainBBRadius=33.330002
MainBBHasHead=false
MainBBHeadRadius=45.0
MainBBHeadOffset=0.0
MainBBHide=false
