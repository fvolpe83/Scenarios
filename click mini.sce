...
BotCharacters=bot_decay_small.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Clicker
AddedBots=bot_decay_small.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=2
...
BlockFCT=true
Description=Flick to a short-lived target before it despawns. A test of reflex and flick accuracy. Single 100 size target with 450 ms lifetime.
GameVersion=1.0.7.2
...
UseWeapons=true
CharacterProfile=target_decay_small
