Name=XYSmall For High FoV 025 Timescale
PlayerCharacters=A_air_pistol_frozen
BotCharacters=air1F_close_short.bot
IsChallenge=true
Timelimit=20.0
PlayerProfile=A_air_pistol_frozen
AddedBots=air1F_close_short.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=2
BotTeams=1
...
WeaponHeroTag=LG
DifficultyTag=4
AuthorsTag=Fuglaa (based on fuglaaXYShortstrafes), 3osk3sh (adjustments)
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Track a very small, slow bot moving in XY directions with a lot of direction changes. Goal: Helping with very small adjustments in aiming and working out jitteryness.
GameVersion=2.0.1.0
...
MaxHealth=100.0
WeaponProfileNames=Track Master 100 Ken;;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
