Name=Tile Frenzy 360
PlayerCharacters=TileFrenzy Challenger
BotCharacters=TileFrenzy Cube.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=TileFrenzy Challenger
AddedBots=TileFrenzy Cube.bot;TileFrenzy Cube.bot;TileFrenzy Cube.bot;TileFrenzy Cube.bot;TileFrenzy Cube.bot;TileFrenzy Cube.bot;TileFrenzy Cube.bot;TileFrenzy Cube.bot;TileFrenzy Cube.bot;TileFrenzy Cube.bot
PlayerMaxLives=0
...
BlockFCT=false
Description=Tile Frenzy 360. 10 targets, 60 seconds, 360 degrees.
GameVersion=1.0.8.0
