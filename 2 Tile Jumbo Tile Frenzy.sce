...
WeaponHeroTag=
DifficultyTag=1
AuthorsTag=Sharqosity (added 2 Tile mode by twitch.tv/relog)
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=2 Tiles Appear on screen once you shoot one it appears again for 30 seconds
GameVersion=1.0.6.2
