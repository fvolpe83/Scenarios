Name=1widewall10targets_pasu 
PlayerCharacters=A_air_pistol_frozen
BotCharacters=test.bot
IsChallenge=true
Timelimit=42.0
PlayerProfile=A_air_pistol_frozen
AddedBots=test.bot;test.bot;test.bot;test.bot;test.bot;test.bot;test.bot
PlayerMaxLives=0
...
DifficultyTag=3
AuthorsTag=Fuglaa, buntly
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=1wall5targets_pasu reload but on Wide Wall since that's the new meta
GameVersion=2.0.2.0
