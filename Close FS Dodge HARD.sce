...
BlockFCT=false
Description=Close quarter combat against a fast strafing bot. Keep moving for increased score. bot thinner and has a harder tracking pattern in this version. hf 
GameVersion=1.0.7.2
...
DodgeProfileWeights=2.0;0.5;1.5
