Name=VSS GP Close Track Far Click
PlayerCharacters=A
...
GameTag=Track 
WeaponHeroTag=LG Rail
DifficultyTag=5
AuthorsTag=razaplaza, Zac, Moffit
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=you can only damage far bots with rail headshots
GameVersion=1.0.7.2
