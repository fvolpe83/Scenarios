Name=1wall8targets 30 sec
PlayerCharacters=Player
BotCharacters=target.bot;250ms.bot;300ms.bot;350ms.bot;400ms.bot;450ms.bot;500ms.bot;500ms.bot
IsChallenge=true
Timelimit=30.0
...
BlockFCT=true
Description=Eight targets spawn on a wall.  Great practice for flicking to many targets quickly.  Challenge mode has accuracy-based scoring. 30 Seconds mode
GameVersion=2.0.0.2
