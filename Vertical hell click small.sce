Name=Vertical hell click small
PlayerCharacters=pistol-fcv
BotCharacters=Pigeon.bot;Pigeon2.bot;Pigeon3.bot;Pigeon4.bot;Pigeon5.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=pistol-fcv
...
GameTag=fortnite, overwatch
WeaponHeroTag=pistol
DifficultyTag=3
AuthorsTag=kindred, Cody
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Practice shooting pistol against enemies above and below you. 1 kill = 2 ammo replenished
GameVersion=2.0.0.2
