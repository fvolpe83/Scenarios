Name=Bounce 180 Tracking more HP
...
WeaponHeroTag=
DifficultyTag=3
AuthorsTag=Ascetic, Huddled, Azzu
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Bounce 180, tracking
GameVersion=2.0.2.0
...
HitscanVisualOffset=X=0.000 Y=0.000 Z=55.000
