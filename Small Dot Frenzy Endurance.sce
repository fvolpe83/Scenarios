Name=Small Dot Frenzy Endurance
...
BlockFCT=false
Description=incredibly fun scenario to play while improving mouse control, endurance has been added to this scenario for also increasing focus over a certain amount of time and building speed!
GameVersion=1.0.8.0
