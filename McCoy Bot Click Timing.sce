...
DifficultyTag=3
AuthorsTag=KovaaK, Zen
BlockHitMarkers=true
BlockHitSounds=true
BlockMissSounds=true
BlockFCT=false
Description=McCoy bot only HS click timing on dodging target
GameVersion=2.0.2.0
...
Name=McCoy
MaxHealth=200.0
WeaponProfileNames=Six Shooter;Pistol;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=30.0
...
EnemyBodyColor=X=0.000 Y=0.000 Z=1.000
