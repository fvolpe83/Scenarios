...
WeaponHeroTag=AK-47 but modify to BAR/STG
DifficultyTag=4
AuthorsTag=MATHR
...
BlockFCT=false
Description=Battalion Tracking
GameVersion=1.0.7.2
...
SpreadSSH=2.0,15.0,-9.0,0.0
SpreadSCH=2.0,15.0,-9.0,0.0
SpreadMSH=2.0,15.0,-9.0,0.0
SpreadMCH=2.0,15.0,-9.0,0.0
MaxRecoilUp=1.0
MinRecoilUp=1.0
MinRecoilHoriz=-0.2
MaxRecoilHoriz=0.2
