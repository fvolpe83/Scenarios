Name=Smooth Extra Thin Strafes
PlayerCharacters=A
BotCharacters=Thin short strafe.bot;Extra Thin short strafe.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=A
AddedBots=Extra Thin short strafe.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=0
...
GameTag=tracking, quake, overwatch
WeaponHeroTag=LG
DifficultyTag=4
AuthorsTag=patys, Slick
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Smoothly track Extra thin bots that make fast strafes.
GameVersion=2.0.1.2
