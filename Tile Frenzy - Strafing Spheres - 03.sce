Name=Tile Frenzy - Strafing Spheres - 03
PlayerCharacters=TileFrenzy Challenger 3;TileFrenzy Weapon Overrides;TileFrenzy Zooms 10sec
BotCharacters=TileFrenzyStrafing Cube.bot;TileFrenzyStrafing Sphere.bot
IsChallenge=true
Timelimit=30.0
PlayerProfile=TileFrenzy Challenger 3
AddedBots=TileFrenzyStrafing Sphere.bot;TileFrenzyStrafing Sphere.bot;TileFrenzyStrafing Sphere.bot;TileFrenzyStrafing Sphere.bot
PlayerMaxLives=0
BotMaxLives=0;0;0;0
PlayerTeam=1
BotTeams=2;2;2;0
MapName=TileFrenzyStrafing_03x.map
MapScale=1.5
...
BlockFCT=true
Description=Flick between three moving cubes that respawn instantly upon death. Kill as many as you can within 30 seconds!
GameVersion=1.0.8.0
...
global
	...
	entity
		type PlayerSpawn
		Vector3 position 0.000000 -12.000000 -5888.000000
		Bool8 teamB 0
	entity
		type CameraPath
