Name=lorenz's Fn TPS shotgun flick
PlayerCharacters=Player;FortniteMain
BotCharacters=target.bot;target decay.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=FortniteMain
AddedBots=target decay.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=0
