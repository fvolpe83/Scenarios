Name=Close Fast Strafes Easy Pistol
PlayerCharacters=Quaker
BotCharacters=Quaker Bot Easy No Pistol.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Quaker
AddedBots=Quaker Bot Easy No Pistol.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=2
...
BlockFCT=false
Description=Pistol practice for valorant
GameVersion=2.0.2.0
...
[Bot Profile]
Name=Quaker Bot Easy No Pistol
...
UseWeapons=false
CharacterProfile=valorant char
