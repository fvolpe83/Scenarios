Name=Fortnite Box Strafes Shotgun 
...
DifficultyTag=3
AuthorsTag=patys, KovaaK, Secondo, trist
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Shotgun box practice in fortnite
GameVersion=2.0.0.2
...
DodgeProfileNames=Long Strafes Jumping;Close Long Strafes;Close Very Short Strafes
