...
BlockFCT=false
Description=Basically like vF Kroader's Aim Duels but in Kovaak's
GameVersion=2.0.0.1
...
MinReactionTime=0.4
MaxReactionTime=0.5
MinSelfMovementCorrectionTime=0.4
MaxSelfMovementCorrectionTime=0.5
FlickFOV=30.0
FlickSpeed=1.5
FlickError=35.0
TrackSpeed=3.5
...
UseWeapons=true
CharacterProfile=A_air_pistol_frozenbot
...
SpreadSSA=0.5,10.0,-1.0,3.0
SpreadSCA=0.5,10.0,-1.0,3.0
SpreadMSA=0.5,10.0,-1.0,3.0
SpreadMCA=0.5,10.0,-1.0,3.0
SpreadSSH=1.0,10.0,-1.0,5.0
SpreadSCH=1.0,10.0,-1.0,5.0
SpreadMSH=1.0,10.0,-1.0,5.0
SpreadMCH=1.0,10.0,-1.0,5.0
MaxRecoilUp=1.0
MinRecoilUp=1.0
MinRecoilHoriz=0.0
MaxRecoilHoriz=0.0
