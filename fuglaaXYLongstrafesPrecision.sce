Name=fuglaaXYLongstrafesPrecision
...
WeaponHeroTag=
DifficultyTag=3
AuthorsTag=fuglaa, yarn
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=fuglaaXYLongstrafes but with a 35 radius sphere instead of a 100 radius capsule, and at 0.85 time scale. For 2D smoothness/Precision.
GameVersion=2.0.0.2
