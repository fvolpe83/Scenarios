Name=fuglaaXYShortstrafes Easy small
...
WeaponHeroTag=LG
DifficultyTag=2
AuthorsTag=fuglaa, patys, aestheticgoose
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Track the short strafing target vertically and horizontally. Lower movement speed compared to the original.
GameVersion=1.0.8.0
