Name=McCoy 1v1 NO WEAPON BOTS
PlayerCharacters=McCoy;Rocket Flyer;Sergeant 87;Shinji;Racer;Hansel;OrbMonk;Grandma
...
BlockFCT=false
Description=You as McCoy vs a single random bot, separated by an invisible wall.
GameVersion=2.0.1.2
