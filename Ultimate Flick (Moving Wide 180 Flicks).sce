Name=Ultimate Flick (Moving Wide 180 Flicks)
...
DifficultyTag=3
AuthorsTag=Ben Rabara
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=This is the ultimate flick scenario where you target moving targets through a 180 degree field of view.
GameVersion=1.0.7.2
