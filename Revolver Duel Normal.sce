...
GameTag=
WeaponHeroTag=Pistol, Peacekeeper
DifficultyTag=4
AuthorsTag=Watsyurdeal
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Revolver Duel in an enclosed space, stay on the move and focus on accuracy to improve your score.
GameVersion=2.0.2.0
