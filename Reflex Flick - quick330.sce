...
BlockFCT=true
Description=Flick to a short-lived target before it despawns. A test of reflex and flick accuracy. Single 100 size target with 400 ms lifetime.
GameVersion=2.0.2.0
...
DelayAfterUse=0.0
FullyAuto=true
WeaponProfile=selfdamage 330 ms
