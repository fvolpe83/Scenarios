...
BlockFCT=true
Description=Practice to recognize a movement direction of a target quickly. A target begins to move when you hit it (lifetime: 500 ms).
GameVersion=2.0.0.2
