Name=Ascended R99 - Hard
PlayerCharacters=Ascended Tracking
BotCharacters=Apex Bot - Purple.bot
IsChallenge=true
Timelimit=90.0
PlayerProfile=Ascended Tracking
AddedBots=Apex Bot - Purple.bot;Apex Bot - Purple.bot;Apex Bot - Purple.bot
PlayerMaxLives=0
BotMaxLives=0;0;0
PlayerTeam=1
BotTeams=0;0;0
...
BlockFCT=true
Description=R99 Tracking Exercise Bot health = 200hp (Same as Purple armor)Any suggestions ask me on twitter @supatroopa_
GameVersion=1.0.7.2
