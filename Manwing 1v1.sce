...
BotCharacters=Apex Rotation (sort of).rot
IsChallenge=true
Timelimit=100000.0
PlayerProfile=Apexer
AddedBots=Apex Rotation (sort of).rot
PlayerMaxLives=0
BotMaxLives=15
PlayerTeam=1
BotTeams=2
...
DifficultyTag=3
AuthorsTag=KovaaK, KROADER
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=You as McCoy vs a single bot in a fixed rotation, separated by an invisible wall.
GameVersion=2.0.2.0
...
Name=Apex Rotation (sort of)
ProfileNames=Shinji Bot;McCoy Bot;Sergeant Bot;Racer Bot
