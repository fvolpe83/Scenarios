Name=Air Angelic Fast Short Strafes Pure Vertical
PlayerCharacters=A
...
BlockFCT=false
Description=the gun is an automatic shotgun with pellets that spread in a horizontal line, so its impossible to miss the bot laterally, also the bot is air short fast strafes from air angelic but with tweaks to the jetpack to cause more varied vertical movement
GameVersion=1.0.7.2
