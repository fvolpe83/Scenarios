...
BlockFCT=false
Description=Air II but the bots are smaller, slower and have less health
GameVersion=2.0.2.0
...
JetpackFuelIncPerSec=1.0
JetpackFuelRegensInAir=true
JetpackThrust=5600.0
JetpackMaxZVelocity=480.0
JetpackAirControlWithThrust=1.0
AbilityProfileNames=;;;
HideWeapon=false
AerialFriction=0.0
