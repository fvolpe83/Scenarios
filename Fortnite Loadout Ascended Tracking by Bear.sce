Name=Fortnite Loadout Ascended Tracking by Bear
PlayerCharacters=FortniteMain
BotCharacters=IAFortnite-2.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=FortniteMain
AddedBots=IAFortnite-2.bot;IAFortnite-2.bot;IAFortnite-2.bot
PlayerMaxLives=0
BotMaxLives=0;0;0
PlayerTeam=1
BotTeams=2;2;2
...
DifficultyTag=4
AuthorsTag=Original scenario by Cody, Skyllers, KovaaK, edited by Bear
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=false
BlockFCT=false
Description=Fortnite AR Training on the Ascended series of maps. Slower movement, less jumping compared to v1. Introduced some crouching.
GameVersion=2.0.2.0
