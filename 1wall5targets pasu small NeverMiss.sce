Name=1wall5targets pasu small NeverMiss
...
GameTag=Pistol/4shot
WeaponHeroTag=Nevermiss
DifficultyTag=4
AuthorsTag=Kroader, Fuglaa, Pasutazame
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=1w5p small targets, if you miss one shot you lose
GameVersion=1.0.8.0
