Name=tamTargetSwitch Control Hard
...
BlockFCT=false
Description=Small regenerating dots wiggle back and forth around you while also bouncing slowly, 0.5s ttk, up to 1s to regen to full, starts regening 0.3s after going off target
GameVersion=2.0.2.0
