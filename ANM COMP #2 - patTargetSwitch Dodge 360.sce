Name=ANM COMP #2 - patTargetSwitch Dodge 360
PlayerCharacters=QuakerPlayer
BotCharacters=Quaker Bot Long Strafes.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=QuakerPlayer
...
WeaponHeroTag=MG
DifficultyTag=3
AuthorsTag=patys, sini
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=patTargetSwitch but while moving on a 360 environment.
GameVersion=2.0.1.0
