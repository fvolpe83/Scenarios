Name=FoxyPewPew Apex
PlayerCharacters=Quaker
BotCharacters=apexparalympics.bot;apexparalympics.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Quaker
AddedBots=apexparalympics.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=2
BotTeams=0
