...
GameTag=Creative Destruction
WeaponHeroTag=pump, shotgun, training, real, train, jump
DifficultyTag=3
AuthorsTag=LeCeuv, TntSpys
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=CD Shotgun Training with DTR and Pump
GameVersion=1.0.7.2
...
Name=Fortnite
MaxHealth=200.0
WeaponProfileNames=Pump;DTR;Pump;DTR;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=16.0
...
SpreadSSH=0.1,0.1,1.0,1.0
SpreadSCH=0.0,0.1,1.0,1.0
SpreadMSH=0.1,0.1,1.0,1.0
