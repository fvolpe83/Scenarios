Name=Bounce 180 Speed Training (Fast Switch)
...
DifficultyTag=2
AuthorsTag=kindred, Huddled
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Bots have less HP (20hp), and you gain time for every bot you kill (0.4s). Switch targets faster to keep up!
GameVersion=2.0.0.2
