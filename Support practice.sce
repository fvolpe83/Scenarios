...
PlayerCharacters=OrbMonk;Shinji
BotCharacters=Watcher Bot Fast Strafes.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=OrbMonk
AddedBots=Watcher Bot Fast Strafes.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=2
BotTeams=1
...
BlockFCT=false
Description=Low pressure fast projectile against a hard to hit target. 
GameVersion=1.0.7.2
...
Name=OrbMonk
MaxHealth=200.0
WeaponProfileNames=Monk Orb;Syringe Rifle;Lusio gun;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=35.0
...
DamagePerShot=20.0
KnockbackFactor=4.0
TimeBetweenShots=0.92
Pierces=false
Category=SemiAuto
BurstShotCount=4
TimeBetweenBursts=0.13
ChargeStartDamage=10.0
ChargeStartVelocity=X=500.000 Y=0.000 Z=0.000
ChargeTimeToAutoRelease=2.0
ChargeTimeToCap=1.0
