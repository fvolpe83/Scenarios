Name=Air Angelic Invincible 3
PlayerCharacters=A
BotCharacters=air_close_short.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=A
AddedBots=air_close_short.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=2
...
BlockFCT=false
Description=Invincible version of Air Angelic bot 3 for 60 seconds.
GameVersion=2.0.0.2
