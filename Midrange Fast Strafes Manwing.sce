Name=Midrange Fast Strafes Manwing
...
DifficultyTag=4
AuthorsTag=patys, Hachi
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=optimized apex strafe speed and wingman
GameVersion=2.0.0.2
ScorePerDistance=5.0
MBSEnable=false
MBSTime1=0.25
MBSTime2=0.5
MBSTime3=0.75
...
UseWeapons=false
CharacterProfile=QuakerHardbot
