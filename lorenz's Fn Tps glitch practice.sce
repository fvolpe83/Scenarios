Name=lorenz's Fn Tps glitch practice
...
BlockFCT=false
Description=I don't take credit for anything, I can't make maps I just copied the values from other to make my own. I uploaded it so that my friend can use it 
GameVersion=2.0.1.2
...
Name=Quaker
MaxHealth=500.0
WeaponProfileNames=;shotgun;SMG;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
