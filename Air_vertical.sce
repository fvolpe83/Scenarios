...
WeaponHeroTag=
DifficultyTag=4
AuthorsTag=patys (edited)
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Air NUNS but with more vertical movement
GameVersion=2.0.1.0
...
ProfileNames=air1_far_long;air1_far_short;air1F_far_long;air1F_far_short
...
JetpackActivationDelay=0.2
JetpackFullFuelTime=1.0
JetpackFuelIncPerSec=1.1
JetpackFuelRegensInAir=true
JetpackThrust=12000.0
JetpackMaxZVelocity=1550.0
JetpackAirControlWithThrust=1.0
AbilityProfileNames=;;;
HideWeapon=false
AerialFriction=0.0
