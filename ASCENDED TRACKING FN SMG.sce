Name=ASCENDED TRACKING FN SMG
PlayerCharacters=FortniteMain
BotCharacters=IAFortnite.bot
IsChallenge=true
Timelimit=300.0
PlayerProfile=FortniteMain
AddedBots=IAFortnite.bot;IAFortnite.bot;IAFortnite.bot;IAFortnite.bot;IAFortnite.bot
PlayerMaxLives=0
...
GameTag=Fortnite, Ascended Tracking
WeaponHeroTag=Assault Rifle
DifficultyTag=2
AuthorsTag=Skyllers, KovaaK
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=false
BlockFCT=false
Description=Fortnite AR Training on the Ascended series of maps.
GameVersion=1.0.7.2
