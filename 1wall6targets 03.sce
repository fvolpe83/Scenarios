...
GameTag=Mouse Control and Speed Training
WeaponHeroTag=
DifficultyTag=1
AuthorsTag=
...
BlockFCT=true
Description=Six targets spawn on a wall.  Great practice for flicking to many targets quickly.  Challenge mode has accuracy-based scoring.
GameVersion=2.0.0.2
