Name=Fortnite 180 flick
PlayerCharacters=FortniteMain
BotCharacters=TileFrenzy Cube.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=FortniteMain
AddedBots=TileFrenzy Cube.bot;TileFrenzy Cube.bot;TileFrenzy Cube.bot;TileFrenzy Cube.bot;TileFrenzy Cube.bot
PlayerMaxLives=0
...
Name=FortniteMain
MaxHealth=100.0
WeaponProfileNames=pistol;FN AR;Shotgun;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=16.0
