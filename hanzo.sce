...
BotCharacters=Quaker Bot Medium.bot;Quaker Bot Long Strafes.bot;Pigeon.bot;Quaker Bot Fast Strafes.bot;Quaker Bot Close.bot
IsChallenge=true
Timelimit=60.0
...
BlockFCT=false
Description=Snipe small jumping spheres out of the air with a Bow & Arrow.
GameVersion=1.0.8.0
...
MuzzleVelocityMin=X=18181.818 Y=0.000 Z=0.000
MuzzleVelocityMax=X=18181.818 Y=0.000 Z=0.000
