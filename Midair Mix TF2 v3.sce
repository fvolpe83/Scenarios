Name=Midair Mix TF2 v3
PlayerCharacters=Soldier TF2 (lp) (9999 HP)
BotCharacters=Scout TF2 (lp) Bot (No Weapon).bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Soldier TF2 (lp) (9999 HP)
AddedBots=Scout TF2 (lp) Bot (No Weapon).bot;Scout TF2 (lp) Bot (No Weapon).bot
PlayerMaxLives=0
BotMaxLives=0;0
PlayerTeam=1
BotTeams=2;2
...
ScorePerDamage=0.5
ScorePerKill=0.0
ScorePerMidairDirect=60.0
ScorePerAnyDirect=30.0
ScorePerTime=0.0
...
GameTag=
WeaponHeroTag=Soldier, Demoman
DifficultyTag=4
AuthorsTag=KovaaK, Tob, Mikey
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Midair Mix with Soldier/Demoman vs Scout Bots. Added Grenade launcher and allowed the scouts to jump.
GameVersion=2.0.2.0
...
[Bot Profile]
Name=Scout TF2 (lp) Bot (No Weapon)
...
UseWeapons=false
CharacterProfile=Scout TF2 (lp) (Less air control)
...
[Character Profile]
Name=Soldier TF2 (lp) (9999 HP)
MaxHealth=9999.0
WeaponProfileNames=TF2 RL (infinite ammo);TF2 GL (infinite ammo);;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=18.0
...
[Character Profile]
Name=Scout TF2 (lp) (Less air control)
MaxHealth=125.0
...
DamageFalloffStartDistance=1024.0
DamageFalloffStopDistance=2048.0
...
ChargeTimeToCap=1.0
ChargeMoveSpeedModifier=1.0
MuzzleVelocityMin=X=1150.000 Y=0.000 Z=200.000
MuzzleVelocityMax=X=1150.000 Y=0.000 Z=200.000
InheritOwnerVelocity=0.0
OriginOffset=X=0.000 Y=0.000 Z=0.000
MaxTravelTime=10.0
MaxHitscanRange=100000.0
