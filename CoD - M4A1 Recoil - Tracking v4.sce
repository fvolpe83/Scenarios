Name=CoD - M4A1 Recoil - Tracking v4
...
GameTag=Tracking
WeaponHeroTag=M4A1, Call of Duty
DifficultyTag=3
AuthorsTag=KovaaK
...
BlockFCT=true
Description=Track 3 targets at various ranges with the recoil of the M4A1 in CoD MW (2019.) Target Health based off of Warzone Armor plating values.
GameVersion=2.0.0.2
