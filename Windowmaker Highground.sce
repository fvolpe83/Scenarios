...
WeaponHeroTag=Widowmaker, Hitscan, Sniper, ADS
DifficultyTag=1
AuthorsTag=Taunty, Huddled, Felicity
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=As Windowmaker, try to take down five different watcher bots as quickly as you can within the time limit.
GameVersion=1.0.6.3
...
ProfileNames=Racer Bot;Shinji Bot
