Name=Widowmaker Vertical Headshots No DMG
...
DifficultyTag=4
AuthorsTag=KovaaK, Risker
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Snipe random enemies from an elevated position.  Be sure to zoom in. Enemies don't shoot back. Headshots only.
GameVersion=1.0.7.2
