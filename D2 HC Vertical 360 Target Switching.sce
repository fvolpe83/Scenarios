Name=D2 HC Vertical 360 Target Switching
...
BlockFCT=false
Description=This is to help you train how fast you In this exercise you will be shooting and tracking vertical targets, BUT this is not the only objective of the exercise. It will also train you to quickly and accurately switch and acquire targets with Hand Cannons. Thus increasing the speed between one target to another. To find out how to properly do this exercise please watch my Hand Cannon Training video on Youtube at HazedNConfused.
GameVersion=2.0.1.2
