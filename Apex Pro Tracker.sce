...
GameTag=Apex, Close, Mid, Long, Dodge
WeaponHeroTag=Spray, railgun, r99, r301, flatline
DifficultyTag=5
AuthorsTag=EXO-Dodge
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Close, Mid, Long range tracking against human bot (Movement based scoring)
GameVersion=2.0.2.0
...
DodgeProfileNames=Short Strafes;Long Strafes Close;Long Strafes Jumping;MidStrafes2
DodgeProfileWeights=0.5;1.0;1.0;1.0
...
EnemyBodyColor=X=0.462 Y=0.791 Z=0.012
