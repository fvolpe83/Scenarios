...
BlockFCT=false
Description=Strafe time is 0.1 to 1000 so basically that means you can't actually predict when its going to change directions therefore this is the hardest map ever made
GameVersion=2.0.2.0
...
DodgeProfileNames=Literally unpredictable
