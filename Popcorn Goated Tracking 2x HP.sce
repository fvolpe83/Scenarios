Name=Popcorn Goated Tracking 2x HP
...
DifficultyTag=3
AuthorsTag=gli, nocrno, Pudge
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=kill bouncing/arcing balls.  Skeet-shooting basically (But with tracking!). Edited to have 2x health, and give 20 points per kill instead of 10.
GameVersion=2.0.0.2
