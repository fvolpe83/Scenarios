Name=Close FS Easy Dodge High Ground
...
BlockFCT=false
Description=Close quarter combat against a fast strafing bot while standing on high ground. Keep moving for increased score.
GameVersion=1.0.8.0
