Name=pasu midrange invisible goated longstrafes anti-mirror thin easy dodge invincible small 360 TE no UFO no skybots x10 v3 (fixed)
PlayerCharacters=A
BotCharacters=smooth_8.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=A
AddedBots=smooth_8.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=2
...
GameTag=Fortnite, Apex Legends, PUBG, Warzone, Blackout, Ring of Elysium, SCUM, Realm Royale, H1Z1, Darwin Project, The Culling, Radical Heights, Totally Accurate Battlegrounds, Minecraft
WeaponHeroTag=R99, R301, Diamond Sword (Enchanted)
DifficultyTag=1
AuthorsTag=Xytaglyph
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=an intro wrist/arm tracking scenario for beginners
GameVersion=2.0.0.2
