...
WeaponHeroTag=
DifficultyTag=2
AuthorsTag=KovaaK, Platacat
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=true
Description=Ascended Tracking Optimised to Rainbow Six Seige. Seperate guns are for Acog and everything else (Red dot, Reflex, Iron Sights, Halo. ie: RRIH) Your Sens is automaticly handeled. Set your overal sens to your rainbow ads sens. Then go gun by gun and change the zoom fov. Acog is ur fov times .35 and All the others are fov times .9. Train to your desire, You can use 1 and 2 to switch.
GameVersion=2.0.1.0
