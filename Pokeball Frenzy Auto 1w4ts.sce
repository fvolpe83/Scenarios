Name=Pokeball Frenzy Auto 1w4ts
PlayerCharacters=Player
BotCharacters=Regenerating Pokeball.bot;Regenerating Pokeball.bot;Regenerating Pokeball.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Player
AddedBots=Regenerating Pokeball.bot;Regenerating Pokeball.bot;Regenerating Pokeball.bot;Regenerating Pokeball.bot
PlayerMaxLives=0
BotMaxLives=0;0;0;0
PlayerTeam=1
BotTeams=0;0;0;0
...
BlockFCT=true
Description=1wall 2targets small, except accuracy isn't factored into score; instead, you have ammo that reloads on kill.
GameVersion=2.0.2.0
