...
GameTag=Valorant, One taps, CS GO
...
BlockFCT=false
Description=It work same as Valorant One Tap but the time is been increased to 60secs
GameVersion=2.0.1.2
...
MaxHealth=100.0
WeaponProfileNames=pistol mini;sniper rifle;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
