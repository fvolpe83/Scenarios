...
DifficultyTag=3
AuthorsTag=kindred, gli, sini, Sackboy_Clank5
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Popcorn Sparky but with 10% smaller bots and 3 shot reload (+1 ammo per kill).
GameVersion=2.0.2.0
