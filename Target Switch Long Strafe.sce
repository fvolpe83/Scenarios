Name=Target Switch Long Strafe
PlayerCharacters=Ascended Tracking;TrackPlayer
BotCharacters=Quaker Bot Fast Strafes.bot;Quaker Bot Long Strafes.bot;Quaker Bot Close.bot;air1_far_long.bot
IsChallenge=true
Timelimit=40.0
PlayerProfile=TrackPlayer
...
GameTag=Target Switching, Track, Flick,BO4, Battlefield
WeaponHeroTag=Tracking LG, ICR
DifficultyTag=2
AuthorsTag=R0N
...
BlockFCT=true
Description=Track different targets
GameVersion=1.0.8.0
...
Name=TrackPlayer
MaxHealth=100.0
WeaponProfileNames=LG Strong;ICR;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
CrouchHeightModifier=0.5
