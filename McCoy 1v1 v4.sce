...
BlockFCT=false
Description=You as McCoy vs a single bot in a fixed rotation, separated by an invisible wall. You lose points for every damage taken.Updated with firerate buff and new models
GameVersion=2.0.0.2
...
Name=OW Rotation
ProfileNames=Shinji Bot;McCoy Bot;Rocket Flyer Bot;Sergeant Bot;Racer Bot
