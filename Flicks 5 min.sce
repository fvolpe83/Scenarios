...
BlockFCT=true
Description=Flick to a short-lived target before it despawns. A test of reflex and flick accuracy. One 300 size target with 500 ms lifetime.
GameVersion=2.0.2.0
