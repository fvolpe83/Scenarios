Name=Close Fast Strafes Easy Invincible Precise+
...
DifficultyTag=3
AuthorsTag=KovaaK, patys, Huddled, Sackboy_Clank5
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Low pressure hitscan tracking against a hard to hit target. Lower movement speed compared to the original. Target width even thinner compared to Precise.
GameVersion=2.0.0.2
