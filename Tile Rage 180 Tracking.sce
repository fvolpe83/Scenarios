Name=Tile Rage 180 Tracking
PlayerCharacters=Challenger
BotCharacters=Strafing Cube.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Challenger
AddedBots=Strafing Cube.bot;Strafing Cube.bot;Strafing Cube.bot;Strafing Cube.bot;Strafing Cube.bot
PlayerMaxLives=0
...
GameTag=tracking, accuracy
WeaponHeroTag=lg
DifficultyTag=4
AuthorsTag=PPV, kroader
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Frustration is improvement.
GameVersion=1.0.6.2
...
[Bot Profile]
Name=Strafing Cube
DodgeProfileNames=Tile Rage Dodge
...
UseWeapons=false
CharacterProfile=Strafing Cube
