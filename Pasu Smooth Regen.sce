...
DifficultyTag=3
AuthorsTag=Fuglaa, nocrno, Fallen, Maddie
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=1w5t_pasu_small with faster target
GameVersion=2.0.2.0
