Name=Orbmonk Anti-molesting
PlayerCharacters=OrbMonk
BotCharacters=MolesterBot.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=OrbMonk
AddedBots=MolesterBot.bot;MolesterBot.bot;MolesterBot.bot
PlayerMaxLives=0
BotMaxLives=0;0;0
PlayerTeam=0
BotTeams=0;0;0
...
WeaponHeroTag=Zenyatta, Monk Orb
DifficultyTag=5
AuthorsTag=
...
BlockFCT=false
Description=As Zenyatta you get knocked about very often. Practice counter-killing them.
GameVersion=1.0.8.0
...
Name=Molester
MaxHealth=200.0
WeaponProfileNames=Molesting Rocket;;;;;;;
MinRespawnDelay=0.5
MaxRespawnDelay=5.0
StepUpHeight=16.0
CrouchHeightModifier=0.7
...
CanJumpFromCrouch=false
EnemyBodyColor=X=0.771 Y=0.000 Z=0.000
EnemyHeadColor=X=0.468 Y=0.195 Z=0.095
TeamBodyColor=X=1.000 Y=0.888 Z=0.000
TeamHeadColor=X=0.468 Y=0.195 Z=0.095
...
FlatKnockbackVerticalMin=350.0
ADSScope=No Scope
ADSFOVOverride=72.099998
ADSFOVScale=Overwatch
