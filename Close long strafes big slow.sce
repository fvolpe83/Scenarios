Name=Close long strafes big slow
PlayerCharacters=Quaker
BotCharacters=Quaker Bot Long Strafes Far With Slow.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Quaker
AddedBots=Quaker Bot Long Strafes Far With Slow.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=0
...
[Bot Profile]
Name=Quaker Bot Long Strafes Far With Slow
...
JetpackMaxZVelocity=400.0
JetpackAirControlWithThrust=0.25
AbilityProfileNames=Slow down ability.abilmov;;;
HideWeapon=true
AerialFriction=0.0
StrafeSpeedMult=1.0
BackSpeedMult=1.0
