Name=Dont Stop Moving (Ascended)
PlayerCharacters=Ascended Tracking
BotCharacters=Quaker Bot Hard ascend.bot
IsChallenge=true
Timelimit=90.0
PlayerProfile=Ascended Tracking
AddedBots=Quaker Bot Hard ascend.bot;Quaker Bot Hard ascend.bot;Quaker Bot Hard ascend.bot
PlayerMaxLives=0
BotMaxLives=0;0;0
PlayerTeam=1
BotTeams=2;2;2
...
BlockFCT=true
Description=Movement based + Efficiency based scoring, fast tracking. Strafes are long and short to replicate real in-game Firefight scenarios. 
GameVersion=1.0.8.0
...
[Bot Profile]
Name=Quaker Bot Hard ascend
DodgeProfileNames=Circle Strafe;Long Strafes;Short Strafes;MidStrafes2
DodgeProfileWeights=1.0;2.0;1.0;1.5
