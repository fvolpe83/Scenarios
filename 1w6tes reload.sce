...
GameTag=Clicking, precision.
WeaponHeroTag=BB Gun
DifficultyTag=2
AuthorsTag=ku, gli, kovaak, Sackboy_Clank5
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=true
Description=1wall 6targets small, except accuracy isn't factored into score; instead, you have ammo that reloads on kill, and the bots are extra small.
GameVersion=2.0.0.2
