Name=Jumbo Tile Frenzy with Movement
...
GameTag=Jumbo Tile Frenzy with Movement
WeaponHeroTag=
DifficultyTag=2
AuthorsTag=Kaspenic
...
BlockFCT=false
Description=Jumbo Tile Frenzy but the Targets move
GameVersion=1.0.8.0
...
[Bot Profile]
Name=target
DodgeProfileNames=Long Strafes Jumping;Circle Strafe;Mimic;Short Strafes Jumping
DodgeProfileWeights=3.0;2.0;1.0;3.0
