Name=Target Switch Thin
PlayerCharacters=Ascended Tracking;TrackPlayer
BotCharacters=Bot thin fast.bot
IsChallenge=true
Timelimit=40.0
PlayerProfile=TrackPlayer
AddedBots=Bot thin fast.bot;Bot thin fast.bot;Bot thin fast.bot
PlayerMaxLives=0
BotMaxLives=0;0;0
PlayerTeam=1
BotTeams=2;2;2
...
BlockFCT=true
Description=Track 3 thin Targets
GameVersion=1.0.8.0
...
Name=TrackPlayer
MaxHealth=100.0
WeaponProfileNames=LG Strong;Rampart;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
CrouchHeightModifier=0.5
