...
DifficultyTag=4
AuthorsTag=Ascetic, ryan, kindred
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Pasu Dodge with the original 1w5t_pasu timescale (0.7)
GameVersion=2.0.2.0
...
Name=CSpasu
MaxHealth=100.0
WeaponProfileNames=pistol;pistol2;pistol3;;;;;
