Name=Air no SKYBOTS no SLOWBOTS
PlayerCharacters=A
...
BlockFCT=false
Description=Air but there's no SKYBOTS or slow bots
GameVersion=1.0.8.0
...
ProfileNames=air1F_close_long;air1F_far_long;air1F_close_short;air1F_far_short;air1_UFO
