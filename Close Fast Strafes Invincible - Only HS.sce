Name=Close Fast Strafes Invincible - Only HS
...
GameTag=Reflex, Quake, CS, Valorant, R6
WeaponHeroTag=Lightning Gun, LG
DifficultyTag=4
AuthorsTag=KovaaK x Comanglia x vinhero
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Close Fast Strafes, thin body with Head + invincible, only HS count
GameVersion=2.0.1.2
