...
GameTag=Tracking, Dodge, Long Range
...
BlockFCT=false
Description=long range dodge and tracking training against fast strafing bots.
GameVersion=2.0.2.0
...
DodgeProfileNames=Close Short Strafes;Close Long Strafes;Close Mid Strafes;ADAD;Short Strafes
DodgeProfileWeights=2.25;0.5;1.5;1.5;0.67
...
UseWeapons=false
CharacterProfile=QuakerFasterA
...
MaxTargetDistance=4025.0
MinTargetDistance=3375.0
ToggleLeftRight=true
ToggleForwardBack=false
MinLRTimeChange=0.4
MaxLRTimeChange=0.7
