Name=Popcorn Goated Tracking NOOB invincible
...
BlockFCT=false
Description=ARE U A NOOB, U LIKE EVERYTHING EASY MODE? U PLAY WITCHER 3 ON EASIEST MODE, U PLAY AGAINST AI BOTS ON UR FAV GAME? THIS SCENARIO IS FOR U!
GameVersion=2.0.1.2
