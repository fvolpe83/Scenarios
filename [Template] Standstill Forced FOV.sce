Name=[Template] Standstill Forced FOV
PlayerCharacters=Template Forced FOV Player
BotCharacters=Template Static Target.bot
IsChallenge=false
Timelimit=30.0
PlayerProfile=Template Forced FOV Player
...
BlockFCT=true
Description=A template for creating a standstill forced FOV scenario. A player must use ADS due to hipfire doesn't deal damage. If you want to enable challenge mode, check the "Challenge" item in "Main Properties" of "Scenario Editor".
GameVersion=2.0.0.2
...
[Character Profile]
Name=Template Forced FOV Player
MaxHealth=100.0
WeaponProfileNames=Template Forced FOV Semi-auto;;;;;;;
...
[Weapon Profile]
Name=Template Forced FOV Semi-auto
Type=Hitscan
ShotsPerClick=1
DamagePerShot=0.0
KnockbackFactor=0.0
...
AlsoShoot=
ADSShoot=Template While ADS Semi-auto
StunDuration=0.0
CircularSpread=true
...
[Weapon Profile]
Name=Template While ADS Semi-auto
Type=Hitscan
ShotsPerClick=1
DamagePerShot=10.0
KnockbackFactor=0.0
