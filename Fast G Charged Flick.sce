...
GameTag=Charged, Shotgun, Golden
WeaponHeroTag=Fortnite Pump, Pump
DifficultyTag=3
AuthorsTag=Wertandrew
BlockHitMarkers=true
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=true
Description=Variation of the Pump Short Flick, but with a Golden Charged Shotgun.
GameVersion=2.0.2.0
...
Name=Clicker
MaxHealth=100.0
WeaponProfileNames=Golden Charged Shotgun;;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=0.0
...
QuickSwitchTime=0.1
WeaponModel=Blank
WeaponAnimation=Charging
UseIncReload=true
IncReloadStartupTime=0.5
IncReloadLoopTime=0.75
IncReloadAmmoPerLoop=1
IncReloadEndTime=0.5
