Name=Huge Jumbo Tile Frenzy Relax
...
GameTag=Huge Jumbo Tile Frenzy
WeaponHeroTag=
DifficultyTag=3
...
BlockFCT=false
Description=another one to relax 
GameVersion=1.0.7
...
MaxHealth=100.0
WeaponProfileNames=Track Master 1000;;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
