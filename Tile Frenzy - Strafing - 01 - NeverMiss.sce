Name=Tile Frenzy - Strafing - 01 - NeverMiss
...
BlockFCT=true
Description=Flick between three moving cubes that respawn instantly upon death. Kill as many as you can within 30 seconds! If you miss once, you fail.
GameVersion=1.0.8.0
