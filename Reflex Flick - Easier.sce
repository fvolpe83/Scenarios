...
BlockFCT=true
Description=Flick to a short-lived target before it despawns. A test of reflex and flick accuracy. Single 200 size target with 600 ms lifetime. If you are graduating from Reflex Flick Very Easy but Easy is still a tad to fast this is a good intermediate step. 
GameVersion=2.0.1.0
