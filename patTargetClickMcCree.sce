...
GameTag=Call of Duty, Battlefield, Overwatch, Apex, flick,ddtv
WeaponHeroTag=Pistol,McCree,McCoy
DifficultyTag=3
AuthorsTag=patys
...
BlockFCT=false
Description=Added .4 weapon delay. Made targets thinner.
GameVersion=1.0.7.2
