Name=114FNEgrus
PlayerCharacters=guac6
BotCharacters=surgeinvincible.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=guac6
AddedBots=surgeinvincible.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=2
BotTeams=0
...
BlockFCT=false
Description=surge tracking prctc
GameVersion=2.0.2.0
...
Name=guac6
MaxHealth=100.0
WeaponProfileNames=pewinvinciblev3;;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
