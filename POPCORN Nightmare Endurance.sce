Name=POPCORN Nightmare Endurance
...
GameTag=Single-Shot
WeaponHeroTag=Pistol, Rail, Semi-auto, Single-Shot
DifficultyTag=3
AuthorsTag=gli, busdriverx
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Nightmare endurance POPCORN, faster targets and +3.5 seconds per kill
GameVersion=1.0.5
