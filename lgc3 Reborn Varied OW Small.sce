Name=lgc3 Reborn Varied OW Small
...
GameTag=Overwatch, Reflex, Quake, lgc, Dodge
WeaponHeroTag=Soldier 76, Tracer, LG, Lightning Gun
DifficultyTag=5
AuthorsTag=patys
...
BlockFCT=false
Description=Remake of the original LGC3 mod from Quakeworld, this time with movement and hitboxes inspired by Overwatch. LG duel in an open space. Instant ground acceleration. Boost your score by moving around. Bots are chosen at random from a bot rotation with different dodging profiles.
GameVersion=2.0.1.0
