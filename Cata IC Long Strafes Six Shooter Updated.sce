Name=Cata IC Long Strafes Six Shooter Updated
...
WeaponHeroTag=McCree, mccoy, Six Shooter
DifficultyTag=2
...
BlockFCT=false
Description=Easy to hit target, updated version of McCree's gun (0.42s between shots)
GameVersion=1.0.8.0
