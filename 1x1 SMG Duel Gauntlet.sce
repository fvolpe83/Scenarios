...
GameTag=1v1, Fortnite, TPS, Track
WeaponHeroTag=SMG
DifficultyTag=5
...
BlockFCT=false
Description=An improved 1x1 SMG Duel. Survive the 6 increasingly more difficult bots for a higher score. Good luck!
GameVersion=2.0.0.2
...
TrackSpeed=3.0
TrackError=4.0
MaxTurnAngleFromPadCenter=70.0
MinRecenterTime=0.37
MaxRecenterTime=0.43
OptimalAimFOV=20.0
OuterAimPenalty=1.0
MaxError=40.0
ShootFOV=15.0
...
TrackSpeed=3.0
TrackError=3.5
MaxTurnAngleFromPadCenter=80.0
MinRecenterTime=0.35
MaxRecenterTime=0.45
OptimalAimFOV=25.0
OuterAimPenalty=1.0
MaxError=35.0
ShootFOV=13.0
