...
BlockFCT=false
Description=Bhoppers suck, so here's a trainer to beat them
GameVersion=2.0.1.2
...
DodgeProfileNames=Short Strafes Close Jump
...
CanCrouchInAir=true
CanJumpFromCrouch=false
EnemyBodyColor=X=0.070 Y=1.000 Z=0.000
EnemyHeadColor=X=1.000 Y=1.000 Z=1.000
TeamBodyColor=X=1.000 Y=0.888 Z=0.000
TeamHeadColor=X=1.000 Y=1.000 Z=1.000
BlockSelfDamage=false
