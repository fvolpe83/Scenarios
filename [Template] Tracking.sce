...
BlockFCT=true
Description=A template for creating a tracking scenario. If you want to enable challenge mode, check the "Challenge" item in "Main Properties" of "Scenario Editor".
GameVersion=2.0.0.2
...
UseWeapons=false
CharacterProfile=Template Target
