Name=Midrange Fast Strafes Invincible V2 OW
...
DifficultyTag=4
AuthorsTag=patys, aestheticgoose
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Tracking a target at mid-range. The target mixes in a few dodging profiles making its fast strafes unpredictable.
GameVersion=2.0.2.0
