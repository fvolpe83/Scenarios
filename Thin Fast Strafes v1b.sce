Name=Thin Fast Strafes v1b
PlayerCharacters=A
BotCharacters=Thin very fast strafe.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=A
AddedBots=Thin very fast strafe.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=2
...
WeaponHeroTag=
DifficultyTag=5
AuthorsTag=Original by Ku, Thin Fast Strafes changes by Fatsquirrel
