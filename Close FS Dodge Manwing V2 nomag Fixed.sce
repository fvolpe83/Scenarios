Name=Close FS Dodge Manwing V2 nomag Fixed
...
DifficultyTag=5
AuthorsTag=patys, Ascetic, ikue, KovaaK, Hachi, huekk, Ghokury
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Close FS dodge but with a wingman :) No more 100% 1 hit top 1 scores.
GameVersion=1.0.8.0
