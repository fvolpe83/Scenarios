...
WeaponHeroTag=
DifficultyTag=3
AuthorsTag=Kovaak, yuan
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=true
Description=Ascended Tracking V3, but the map is twice as large and the bots are smaller. Useful for long range AR encounters.
GameVersion=2.0.1.2
