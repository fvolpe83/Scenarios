Name=Ground Plaza Sparky 121212
PlayerCharacters=A
...
DifficultyTag=4
AuthorsTag=razaplaza, patys, sarin, Whisper
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Ground Plaza with slightly slower and thinner bots, slower ground acceleration. 6 bots - (Bot 1 & Bot 2) x3
GameVersion=2.0.1.2
...
ProfileNames=fast strafes blink;long strafe ufo blink;fast strafes blink;long strafe ufo blink;fast strafes blink;long strafe ufo blink
