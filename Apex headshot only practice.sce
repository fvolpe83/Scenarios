Name=Apex headshot only practice
PlayerCharacters=Apex purple armor wingman
BotCharacters=Apex HS bot.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Apex purple armor wingman
AddedBots=Apex HS bot.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=2
BotTeams=1
...
UseWeapons=false
CharacterProfile=Apex headshot only white armor
...
[Character Profile]
Name=Apex headshot only white armor
MaxHealth=150.0
WeaponProfileNames=;;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
