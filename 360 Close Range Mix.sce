Name=360 Close Range Mix
PlayerCharacters=Character Profile
BotCharacters=Pigeon.bot;air1F_far_long.bot;air1F_far_short.bot;Quaker Bot Fast Strafes.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Character Profile
AddedBots=Pigeon.bot;Pigeon.bot;Pigeon.bot;Quaker Bot Fast Strafes.bot;Quaker Bot Fast Strafes.bot;air1F_far_long.bot;air1F_far_short.bot
PlayerMaxLives=0
...
BlockFCT=false
Description=Pick your target from a selection of fast moving bots on a 360 map. Designed for practicing close range shot placement. All bots are 1-hit-kill.
GameVersion=1.0.6.1
