Name=tamTargetSwitch Smooth Small
...
BlockFCT=false
Description=Small regenerating dots circle around you, 0.5s ttk, up to 0.5s to regen to full, starts regening Immediately if you go off target. ~50% less 2d surface area than standard version
GameVersion=2.0.2.0
