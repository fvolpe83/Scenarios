Name=1wall20targets xxxx-small
...
BlockFCT=false
Description=The peak hardest version this game is capable off. Literal pixel size. Can't miss. Perfect for centralization of crosshairs. 
GameVersion=1.0.8.0
