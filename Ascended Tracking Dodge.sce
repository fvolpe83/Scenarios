...
BlockFCT=true
Description=Track 3 targets at a variety of ranges and angles.  The weapon you use is hitscan and does more damage if you are centered on your target.  Enemies fire slow moving projectiles that will subtract from your score if they hit you.  You gain score for moving.
GameVersion=1.0.6
...
AimingProfileNames=At Feet;High Skill;Low Skill;Default;Default;Default;Default;Default
