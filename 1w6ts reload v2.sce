...
GameTag=Valorant, Counterstrike
WeaponHeroTag=Rifle
DifficultyTag=2
AuthorsTag=ku, gli, kovaak, sini
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=true
Description=FOV lock, 1wall 6targets small, except accuracy isn't factored into score; instead, you have ammo that reloads on kill.
GameVersion=2.0.2.0
