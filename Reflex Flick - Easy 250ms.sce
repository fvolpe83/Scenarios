...
BlockFCT=false
Description=Target 250ms lifetime, same size as "Reflex Flick - Easy". Increase Map Scale for smaller targets, decrease Time Scale for longer lifetimes.
GameVersion=1.0.5
