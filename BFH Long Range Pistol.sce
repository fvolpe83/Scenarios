Name=BFH Long Range Pistol
PlayerCharacters=BFH Soldier
BotCharacters=Tiny QC Fast Strafes.bot
IsChallenge=true
Timelimit=90.0
PlayerProfile=BFH Soldier
AddedBots=Tiny QC Fast Strafes.bot;Tiny QC Fast Strafes.bot;Tiny QC Fast Strafes.bot
PlayerMaxLives=0
BotMaxLives=0;0;0
PlayerTeam=1
BotTeams=0;0;0
...
GameTag=BFH Long Range Pistol
WeaponHeroTag=
DifficultyTag=3
AuthorsTag=KovaaK (changed by Brumor)
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=false
BlockFCT=false
Description=Aiming with BFH Long Range Pistol.
GameVersion=1.0.6.2
