Name=Ascended Tracking e-sports edition (ultimate)
...
GameTag=Tracking, Flicking, Strafing, esports
WeaponHeroTag=
DifficultyTag=4
AuthorsTag=Hunsley
...
BlockFCT=true
Description=You know this, just a bit faster, harder and more challenging. (Tipp; Accuracy is key!)   Track 3 targets at a variety of ranges and angles.  The weapon you use is hitscan and does more damage if you are centered on your target.  Difference from v2 is that v3 allows you to ADS/zoom.
GameVersion=2.0.1.2
...
MainBBRadius=20.0
MainBBHasHead=true
MainBBHeadRadius=17.0
MainBBHeadOffset=3.0
MainBBHide=false
ProjBBType=Cylindrical
ProjBBHeight=300.0
ProjBBRadius=20.0
...
DamageReactionChanceToIgnore=0.1
