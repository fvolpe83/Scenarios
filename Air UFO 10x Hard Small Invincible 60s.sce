Name=Air UFO 10x Hard Small Invincible 60s
PlayerCharacters=A
...
WeaponHeroTag=
DifficultyTag=5
AuthorsTag=nick, Ku, patys, Sackboy_Clank5
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=true
Description=Kill the Air UFO Boss 10 times. Scored on time remaining. Smaller than the original.
GameVersion=2.0.1.2
...
[Bot Profile]
Name=air1_UFO
DodgeProfileNames=Very Short Strafes + Jump;Short Strafes Close
