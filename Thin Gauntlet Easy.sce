...
GameTag=Sparky, Smoothness, Valorant, Overwatch
WeaponHeroTag=
DifficultyTag=3
...
BlockFCT=false
Description=Track very thin targets that make long strafes, progressively getting harder. Challenge mode takes up to 2-3 minutes. Easy version. 75% speed and 25% wider bots
GameVersion=2.0.2.0
