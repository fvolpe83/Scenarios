...
BotCharacters=Pigeon.bot;Pigeon.bot;Pigeon.bot;Quaker Bot Long Strafes.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Ultimater
AddedBots=Pigeon.bot;Pigeon.bot;Pigeon.bot;Quaker Bot Long Strafes.bot
PlayerMaxLives=0
BotMaxLives=0;0;0;0
PlayerTeam=1
BotTeams=2;2;2;0
...
BlockFCT=false
Description=Track the jumping targets with the LG to pin them in the corner, Quake style.
GameVersion=1.0.6.1
