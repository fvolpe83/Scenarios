Name=Close Very Long Strafes 200 Percent
...
BlockFCT=false
Description=Track a bot that long strafes for 10 seconds before changing directions
GameVersion=1.0.6.2
...
AimingProfileNames=At Feet;At Feet;_;Default;Default;Default;Default;Default
