Name=ET running not running
PlayerCharacters=Not running;Quaker
BotCharacters=Bot Profile.bot;Quaker Bot Long Strafes.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Not running
AddedBots=Bot Profile.bot;Quaker Bot Long Strafes.bot
PlayerMaxLives=0
BotMaxLives=0;0
PlayerTeam=1
BotTeams=2;0
...
AimingProfileNames=Default;Default;Low Skill;Default;Default;Default;Default;Default
WeaponSwitchTime=3.0
UseWeapons=true
CharacterProfile=Not running
