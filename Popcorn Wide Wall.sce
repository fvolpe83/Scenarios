...
DifficultyTag=3
AuthorsTag=kindred, gli, sini, gaschio
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=This scenario is a preparation scenario for the Popcorn sparky benchmark which should help a lot for beginners wanting to improve. Only changes made is time scale to 0.7 and map changed.
GameVersion=2.0.1.2
