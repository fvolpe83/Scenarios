Name=Pokeball Frenzy Auto
PlayerCharacters=Offset128
BotCharacters=Regenerating Pokeball.bot
IsChallenge=true
Timelimit=30.0
PlayerProfile=Offset128
...
BlockFCT=true
Description=Pokeball Frenzy but with an autofire Drill against instantly regenerating targets if you don't drill the target for at least 40ms. No accuracy penalty artifically added, the regeneration punishes you for Parkinsons aim.
GameVersion=1.0.6.2
...
CameraOffset=X=0.000 Y=0.000 Z=128.000
HeadshotOnly=false
