Name=Target Acquisition Flick Easy (Blocked FOV)
...
BlockFCT=true
Description=Bigger balls, longer despawn time than original. Aim at Poke-Ball and wait for the other target to spawn. Kill both in one fluid motion, focus on consistency to train your baseline ability to acquire targets, rather than relying on your peak flicking speed.
GameVersion=1.0.8.0
