Name=MATTBUTT VAL PISTOL ROUND TRACKING
...
BlockFCT=false
Description=PISTOL ROUND LIKE TRACKING PRACTICE VALORANT
GameVersion=2.0.2.0
...
UseWeapons=false
CharacterProfile=MATTBUTT VAL BOT tracking
...
[Character Profile]
Name=MATTBUTT VAL BOT tracking
MaxHealth=200.0
WeaponProfileNames=;;;;;;;
MinRespawnDelay=0.1
MaxRespawnDelay=0.1
