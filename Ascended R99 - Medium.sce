Name=Ascended R99 - Medium
PlayerCharacters=Ascended Tracking
BotCharacters=Apex Bot - Blue.bot
IsChallenge=true
Timelimit=90.0
PlayerProfile=Ascended Tracking
AddedBots=Apex Bot - Blue.bot;Apex Bot - Blue.bot;Apex Bot - Blue.bot
PlayerMaxLives=0
BotMaxLives=0;0;0
PlayerTeam=1
BotTeams=0;0;0
...
BlockFCT=true
Description=R99 Tracking Exercise Bot health = 175hp (Same as Blue armor)Any suggestions ask me on twitter @supatroopa_
GameVersion=1.0.7.2
