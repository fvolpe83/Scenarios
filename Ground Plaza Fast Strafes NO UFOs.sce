Name=Ground Plaza Fast Strafes NO UFOs
PlayerCharacters=A
BotCharacters=plaza rotation.rot
IsChallenge=true
Timelimit=1000.0
PlayerProfile=A
AddedBots=plaza rotation.rot
PlayerMaxLives=0
BotMaxLives=4
PlayerTeam=1
BotTeams=2
...
DifficultyTag=4
AuthorsTag=sini, razaplaza
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Only the 4 fast strafes bots from Ground Plaza. This has no UFOS, fixed spawns and no 99 prefix in the scoring.
GameVersion=1.0.8.0
