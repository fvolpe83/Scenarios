...
BlockFCT=false
Description=Duel an enemy Windowbot from a medium range. Be sure to zoom in.  Less crouch spam than the original. Corrected jump physics to OW's unification update
GameVersion=1.0.6.2
