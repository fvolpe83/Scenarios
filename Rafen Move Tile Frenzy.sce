...
GameTag=Fortnite, Apex Legend
WeaponHeroTag=AR, Shotgun
DifficultyTag=3
AuthorsTag=Rafen
...
BlockFCT=false
Description=Move Tile Frenzy Strafe 180 
GameVersion=1.0.7.2
...
MinJumpTime=0.1
MaxJumpTime=0.2
LeftStrafeTimeMult=0.15
RightStrafeTimeMult=0.15
