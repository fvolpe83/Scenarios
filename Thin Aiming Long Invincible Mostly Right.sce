Name=Thin Aiming Long Invincible Mostly Right
PlayerCharacters=A
...
GameTag=track apex legends overwatch ow hyperscape
WeaponHeroTag=track
DifficultyTag=3
AuthorsTag=Ku, huekk
...
BlockFCT=false
Description=Track a very thin INVINCIBLE target that makes long strafes mostly to the right. 
GameVersion=2.0.1.2
