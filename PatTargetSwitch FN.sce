Name=PatTargetSwitch FN
PlayerCharacters=combat shotgun
BotCharacters=Quaker Bot Fast Strafes.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=combat shotgun
AddedBots=Quaker Bot Fast Strafes.bot;Quaker Bot Fast Strafes.bot;Quaker Bot Fast Strafes.bot
PlayerMaxLives=0
BotMaxLives=0;0;0
PlayerTeam=1
BotTeams=2;0;0
...
BlockFCT=false
Description=Target switch with fortnite combat shotgun
GameVersion=1.0.8.0
