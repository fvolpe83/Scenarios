Name=Wingdude Experimental Flick
...
GameTag=Apex Legends Flick
WeaponHeroTag=Wingman Flick Timing
DifficultyTag=3
AuthorsTag=Asyntheticality
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=false
BlockFCT=false
Description=Practice Flicking
GameVersion=1.0.8.0
