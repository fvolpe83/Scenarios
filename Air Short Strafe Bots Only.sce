Name=Air Short Strafe Bots Only
PlayerCharacters=A
BotCharacters=Bot Rotation short.rot
IsChallenge=true
Timelimit=100000.0
PlayerProfile=A
AddedBots=Bot Rotation short.rot
PlayerMaxLives=0
BotMaxLives=5
PlayerTeam=1
BotTeams=2
...
DifficultyTag=4
AuthorsTag=razaplaza,Vantae
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=5 Short strafe bots taken fom the original "Air" scenario.
GameVersion=1.0.6.2
...
Name=Bot Rotation short
ProfileNames=air1F_close_short;air_close_short;air1_far_short;air1F_far_short;air1_UFO
