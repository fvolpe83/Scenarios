Name=lgc3 racer AD spam
PlayerCharacters=Quaker
BotCharacters=AD spam.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Quaker
AddedBots=AD spam.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=2
...
GameTag=Overwatch, Reflex, Quake, lgc, Dodge, ddtv
WeaponHeroTag=Soldier 76, Tracer, LG, Lightning Gun
DifficultyTag=5
AuthorsTag=patys, devin
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=This scenario is pure misery.
GameVersion=2.0.0.2
...
Name=Quaker
MaxHealth=200.0
WeaponProfileNames=Sergeant Rifle;Six Shooter;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=1.0
StepUpHeight=75.0
...
MagazineMax=25
AmmoPerShot=1
ReloadTimeFromEmpty=1.55
ReloadTimeFromPartial=1.55
