Name=DGS Pistol Practice
PlayerCharacters=Character Profile
BotCharacters=ADAD.bot
IsChallenge=true
Timelimit=60.0
...
DifficultyTag=3
AuthorsTag=DatGoodSir
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Practice getting headshots vs pesky ADAD spamers
GameVersion=1.0.8.0
