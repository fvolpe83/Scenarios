Name=PLAGUES FLOATING TILES
PlayerCharacters=Clicker
BotCharacters=Dodgey.bot;Dodgey.bot;Dodgey.bot;Dodgey.bot;Dodgey.bot
IsChallenge=true
Timelimit=12.5
PlayerProfile=Clicker
AddedBots=Dodgey.bot;Dodgey.bot;Dodgey.bot;Dodgey.bot;Dodgey.bot
PlayerMaxLives=0
...
DifficultyTag=4
AuthorsTag=PLAGUEDOCTRR
BlockHitMarkers=true
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=true
Description=HIT THE TILES BEFORE THE TOUCH THE GROUND
GameVersion=1.0.6.2
...
Name=Dodgey
MaxHealth=0.3
WeaponProfileNames=selfdamage 450 ms;;;;;;;
MinRespawnDelay=0.2
MaxRespawnDelay=0.3
StepUpHeight=75.0
CrouchHeightModifier=0.5
