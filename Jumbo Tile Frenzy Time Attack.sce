Name=Jumbo Tile Frenzy Time Attack
...
GameTag=Jumbo Tile Frenzy Time Attack
WeaponHeroTag=
DifficultyTag=2
AuthorsTag=Sharqosity(Time Attack added by soleskidder1)
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=1 Tile = .2 second gain, endurance scenario basically
GameVersion=1.0.6.2
