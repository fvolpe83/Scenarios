...
DifficultyTag=3
AuthorsTag=Lucas, Benjiz
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Advanced fortnite tac with slimmer targets and a slower speed to simulate fortnite. Targets height has also been lowered to suit the same hit box as a fortnite hit box
GameVersion=2.0.1.0
