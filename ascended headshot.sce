...
GameTag=hitscan
WeaponHeroTag=single point hitscan
DifficultyTag=2
AuthorsTag=decizion, Kovaak, mgli
BlockHitMarkers=true
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=ascended railgun, 2 bodyshots or 1 headshot for a kill. scored by kills/dmg eff
GameVersion=1.0.5
