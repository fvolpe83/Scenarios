...
BlockFCT=false
Description=Test your tracking RT using this scenario. To do so, record yourself playing in 120fps, and count the frames between your crosshair going off target (following the bot's direction change) to when your crosshair starts moving back towards the bot
GameVersion=1.0.6.2
