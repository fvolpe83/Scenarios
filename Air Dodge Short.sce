Name=Air Dodge Short
PlayerCharacters=A
BotCharacters=Bot Rotation air short.rot
IsChallenge=true
Timelimit=85.0
PlayerProfile=A
AddedBots=Bot Rotation air short.rot
PlayerMaxLives=0
BotMaxLives=4
PlayerTeam=1
BotTeams=2
...
BlockFCT=false
Description=air dodge but with only the short strafing bots and it's hard to get an actual score
GameVersion=1.0.8.0
