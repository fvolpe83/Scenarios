Name=Aim_Botz Multi Bot
PlayerCharacters=csplayer
BotCharacters=csbotz harmless.bot;csbotz harmless.bot;csbotz harmless.bot;csbotz harmless.bot;csbotz harmless.bot;csbotz harmless.bot
IsChallenge=true
Timelimit=60.0
...
BlockFCT=false
Description=CSGO Aimbotz one target
GameVersion=1.0.8.0
