...
BlockFCT=false
Description=Thin aiming long invincible, but the target only goes one direction for 30 seconds at a time.
GameVersion=1.0.7.2
...
DodgeProfileMaxChangeTime=70.0
DodgeProfileMinChangeTime=70.0
...
MinLRTimeChange=30.0
MaxLRTimeChange=30.0
MinFBTimeChange=0.2
MaxFBTimeChange=0.5
