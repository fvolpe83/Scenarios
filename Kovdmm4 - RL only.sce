...
DifficultyTag=3
AuthorsTag=Kovaak, Ch0wW
BlockHitMarkers=true
BlockHitSounds=true
BlockMissSounds=true
BlockFCT=false
Description=QuakeWorld exercice. Try to get as RL kills as possible ! Original PovDMM4 time.
GameVersion=1.0.5
...
AimingProfileNames=At Feet;Aimbot;Aimbot;Default;Default;Default;Default;Default
