Name=Floating Heads Timing Easy
...
GameTag=Valorant, Sparky, CSGO
WeaponHeroTag=Pistol
DifficultyTag=4
AuthorsTag=maruta, Huddled, Whisper
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Click the floating heads! No accuracy multiplier, ammo is reloaded on kill. Bigger bots, less ammo for balance.
GameVersion=2.0.1.2
