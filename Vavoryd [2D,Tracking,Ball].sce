Name=Vavoryd [2D,Tracking,Ball]
PlayerCharacters=Quaker
BotCharacters=Jumbo Long Strafer.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Quaker
AddedBots=Jumbo Long Strafer.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=2
BotTeams=1
...
BlockFCT=false
Description=Try to hit as many shots on the Air Bot as you can. First tracking level of me :)
GameVersion=2.0.1.0
...
[Bot Profile]
Name=Jumbo Long Strafer
DodgeProfileNames=Long Strafes;Long Strafes 2
DodgeProfileWeights=0.5;0.5
...
Name=Quaker
MaxHealth=300.0
WeaponProfileNames=AKM;M4R;LG;AKM-Vert;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
...
IsFlyer=true
FlightObeysPitch=false
FlightVelocityUp=400.0
FlightVelocityDown=400.0
