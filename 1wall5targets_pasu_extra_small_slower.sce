Name=1wall5targets_pasu_extra_small_slower
...
DifficultyTag=5
AuthorsTag=Fuglaa,highphive, sdk
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=1wall5targets_pasu_Small 50% less size and 50% less Movements speed
GameVersion=1.0.8.0
