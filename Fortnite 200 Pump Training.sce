Name=Fortnite 200 Pump Training
PlayerCharacters=Pump User
BotCharacters=200 Pump Trainer.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Pump User
AddedBots=200 Pump Trainer.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=0
...
BlockFCT=false
Description=1x1 box with bot strafing, 2 shot body shot, 1 shot headshot
GameVersion=2.0.1.2
...
3rdPersonWeaponModel=Pump Shotgun
