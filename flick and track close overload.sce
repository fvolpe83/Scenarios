Name=flick and track close overload
...
BlockFCT=false
Description=machinehead drill 6
GameVersion=1.0.6.2
...
DodgeProfileWeights=1.0;0.2;0.1
...
Name=Quaker
MaxHealth=500.0
WeaponProfileNames=Railgun;LG;LG;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
