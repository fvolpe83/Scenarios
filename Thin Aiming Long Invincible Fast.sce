Name=Thin Aiming Long Invincible Fast
PlayerCharacters=A
...
WeaponHeroTag=
DifficultyTag=4
AuthorsTag=Ku, IZikTheTerrible
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=same thin aiming long invinvcible but the target moves at 1.75x the usual speed.
GameVersion=1.0.7.2
