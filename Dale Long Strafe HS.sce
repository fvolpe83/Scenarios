Name=Dale Long Strafe HS
PlayerCharacters=aQuakerPlayer
BotCharacters=Quaker Bot Long Strafes.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=aQuakerPlayer
...
BlockFCT=false
Description=Tracking target w/ head
GameVersion=2.0.0.2
...
MaxHealth=300.0
WeaponProfileNames=Track Master 100;;;;;;;
MinRespawnDelay=0.25
MaxRespawnDelay=0.25
StepUpHeight=75.0
CrouchHeightModifier=0.5
CrouchAnimationSpeed=2.0
CameraOffset=X=0.000 Y=0.000 Z=80.000
...
CanCrouchInAir=true
CanJumpFromCrouch=false
EnemyBodyColor=X=0.792 Y=0.455 Z=0.400
EnemyHeadColor=X=1.000 Y=0.000 Z=0.584
TeamBodyColor=X=1.000 Y=0.888 Z=0.000
TeamHeadColor=X=1.000 Y=1.000 Z=1.000
BlockSelfDamage=false
InvinciblePlayer=false
