...
DifficultyTag=3
AuthorsTag=MrStealurBitty.twitch
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=practice that wingman boi
GameVersion=1.0.7.2
...
ChargeTimeToCap=1.0
ChargeMoveSpeedModifier=1.0
MuzzleVelocityMin=X=13000.000 Y=0.000 Z=0.000
MuzzleVelocityMax=X=13000.000 Y=0.000 Z=0.000
InheritOwnerVelocity=0.0
OriginOffset=X=0.000 Y=0.000 Z=0.000
MaxTravelTime=10.0
MaxHitscanRange=100000.0
