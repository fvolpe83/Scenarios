Name=Reflex Flick - Windowmaker Precise
PlayerCharacters=Stationary Windowmaker
BotCharacters=target_nodecay.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Stationary Windowmaker
AddedBots=target_nodecay.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=2
...
BlockFCT=true
Description=Target does not despawn, practice precision at your own pace.
GameVersion=1.0.6
