Name=Close Fast Strafes Easy Thin Shotgun
PlayerCharacters=Quaker
BotCharacters=Quaker Bot Fast Strafes Thin.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Quaker
AddedBots=Quaker Bot Fast Strafes Thin.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=2
...
BlockFCT=false
Description=Realistic shotgun practice vs a thin strafer
GameVersion=1.0.7.2
...
[Bot Profile]
Name=Quaker Bot Fast Strafes Thin
