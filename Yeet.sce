Name=Yeet
PlayerCharacters=A
BotCharacters=Circle Quaker.bot;Circle Quaker.bot;Circle Quaker.bot;Circle Quaker.bot
IsChallenge=true
Timelimit=30.0
PlayerProfile=A
AddedBots=Circle Quaker.bot;Circle Quaker.bot;Circle Quaker.bot;Circle Quaker.bot
PlayerMaxLives=0
BotMaxLives=5;5;5;5
PlayerTeam=1
BotTeams=2;2;2;2
...
BlockFCT=false
Description=This is a challenge for seconds remaining when you have killed all four of the bots that each have 5 lives!
GameVersion=1.0.6.1
