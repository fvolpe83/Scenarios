Name=Ground Plaza no UFO Diabotical
PlayerCharacters=A
...
DifficultyTag=4
AuthorsTag=razaplaza, mrg, zim
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Ground Plaza, but with no ufos and fixed spawns. Bot changed to resemble an eggbot.
GameVersion=2.0.2.0
