...
GameTag=2 Tile Flick Frenzy
WeaponHeroTag=
DifficultyTag=1
AuthorsTag=SeaToad (I changed @relogFN 's map)
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=2 Tiles Appear on screen once you flick shot one it appears again for 30 seconds
GameVersion=2.0.0.0
