Name=Kasper's Tap range
PlayerCharacters=TileFrenzy Challenger;TileFrenzy Weapon Overrides;TileFrenzy Zooms 10sec
BotCharacters=TileFrenzy Sphere.bot;TileFrenzy Cube.bot
IsChallenge=true
Timelimit=30.0
PlayerProfile=TileFrenzy Challenger
AddedBots=TileFrenzy Cube.bot;TileFrenzy Cube.bot;TileFrenzy Cube.bot;TileFrenzy Cube.bot
PlayerMaxLives=0
BotMaxLives=0;0;0;0
PlayerTeam=1
BotTeams=2;2;2;0
MapName=TileFrenzy_04x.map
MapScale=1.0
...
global
	...
	entity
		type PlayerSpawn
		Vector3 position 0.000000 -12.000000 -6912.000000
		Bool8 teamB 0
	entity
		type CameraPath
