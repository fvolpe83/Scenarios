Name=Pokeball Frenzy Auto 1w6tes
PlayerCharacters=Player
BotCharacters=Regenerating Pokeball.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Player
AddedBots=Regenerating Pokeball.bot;Regenerating Pokeball.bot;Regenerating Pokeball.bot;Regenerating Pokeball.bot;Regenerating Pokeball.bot;Regenerating Pokeball.bot
PlayerMaxLives=0
...
GameTag=click timing,flick,precise,overwatch,fortnite,fn,ow,apex,cs,r6,vf
WeaponHeroTag=
DifficultyTag=3
AuthorsTag=Zeeq, Pudge, Sackboy_Clank5
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=true
Description=1wall 6targets extra small, but pokeball frenzy auto variant.
GameVersion=2.0.0.2
