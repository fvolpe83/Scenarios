Name=Midrange Fast Strafes Invincible (Recoil)
...
GameTag=PubG, Ring of Elysium, Battle Royale
...
BlockFCT=false
Description=Midrange Fast Strafes Invincible with a recoil variable meant to replicate that of guns from PubG and RoE.. (Intermediate Recoil Control)
GameVersion=1.0.8.0
