...
WeaponHeroTag=
DifficultyTag=3
AuthorsTag=TauntyArmadillo, patys, Zaey
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=true
Description=Zizag, stay with your crosshair at the middle, when the 500ms target spawns, flick on the pokeball then the target
GameVersion=2.0.1.1
...
MainBBHeadOffset=-106.0
MainBBHide=false
ProjBBType=Spheroid
ProjBBHeight=105.0
ProjBBRadius=50.0
ProjBBHasHead=true
ProjBBHeadRadius=105.0
ProjBBHeadOffset=-113.0
ProjBBHide=true
HasJetpack=false
JetpackActivationDelay=0.2
