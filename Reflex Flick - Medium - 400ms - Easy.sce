Name=Reflex Flick - Medium - 400ms - Easy
...
GameTag=flick, medium, reflex flick, reflex, easy
WeaponHeroTag=
DifficultyTag=3
...
BlockFCT=true
Description=Medium Flick distance training. target lifetime: 400m. Adjustments: increased map depth (4096 units), increased spawn area padding
GameVersion=2.0.1.2
