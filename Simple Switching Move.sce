Name=Simple Switching Move
PlayerCharacters=player_char
BotCharacters=simple_walk.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=player_char
AddedBots=simple_walk.bot;simple_walk.bot;simple_walk.bot;simple_walk.bot;simple_walk.bot;simple_walk.bot;simple_walk.bot;simple_walk.bot
PlayerMaxLives=0
...
BlockFCT=true
Description=Switching target that moves left and right.
GameVersion=2.0.0.2
...
[Bot Profile]
Name=simple_walk
DodgeProfileNames=simple_dodge
