...
BlockFCT=true
Description=Flick to a short-lived target before it despawns. A test of reflex and flick accuracy. Single 120 size target with 1000 ms lifetime.
GameVersion=2.0.1.2
