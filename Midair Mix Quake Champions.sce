Name=Midair Mix Quake Champions
...
GameTag=Quake Champions, Reflex, QL, QC, QW
WeaponHeroTag=
DifficultyTag=2
AuthorsTag=
...
BlockFCT=false
Description=Quake-scaled version of Midar Mix with accurate physics and projectile speed. Targets can take two directs so practice double midairs.
GameVersion=1.0.6.2
...
MaxHealth=100.0
WeaponProfileNames=Rocket 1000ups;Rocket 900ups;LG 6dp50ms;Railgun;;;Rocket 1100ups;Rocket 1200ups
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=18.0
...
FlatKnockbackVerticalMin=100.0
ADSScope=No Scope
...
MuzzleVelocityMax=X=900.000 Y=0.000 Z=0.000
InheritOwnerVelocity=0.0
OriginOffset=X=0.000 Y=0.000 Z=0.000
MaxTravelTime=10.0
MaxHitscanRange=100000.0
...
AmmoPerShot=0
FlatKnockbackHorizontal=150.0
FlatKnockbackVertical=600.0
FlatKnockbackHorizontalMin=-150.0
FlatKnockbackVerticalMin=600.0
AIUseInCombat=true
