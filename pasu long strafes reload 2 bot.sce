Name=pasu long strafes reload 2 bot
...
BlockFCT=false
Description=Pasu Reload but with 2 bots that always long strafe. Intended for training wide angles and precise reading.
GameVersion=2.0.1.0
