Name=Tile Frenzy 180 Strafing FN AR
PlayerCharacters=FortniteMain
BotCharacters=TileFrenzyStrafing Cube.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=FortniteMain
AddedBots=TileFrenzyStrafing Cube.bot;TileFrenzyStrafing Cube.bot;TileFrenzyStrafing Cube.bot;TileFrenzyStrafing Cube.bot;TileFrenzyStrafing Cube.bot
PlayerMaxLives=0
...
WeaponHeroTag=FN AR
DifficultyTag=3
AuthorsTag=twitch.tv/Akuvo, kroader
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=kroader's tile frenzy 180 but Fortnite (3rd person, FN AR, ADS)
GameVersion=1.0.7.2
