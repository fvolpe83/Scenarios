Name=fortnite 1x1 shotgun
PlayerCharacters=fortniter
BotCharacters=Quaker Bot Fast Strafes.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=fortniter
...
DifficultyTag=3
AuthorsTag=KROADERRRRRRR, patys, KovaaK, Secondo
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Shotgun practice in a 1x1 in fortnite - now in third person!
GameVersion=1.0.7.2
...
TPSArmLength=550.0
TPSOffset=X=0.000 Y=115.000 Z=75.000
