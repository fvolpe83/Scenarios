Name=8L4HTargetSwitch
PlayerCharacters=Quaker-8L4H;Character Profile
...
GameTag=apex, mw, csgo, target, switch, targetswitch, flick, track
WeaponHeroTag=target switch, flatline, r301
DifficultyTag=4
AuthorsTag=8L4H
...
BlockFCT=false
Description=Adjusted ADS-able fast+precise target switching, using pat parts. Bots have a rare hop. Tests smooth midrange tracking and target acquisition on strafing targets
GameVersion=2.0.0.1
