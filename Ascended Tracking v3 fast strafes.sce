Name=Ascended Tracking v3 fast strafes
PlayerCharacters=Ascended Tracking
BotCharacters=Dodgey.bot;Long Strafe Bot.bot;Quaker Bot Fast Strafes.bot
IsChallenge=true
Timelimit=90.0
PlayerProfile=Ascended Tracking
AddedBots=Dodgey.bot;Quaker Bot Fast Strafes.bot;Dodgey.bot
PlayerMaxLives=0
BotMaxLives=0;0;0
PlayerTeam=1
BotTeams=2;2;0
