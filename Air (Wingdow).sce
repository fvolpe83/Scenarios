...
Name=A
MaxHealth=100.0
WeaponProfileNames=Ashe (Trackmaster);Wingman (Trackmaster);Widow (Trackmaster);;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
