...
DodgeProfileNames=ADAD;MidStrafes;Long Strafes Jumping;Short Strafes Jumping
DodgeProfileWeights=0.5;4.0;4.0;0.5
...
AirJumpCount=2
AirJumpVelocity=50.0
MainBBType=Cylindrical
MainBBHeight=300.0
MainBBRadius=46.0
MainBBHasHead=true
MainBBHeadRadius=27.0
MainBBHeadOffset=0.0
MainBBHide=false
ProjBBType=Cylindrical
ProjBBHeight=300.0
...
ProjBBHide=true
HasJetpack=false
JetpackActivationDelay=0.3
JetpackFullFuelTime=1.0
JetpackFuelIncPerSec=0.1
JetpackFuelRegensInAir=true
JetpackThrust=9000.0
JetpackMaxZVelocity=600.0
JetpackAirControlWithThrust=0.25
AbilityProfileNames=Dash.abilmov;Jump.abilmov;;
HideWeapon=false
AerialFriction=0.0
StrafeSpeedMult=1.0
BackSpeedMult=1.0
...
DamageFalloffStartDistance=99998.0
DamageFalloffStopDistance=99999.0
