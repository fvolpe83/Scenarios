Name=Big Boy Strafes
PlayerCharacters=Quaker
BotCharacters=Big Boy Strafes.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Quaker
AddedBots=Big Boy Strafes.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=2
...
[Bot Profile]
Name=Big Boy Strafes
DodgeProfileNames=Close Target
