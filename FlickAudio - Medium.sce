...
BlockFCT=true
Description=Invisible targets.  Use the spawn sound to locate them.  Play with your eyes closed, padawan
GameVersion=1.0.6
...
MuzzleVelocityMin=X=90000.000 Y=0.000 Z=0.000
MuzzleVelocityMax=X=90000.000 Y=0.000 Z=0.000
...
BounceCount=0
HomingProjectileAcceleration=0.0
ProjectileEnemyHitRadius=0.00001
CanAimDownSight=false
ADSZoomDelay=0.0
ADSZoomSensFactor=0.7
ADSMoveFactor=1.0
