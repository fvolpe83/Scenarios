Name=devTargetSwitch Goated Goated
...
DifficultyTag=3
AuthorsTag=DevinDTV, Sackboy_Clank5
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=false
BlockFCT=false
Description=Low FoV target switch with decent range and smallish targets. No reload and 25% smaller targets.
GameVersion=2.0.2.0
