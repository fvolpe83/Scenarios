Name=Direction change invincible
PlayerCharacters=A_frozen
BotCharacters=Tile Frenzy cyl inv 2.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=A_frozen
AddedBots=Tile Frenzy cyl inv 2.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=2
...
BlockFCT=false
Description=smooth mouse aim practice for strafe direction changes
GameVersion=1.0.8.0
...
[Bot Profile]
Name=Tile Frenzy cyl inv 2
DodgeProfileNames=TileFrenzy_Strafe1 1sec
...
UseWeapons=true
CharacterProfile=TileFrenzyStrafing cyl Inv 2
...
[Character Profile]
Name=TileFrenzyStrafing cyl Inv 2
MaxHealth=150.0
WeaponProfileNames=;;;;;;;
MinRespawnDelay=0.1
MaxRespawnDelay=0.1
