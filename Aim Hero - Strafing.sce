...
BlockFCT=true
Description=Track a floating target at eye level circlestrafing over long distances. Management of mousepad space and re-center timing is key. A remake of Aim Hero's "Strafing" mode remedying its lack of inertia. Change map and time scale to modify target size and speed.
GameVersion=1.0.5
...
[Bot Profile]
Name=target
DodgeProfileNames=Circle Strafe scaleable radius
...
Name=Aim Hero
MaxHealth=100.0
WeaponProfileNames=Track 100dps;Click 18dmg;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
...
[Dodge Profile]
Name=Circle Strafe scaleable radius
