Name=PS2 patTargetSwitch v3 (5 bots)
PlayerCharacters=Quaker
BotCharacters=Quaker Bot Long Strafes.bot;q fast.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Quaker
AddedBots=Quaker Bot Long Strafes.bot;Quaker Bot Long Strafes.bot;q fast.bot;q fast.bot;Quaker Bot Long Strafes.bot
PlayerMaxLives=0
...
BlockFCT=false
Description=Target switching 4 shot ttk mixed (flick + track)
GameVersion=2.0.1.2
