Name=Fortnite Loadout Reflex Flick Easy by Bear
PlayerCharacters=Clicker;FortniteMain
...
GameTag=
WeaponHeroTag=Pistol, AR, Pump, SMG
DifficultyTag=2
AuthorsTag=Cracked_Rasta, edited by Bear
BlockHitMarkers=true
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=true
Description=Flick to a short-lived target before it despawns. A test of reflex and flick accuracy. Single 200 size target with 500 ms lifetime. Third-Person View
GameVersion=2.0.2.0
