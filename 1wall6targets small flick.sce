Name=1wall6targets small flick
...
BlockFCT=true
Description=If you're having trouble breaking the 1000 mark in 1wall6 targets small grind this scenario. (Hold LMB the entire time you dingus. Use ur weapon acc as a mean of deciding what your weakness is. Having to make microcorrections too frequently? Just flicking too slow? etc)
GameVersion=2.0.2.0
