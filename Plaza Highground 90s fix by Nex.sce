Name=Plaza Highground 90s fix by Nex
PlayerCharacters=A
...
BlockFCT=false
Description=8 bots with various dodge profiles and speeds. Similar to air, but the bots are on the ground and you are on high ground. Lower movement speed compared to the original.
GameVersion=2.0.1.2
