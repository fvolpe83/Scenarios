...
DifficultyTag=2
AuthorsTag=Ku, Sackboy_Clank5
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=6 targets spawn on a wall.  Great practice for flicking to many targets quickly. 2x larger targets, and accuracy scoring disabled.
GameVersion=2.0.1.1
