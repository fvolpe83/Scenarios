...
BlockFCT=true
Description=Moving around adds points in the challenge mode
GameVersion=1.0.8.0
...
AimingProfileNames=At Feet;Default;Low Skill;Default;Default;Default;Default;Default
...
TPSArmLength=400.0
TPSOffset=X=0.000 Y=200.000 Z=100.000
...
ADSMoveFactor=1.0
ADSStartDelay=0.0
ShootSoundCooldown=1.05
HitSoundCooldown=1.05
HitscanVisualOffset=X=0.000 Y=0.000 Z=-50.000
ADSBlocksShooting=false
ShootingBlocksADS=false
KnockbackFactorAir=0.0
