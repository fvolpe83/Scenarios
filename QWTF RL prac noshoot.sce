Name=QWTF RL prac noshoot
PlayerCharacters=QWTFer
BotCharacters=QWTF Bot noshoot.bot
IsChallenge=true
Timelimit=180.0
PlayerProfile=QWTFer
AddedBots=QWTF Bot noshoot.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=0
BotTeams=0
