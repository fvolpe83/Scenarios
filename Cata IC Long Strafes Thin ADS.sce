Name=Cata IC Long Strafes Thin ADS
...
DifficultyTag=2
AuthorsTag=KovaaK, banDiscord
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Low pressure hitscan tracking against an easy to hit thinner target. Promotes precision tracking.
GameVersion=1.0.8.0
