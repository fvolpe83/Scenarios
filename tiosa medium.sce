Name=Reflex Medium Flick 300ms
PlayerCharacters=Clicker
BotCharacters=target_decay.bot;target_decay.bot;target_decay.bot;target_decay.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Clicker
AddedBots=target_decay.bot;target_decay.bot;target_decay.bot;target_decay.bot
PlayerMaxLives=1
BotMaxLives=0;0;0;0
PlayerTeam=1
BotTeams=2;0;0;0
...
BlockFCT=true
Description=Medium Flick distance training. target lifetime: 300ms. Adjustments: increased map depth (4096 units), increased spawn area padding
GameVersion=1.0.7.2
