Name=Pistol Tracking
PlayerCharacters=Sergeant 87;Racer
BotCharacters=Quaker Bot Fast Strafes.bot;Thin very long strafe.bot
IsChallenge=true
Timelimit=60.0
...
Name=Racer
MaxHealth=150.0
WeaponProfileNames=Machine Pistols;Shinji Triple;Shinji Stars;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
CrouchHeightModifier=0.5
