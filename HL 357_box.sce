...
WeaponHeroTag=357, revolver, magnum, python, Gordon Freeman
DifficultyTag=4
AuthorsTag=naz
...
BlockFCT=false
Description=357_box map from Half-Life, with 357 revolver
GameVersion=1.0.5
...
AimingProfileNames=Medium Skill;Medium Skill At Feet;Medium Skill;Default;Default;Default;Default;Default
