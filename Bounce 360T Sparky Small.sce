...
GameTag=Sparky, Valorant, Fortnite
WeaponHeroTag=Tracking
DifficultyTag=2
AuthorsTag=Whisper, Ghokury
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=To help vertical tracking on small bouncing balls. 33% smaller.
GameVersion=1.0.8.0
