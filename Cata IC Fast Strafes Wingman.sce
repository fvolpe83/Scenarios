Name=Cata IC Fast Strafes Wingman
PlayerCharacters=Wingman Legend
BotCharacters=Quaker Bot Fast Strafes.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Wingman Legend
...
DifficultyTag=3
AuthorsTag=KovaaK, Slasher
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Wingman shooting against a hard to hit target.
GameVersion=2.0.1.2
...
Name=Wingman Legend
MaxHealth=300.0
WeaponProfileNames=;;Wingman Infinite;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
