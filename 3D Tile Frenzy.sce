...
DifficultyTag=2
AuthorsTag=Sharqosity (Pete edited)
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=5 targets that respawn instantly when they die. Kill as many as you can in 45 seconds! Edited to be within a big 3D room
GameVersion=1.0.5
