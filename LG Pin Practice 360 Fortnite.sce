Name=LG Pin Practice 360 Fortnite
...
GameTag=Tracking, Fortnite 
WeaponHeroTag=Fortnite AR, FortniteMain
DifficultyTag=4
AuthorsTag=twitch.tv/Akuvo
...
Name=FortniteMain
MaxHealth=100.0
WeaponProfileNames=FN AR;FN SMG PRAC;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=16.0
