...
GameTag=Mouse Control, Vertical
WeaponHeroTag=
DifficultyTag=2
AuthorsTag=ku, gli, Pudge
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=true
Description=1 click = 1 kill. Practice your precision on tiny targets. Made vertical.
GameVersion=2.0.1.2
...
[Bot Profile]
Name=target
DodgeProfileNames=1w6ts strafing dodge profile
...
[Dodge Profile]
Name=1w6ts strafing dodge profile
MaxTargetDistance=100000.0
MinTargetDistance=0.00001
