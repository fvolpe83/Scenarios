...
GameTag=Track, Dodge, Aim
WeaponHeroTag=Track Master 100
DifficultyTag=5
AuthorsTag=aestheticgoose, killg0res
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Air Dodge but the bots are on the ground.
GameVersion=1.0.8.0
...
Name=A
MaxHealth=100.0
WeaponProfileNames=LG;Six Shooter;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
