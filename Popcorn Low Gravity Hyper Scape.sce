Name=Popcorn Low Gravity Hyper Scape
...
AddedBots=Pigeon3.bot;Pigeon4.bot;Pigeon5.bot;Pigeon4.bot;Pigeon5.bot
PlayerMaxLives=0
...
DifficultyTag=5
AuthorsTag=gli, nocrno, Copper Brain
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=kill bouncing/arcing balls.  Skeet-shooting basically (But with tracking!)
GameVersion=2.0.1.2
...
MaxHealth=300.0
WeaponProfileNames=Low damage TM100;They Talk About My 1Taps;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=1.0
StepUpHeight=75.0
...
SpreadSSH=0.0,25.0,0.0,0.0
SpreadSCH=10.0,25.0,0.0,10.0
SpreadMSH=0.0,1000.0,0.0,0.0
