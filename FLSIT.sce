...
GameTag=tracking, reactivity, ddtv
WeaponHeroTag=LG
DifficultyTag=3
AuthorsTag=DevinDTV
...
BlockFCT=false
Description=You MUST use ADS, which forces 103 OW FoV. This is to prevent cheese. Like CLSI except far, thin, low FoV, slightly faster strafes.
GameVersion=1.0.8.0
...
DodgeProfileNames=Mid Long Strafes
...
SpreadSSH=100.0,0.1,90.0,100.0
SpreadSCH=100.0,0.1,90.0,100.0
SpreadMSH=100.0,0.1,90.0,100.0
SpreadMCH=100.0,0.1,90.0,100.0
MaxRecoilUp=0.0
MinRecoilUp=0.0
MinRecoilHoriz=0.0
MaxRecoilHoriz=0.0
...
global
	...
	entity
		type PlayerSpawn
		Vector3 position -1536.000000 40.000000 -0.000000
