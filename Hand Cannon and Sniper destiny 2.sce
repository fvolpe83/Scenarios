Name=Hand Cannon and Sniper destiny 2
PlayerCharacters=HC sniper
BotCharacters=Jumping aroudn with headz.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=HC sniper
AddedBots=Jumping aroudn with headz.bot;Jumping aroudn with headz.bot;Jumping aroudn with headz.bot
PlayerMaxLives=0
BotMaxLives=0;0;0
PlayerTeam=1
BotTeams=2;0;0
...
Name=HC sniper
MaxHealth=200.0
WeaponProfileNames=Jamie Sniper;Luna;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
