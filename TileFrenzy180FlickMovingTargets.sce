Name=TileFrenzy180FlickMovingTargets
PlayerCharacters=TileFrenzy Challenger
BotCharacters=TileFrenzyStrafing Cube.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=TileFrenzy Challenger
AddedBots=TileFrenzyStrafing Cube.bot;TileFrenzyStrafing Cube.bot;TileFrenzyStrafing Cube.bot;TileFrenzyStrafing Cube.bot
PlayerMaxLives=0
BotMaxLives=0;0;0;0
PlayerTeam=1
BotTeams=2;2;2;2
