Name=Cata IC Fast Strafes Six Shooter Updated
...
WeaponHeroTag=Six Shooter, McCree, mccoy
DifficultyTag=3
AuthorsTag=Shazzik, KovaaK
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Hard to hit target, updated version of McCree's gun (0.42s between shots)
GameVersion=1.0.8.0
...
Name=Quaker
MaxHealth=300.0
WeaponProfileNames=Six Shooter Updated;;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
