Name=Ambassador (headshots only)
PlayerCharacters=Spy
BotCharacters=Pigeon.bot;Sniper Bot.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Spy
AddedBots=Sniper Bot.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=2
...
BlockFCT=false
Description=You are the Spy. Elimate that pesky sniper many times. Sorry if the weapons aren't accurate enough >.<
GameVersion=1.0.5
...
[Bot Profile]
Name=Sniper Bot
DodgeProfileNames=Stop;CsCareful1
...
WeaponSwitchTime=3.0
UseWeapons=true
CharacterProfile=Sniper from tf2 (sorta)
SeeThroughWalls=true

[Character Profile]
Name=Spy
MaxHealth=125.0
WeaponProfileNames=Ambassador;;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
...
DamageFalloffStartDistance=700.0
...
SpreadSSH=0.0,1.0,-1.0,5.0
SpreadSCH=1.0,1.0,-1.0,5.0
SpreadMSH=0.5,1.0,-1.0,5.0
...
SpreadSSH=0.0,5.5,0.0,3.0
SpreadSCH=2.0,5.5,0.0,3.0
SpreadMSH=0.1,5.5,0.0,3.0
