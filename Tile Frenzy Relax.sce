Name=Tile Frenzy Relax
PlayerCharacters=A_air_trackmaster_frozen
BotCharacters=target.bot
IsChallenge=true
Timelimit=30.0
PlayerProfile=A_air_trackmaster_frozen
...
WeaponHeroTag=LG
DifficultyTag=2
AuthorsTag=Sharqosity, Huddled
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Based on osu! relax mod hold left click and flick between targets as fast as you can
GameVersion=1.0.6
