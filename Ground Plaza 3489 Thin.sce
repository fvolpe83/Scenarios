...
DifficultyTag=5
AuthorsTag=ObiWanBenoni, razaplaza, mrg
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Ground Plaza with Bots 3, 4, 8, and 9 only. Bot health is 150% HP and they have only 60% thickness compared to the original. Fixed spawns, duration is roughly the same as Ground Plaza.
GameVersion=2.0.0.2
