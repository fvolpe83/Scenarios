Name=Ground Plaza Sparky v3 OW Invincible 1
PlayerCharacters=A
BotCharacters=fast strafes blink.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=A
AddedBots=fast strafes blink.bot
PlayerMaxLives=0
BotMaxLives=1
PlayerTeam=1
BotTeams=2
...
GameTag=Apex, OW, Quake, whatever
WeaponHeroTag=Track Master 100
DifficultyTag=4
AuthorsTag=razaplaza, patys, sarin, KROADER, rallex
