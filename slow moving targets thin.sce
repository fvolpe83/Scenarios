Name=slow moving targets thin
PlayerCharacters=1 player
BotCharacters=1 bot.bot
IsChallenge=true
Timelimit=300.0
...
BlockFCT=false
Description=Track the thin and slow targets
GameVersion=2.0.1.0
...
[Bot Profile]
Name=1 bot
DodgeProfileNames=1 move
DodgeProfileWeights=10.0
