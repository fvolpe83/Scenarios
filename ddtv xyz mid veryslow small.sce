Name=ddtv xyz mid veryslow small
...
GameTag=Track,mini,precise,smooth,long,ddtv,overwatch,fortnite,fn,ow,apex,cs,r6
WeaponHeroTag=Cone tracker
DifficultyTag=1
AuthorsTag=DevinDTV
...
BlockFCT=false
Description=Tiny target, linear movement, 3d. Aim at the center of the target to do more damage.
GameVersion=1.0.7.2
...
[Bot Profile]
Name=target
DodgeProfileNames=ddtv xyz slow
...
MaxHealth=100.0
WeaponProfileNames=Cone Tracker;;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
