Name=Fortnite Loadout Bounce 360 by Bear
...
DifficultyTag=3
AuthorsTag=Original scenario by fareoh, Pudge, edited by Bear
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Basically fuglaab180t but with the B360FN twist. Focuses on smooth tracking instead of switching.
GameVersion=2.0.2.0
