Name=Wide Wall 5 Targets Distanced - Extra Small
PlayerCharacters=A_air_pistol_frozen
BotCharacters=Extra small.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=A_air_pistol_frozen
AddedBots=Extra small.bot;Extra small.bot;Extra small.bot;Extra small.bot;Extra small.bot
PlayerMaxLives=0
...
GameTag=Wide, Distanced, Flick
WeaponHeroTag=Link
DifficultyTag=3
AuthorsTag=Revlis Antares
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Five extra small distanced targets spawn on a wide wall, spread apart and just within view. No significant clustering.
GameVersion=2.0.2.0
