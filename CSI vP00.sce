...
BlockFCT=false
Description=Close strafe invincible with crouch, jump and x2 headshot multiplier
GameVersion=2.0.2.0
...
DodgeProfileNames=Close Short Strafes;Close Mid Strafes
DodgeProfileWeights=0.1;0.1
