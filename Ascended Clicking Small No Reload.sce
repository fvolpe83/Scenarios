Name=Ascended Clicking Small No Reload
...
DifficultyTag=2
AuthorsTag=Ascetic, ikue, KovaaK, Whisper
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=true
Description=Ascended Tracking variant for Clicking
GameVersion=2.0.1.0
...
MagazineMax=1
AmmoPerShot=1
ReloadTimeFromEmpty=0.29
ReloadTimeFromPartial=0.29
