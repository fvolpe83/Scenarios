Name=Cata IC Long Strafes Very Hard 2min
PlayerCharacters=QuakerI
BotCharacters=Quaker Bot Long Strafes.bot
IsChallenge=true
Timelimit=120.0
PlayerProfile=QuakerI
...
BlockFCT=false
Description=Hitscan tracking against an hard to hit target.
GameVersion=1.0.7.2
...
Name=Quaker
MaxHealth=3000.0
WeaponProfileNames=;;LG with ADS;;;;;
MinRespawnDelay=0.1
MaxRespawnDelay=0.1
StepUpHeight=400.0
CrouchHeightModifier=0.5
