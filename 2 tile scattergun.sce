...
GameTag=tf2ish 3 tile scatter gun
WeaponHeroTag=scatter gun
DifficultyTag=1
AuthorsTag=Sharqosity (stux, i half assed the gun)
BlockHitMarkers=true
BlockHitSounds=true
BlockMissSounds=true
BlockFCT=false
Description=2 Tiles Appear on screen once you shoot one it appears again for 30 seconds you shoot with gun
GameVersion=2.0.0.2
...
Name=scout
MaxHealth=125.0
WeaponProfileNames=scatter gun;;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
