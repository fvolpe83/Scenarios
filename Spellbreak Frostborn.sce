...
BlockFCT=false
Description=exile small jumping spheres out of the air with a Bow & Arrow.
GameVersion=2.0.2.0
...
MaxHealth=100.0
WeaponProfileNames=Ice Gauntlet;;;;;;;
MinRespawnDelay=0.1
MaxRespawnDelay=0.1
StepUpHeight=75.0
...
ChargeStartVelocity=X=4727.273 Y=0.000 Z=0.000
ChargeTimeToAutoRelease=60.0
ChargeTimeToCap=1.6
ChargeMoveSpeedModifier=0.7
MuzzleVelocityMin=X=20000.000 Y=0.000 Z=0.000
...
WeaponSkin=Default
ProjectileVisualOffset=X=1.000 Y=1.000 Z=1.000
...
ParticleProjectileTrail=Fire Trail
ParticleHitscanTrace=Tracer
ParticleMuzzleFlashScale=1.0
ParticleWallImpactScale=1.0
ParticleBodyImpactScale=1.0
ParticleProjectileTrailScale=4.0
Explosive=false
Radius=500.0
