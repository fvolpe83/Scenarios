Name=Tile Frenzy Small (Wingdow)
...
BlockFCT=false
Description=tile frenzy 180 but smaller and with widowmaker (ow) and 1x scope (apex)
GameVersion=2.0.1.0
...
MaxHealth=1.0
WeaponProfileNames=Ashe (LG);Wingman (LG);Widow (LG);;;;;
