...
BotCharacters=DBT Fast Strafes.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=EGODEATH
AddedBots=DBT Fast Strafes.bot;DBT Fast Strafes.bot
PlayerMaxLives=0
BotMaxLives=0;0
PlayerTeam=2
BotTeams=1;1
...
GameTag=Diabotical, DBT
WeaponHeroTag=Lightning Gun, LG
DifficultyTag=4
AuthorsTag=gli, Tammas
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Cata IC 2 Fast Strafes Small with spheres for Diabotical
GameVersion=2.0.2.0
...
Name=EGODEATH
MaxHealth=100.0
WeaponProfileNames=Track_fullsound;track_earlove;track_earlove2;pistol;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=1.0
StepUpHeight=75.0
