Name=Paladins Viktor HS Tracking
PlayerCharacters=Viktor
BotCharacters=Skye must die.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Viktor
AddedBots=Skye must die.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=2
BotTeams=0
...
GameTag=Paladins
WeaponHeroTag=Viktor, Assault Rifle, Burst
DifficultyTag=3
AuthorsTag=Morgiana Besto Waifu
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=false
BlockFCT=false
Description=This map was made to train your tracking with Burst Viktor + -60% recoil card. This map only allows you to headshot ('cause that's what you're looking for)
GameVersion=2.0.1.2
...
[Bot Profile]
Name=Skye must die
DodgeProfileNames=Short Strafes Jumping;Short Strafes
...
UseWeapons=true
CharacterProfile=Skye mains must die
