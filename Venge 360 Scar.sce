...
BotCharacters=Venge Hopper.bot;Venge Hopper.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Quaker
AddedBots=Venge Hopper.bot;Venge Hopper.bot
PlayerMaxLives=0
BotMaxLives=0;0
PlayerTeam=1
BotTeams=0;0
...
BlockFCT=false
Description=An edit of the "Quick Jumpers" scenario that incorporates venge.io bullet spread. Most of the credit goes to Luma
GameVersion=2.0.1.2
...
MinCrouchTime=0.00001
MaxCrouchTime=0.00001
MinJumpTime=0.14
MaxJumpTime=0.18
LeftStrafeTimeMult=16.0
RightStrafeTimeMult=16.0
StrafeSwapMinPause=0.00001
StrafeSwapMaxPause=0.00001
...
SpreadSSH=1.0,1.0,0.0,0.5
SpreadSCH=1.0,1.0,-1.0,5.0
SpreadMSH=1.0,1.0,0.05,1.0
