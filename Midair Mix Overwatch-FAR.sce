...
WeaponHeroTag=LG, Pharah, Zenyatta, McCree, Soldier 76, Hanzo
DifficultyTag=3
AuthorsTag=
...
BlockFCT=false
Description=Longer range than original, also more narrow hitboxes, slightly faster speed to match tracer, and perfect accuracy gun. Smaller Press the Launch ability to send bots flying in the air.  Kills with midair rockets award extra points. A modification of KovaaK's Midair Mix for Overwatch-specific weapons.
GameVersion=1.0.5
...
UseWeapons=true
CharacterProfile=Tracer Clay Pigeon
SeeThroughWalls=false

[Character Profile]
Name=Watcher Rocketeer
MaxHealth=200.0
WeaponProfileNames=Track 100dps;Click 18dmg;Six Shooter;Monk Orb;Sergeant Rifle;Track 130dps;Offhand Rocket;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=35.0
...
AbilityProfileNames=Tranquilizer.abilwep;;;Launch Targets.abilmelee
HideWeapon=false
AerialFriction=0.0
StrafeSpeedMult=1.0
BackSpeedMult=1.0
...
MainBBRadius=14.0
MainBBHasHead=true
MainBBHeadRadius=8.75
MainBBHeadOffset=-8.75
MainBBHide=false
ProjBBType=Cylindrical
ProjBBHeight=120.0
ProjBBRadius=20.0
...
HitscanVisualOffset=X=0.000 Y=0.000 Z=8.000
ADSBlocksShooting=false
ShootingBlocksADS=false
