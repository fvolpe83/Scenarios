...
BotCharacters=Quaker Bot Long Strafes.bot;500ms.bot
IsChallenge=true
Timelimit=150.0
PlayerProfile=Quaker
AddedBots=Quaker Bot Long Strafes.bot;500ms.bot
PlayerMaxLives=1
BotMaxLives=0;0
PlayerTeam=2
BotTeams=1;1
...
BlockFCT=false
Description=Track the moving target while flicking to the orbs that appear every 0.5s or else it will damage you. 
GameVersion=1.0.6
