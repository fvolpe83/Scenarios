Name=1wall20targets extra small
...
DifficultyTag=4
AuthorsTag=Ku, gli, pasu, KROADER
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=1 click = 1 kill.  Practice your precision on tiny targets. No accuracy multiplier - 2 second reload time if you miss 4 shots in a row. Good Luck!
GameVersion=1.0.7.2
