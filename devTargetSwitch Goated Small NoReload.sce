Name=devTargetSwitch Goated Small NoReload
...
GameTag=ddtv,tracking,acquisition,target switch,targetswitch,pattargetswitch
WeaponHeroTag=target switch
DifficultyTag=3
AuthorsTag=DevinDTV, Ghokury
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=false
BlockFCT=false
Description=Low FoV target switch with decent range and smallish targets. Infinite ammo = no reload.
GameVersion=1.0.8.0
