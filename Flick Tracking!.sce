...
GameTag=Flick Tracking
WeaponHeroTag=
DifficultyTag=3
AuthorsTag=Toast of War, fuglaa
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=false
BlockFCT=false
Description=Flick to the targets and practice tracking as quickly as possible with Fuglaa's XYLS Hard bots. 
GameVersion=1.0.7.2
