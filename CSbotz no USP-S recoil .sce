Name=CSbotz no USP-S recoil 
PlayerCharacters=csplayer
BotCharacters=csbotz harmless.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=csplayer
AddedBots=csbotz harmless.bot;csbotz harmless.bot;csbotz harmless.bot;csbotz harmless.bot;csbotz harmless.bot;csbotz harmless.bot;csbotz harmless.bot;csbotz harmless.bot;csbotz harmless.bot;csbotz harmless.bot;csbotz harmless.bot;csbotz harmless.bot
PlayerMaxLives=0
...
BlockFCT=false
Description=CSbotz but not cringe
GameVersion=2.0.0.2
