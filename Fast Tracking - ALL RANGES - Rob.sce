Name=Fast Tracking - ALL RANGES - Rob
PlayerCharacters=Gamer;Quaker
...
BlockFCT=false
Description=Fast Tracking, all ranges
GameVersion=2.0.1.2
...
DodgeProfileNames=Short Strafes;Short Strafes Close;Long Strafes 2;Long Strafes Close
