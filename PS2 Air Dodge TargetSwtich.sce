Name=PS2 Air Dodge TargetSwtich
PlayerCharacters=A
...
BlockFCT=true
Description=tweak the original (without ps2 infront) might be good for LA tracking. Maybe I should add a super fast bot for boooshers...idk 
GameVersion=2.0.1.2
