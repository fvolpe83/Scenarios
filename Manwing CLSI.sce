Name=Manwing CLSI
PlayerCharacters=Legends
BotCharacters=Quaker Bot Fast Strafes.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Legends
...
BlockFCT=false
Description=Manwing version of CLSI. Infinite ammo, damage scoring. 
GameVersion=1.0.7.2
