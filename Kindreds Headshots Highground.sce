Name=Kindreds Headshots Highground
...
GameTag=fortnite, overwatch, rainbow, siege, cs, csgo, headshot,kovaak
WeaponHeroTag=Shotgun, Ak, Sniper, Anything to get a clean Kindred headshot
DifficultyTag=5
AuthorsTag=Kindred, Aimer7
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=false
BlockFCT=false
Description=Speedrun. Eliminate as many heads as you can while they're jumping. 
GameVersion=1.0.8.0
