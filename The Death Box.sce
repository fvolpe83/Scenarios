Name=The Death Box
PlayerCharacters=A_air_pistol_health
BotCharacters=target_mimic_projectile slow.bot;target_long_projectile plasma.bot
IsChallenge=true
Timelimit=600.0
PlayerProfile=A_air_pistol_health
AddedBots=target_mimic_projectile slow.bot;target_mimic_projectile slow.bot;target_mimic_projectile slow.bot;target_mimic_projectile slow.bot;target_mimic_projectile slow.bot;target_mimic_projectile slow.bot;target_mimic_projectile slow.bot;target_mimic_projectile slow.bot;target_mimic_projectile slow.bot;target_long_projectile plasma.bot
PlayerMaxLives=3
...
BlockFCT=false
Description=Death Room for click timing & dodging. when you die 3 times the game ends. don't forget to use the healthpack ability for emergency
GameVersion=1.0.8.0
...
[Bot Profile]
Name=target_mimic_projectile slow
...
UseWeapons=true
CharacterProfile=target_slowmove
SeeThroughWalls=false
NoDodging=false
NoAiming=false

[Bot Profile]
Name=target_long_projectile plasma
...
WeaponSwitchTime=3.0
UseWeapons=true
CharacterProfile=target slow plasma
SeeThroughWalls=false
NoDodging=false
NoAiming=false

[Character Profile]
Name=A_air_pistol_health
MaxHealth=100.0
...
AbilityProfileNames=healthpack 1 per 1s .abilmov;;;
HideWeapon=false
AerialFriction=0.0
StrafeSpeedMult=1.0
BackSpeedMult=1.0
...
[Character Profile]
Name=target slow plasma
MaxHealth=1.0
WeaponProfileNames=Projectile Rifle_plasma;;;;;;;
MinRespawnDelay=3.0
...
BounceFactor=0.0
BounceCount=0
HomingProjectileAcceleration=50000.0
ProjectileEnemyHitRadius=3.0
CanAimDownSight=true
ADSZoomDelay=0.05
ADSZoomSensFactor=0.5
