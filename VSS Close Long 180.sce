Name=VSS Close Long 180
PlayerCharacters=VSS 1
BotCharacters=VSS Bot Long Strafes.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=VSS 1
AddedBots=VSS Bot Long Strafes.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=2
...
GameTag=Reflex, Quake, R6 BEST GAME
WeaponHeroTag=Lightning Gun, LG
DifficultyTag=3
AuthorsTag=Toast of War, Aimer, Zac
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Close Long Strafes, but with the variable speed. Also a non-bullsh!t map because real enemies don't fkin do 360s around you in gunfights. Because, ya know... that'd be stupid. 
GameVersion=1.0.8.0
...
[Bot Profile]
Name=VSS Bot Long Strafes
DodgeProfileNames=VSS Close Long
