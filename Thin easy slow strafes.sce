Name=Thin easy slow strafes
PlayerCharacters=A
BotCharacters=Ken Thin.bot
IsChallenge=false
Timelimit=60.0
PlayerProfile=A
AddedBots=Ken Thin.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=2
...
BlockFCT=false
Description=super ez target for steadiness
GameVersion=1.0.8.0
...
StrafeSwapMinPause=0.24
StrafeSwapMaxPause=0.24
