Name=Moving Tracking - Strafing - 01
PlayerCharacters=Tracker
...
GameTag=Tracking, Moving, Stationary Target
WeaponHeroTag=
DifficultyTag=2
AuthorsTag=BMASTER
...
BlockFCT=true
Description=Move sidewise while shooting the strafing target. Keep switching directions, once the bar next to your crosshair is full to get more points. Also go for headshots to drastically increase your overall score.
GameVersion=2.0.0.2
...
[Bot Profile]
Name=target
DodgeProfileNames=Long Strafes;Short Strafes;Long Strafes_very
DodgeProfileWeights=1.0;0.15;0.5
DodgeProfileMaxChangeTime=8.0
...
CanJumpFromCrouch=false
EnemyBodyColor=X=255.000 Y=0.000 Z=0.000
EnemyHeadColor=X=0.000 Y=255.000 Z=0.000
TeamBodyColor=X=0.000 Y=0.000 Z=255.000
TeamHeadColor=X=255.000 Y=255.000 Z=255.000
BlockSelfDamage=false
InvinciblePlayer=false
...
global
	...
	entity
		type PlayerSpawn
		Vector3 position 696.000000 1948.000000 52.000000
