Name=Thin Aiming Short Invincible
PlayerCharacters=A
...
WeaponHeroTag=
DifficultyTag=5
AuthorsTag=Ku, StarkLN
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Thought it would be cool to make an invincible version of Thin Aiming Short with only one spawn. Jump also included for extra unpredictability.
GameVersion=2.0.2.0
