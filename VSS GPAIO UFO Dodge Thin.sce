Name=VSS GPAIO UFO Dodge Thin
PlayerCharacters=A
BotCharacters=air1_VSS_All.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=A
AddedBots=air1_VSS_All.bot
PlayerMaxLives=0
BotMaxLives=1
PlayerTeam=1
BotTeams=2
...
DifficultyTag=5
AuthorsTag=razaplaza
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=10 bots with various dodge profiles and speeds. Similar to air, but the bots are on the ground.
GameVersion=2.0.2.0
...
[Bot Profile]
Name=air1_VSS_All
DodgeProfileNames=Long Strafes Close;Close Very Short Strafes;Long Strafes Jumping;MidStrafes;Short Strafes Close;Short Strafes Jumping;Very Short Strafes + Jump
...
UseAbilityFreqMinTime=0.6
UseAbilityFreqMaxTime=0.9
ShowLaser=false
