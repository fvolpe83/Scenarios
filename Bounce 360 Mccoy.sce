Name=Bounce 360 Mccoy
PlayerCharacters=McCoy
BotCharacters=200hppigeonHard.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=McCoy
AddedBots=200hppigeonHard.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=0
...
BlockFCT=false
Description=To help mccoy players with vertical enemies
GameVersion=1.0.8.0
...
UseWeapons=false
CharacterProfile=Clay Pigeon hard
