Name=CloseWingman
PlayerCharacters=Wingmanguy
BotCharacters=APEXADBOT.bot
IsChallenge=true
Timelimit=30.0
PlayerProfile=Wingmanguy
AddedBots=APEXADBOT.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=2
...
DifficultyTag=3
AuthorsTag=nextdayair
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=adapted from close long strafes invincible
GameVersion=1.0.8.0
...
UseWeapons=false
CharacterProfile=ApexWingmanAD
...
SpreadMSH=2.0,2.0,2.0,2.0
SpreadMCH=1.0,1.0,1.0,2.0
MaxRecoilUp=4.0
MinRecoilUp=4.0
MinRecoilHoriz=2.0
MaxRecoilHoriz=2.0
