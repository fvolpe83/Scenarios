...
GameTag=Quake 3, QuakeLive, Overwatch
WeaponHeroTag=LG, Lightning Gun, Rocket Launcher, RL, Six Shooter, McCree
DifficultyTag=3
AuthorsTag=KovaaK, Shazzik
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=1on1 combat with a Quake style bot.  Invulnerable player, but taking damage reduces your end score. Updated version of McCree's gun
GameVersion=1.0.8.0
...
Name=Quaker
MaxHealth=300.0
WeaponProfileNames=Six Shooter Updated;Rocket Launcher;LG;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
