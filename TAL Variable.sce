Name=TAL Variable
PlayerCharacters=A
BotCharacters=Thin very long strafe.bot;Bot Rotation Profile.rot;Thin Fast very long strafe.bot;Thin Slow very long strafe.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=A
...
BlockFCT=false
Description=Thin Aiming Long with varying speeds on bots.
GameVersion=1.0.8.0
...
[Bot Profile]
Name=Thin Fast very long strafe
DodgeProfileNames=Long Strafes_very
DodgeProfileWeights=1.0
DodgeProfileMaxChangeTime=5.0
DodgeProfileMinChangeTime=1.0
...
WeaponSwitchTime=3.0
UseWeapons=true
CharacterProfile=Thin Fast
SeeThroughWalls=false
NoDodging=false
NoAiming=false

[Bot Profile]
Name=Thin Slow very long strafe
DodgeProfileNames=Long Strafes_very
DodgeProfileWeights=1.0
DodgeProfileMaxChangeTime=5.0
DodgeProfileMinChangeTime=1.0
...
ProfileNames=Thin Fast very long strafe;Thin very long strafe;Thin Slow very long strafe
...
JetpackMaxZVelocity=400.0
JetpackAirControlWithThrust=0.25
AbilityProfileNames=Self Destruct 20s.abilwep;;;
HideWeapon=false
AerialFriction=0.0
StrafeSpeedMult=1.0
BackSpeedMult=1.0
