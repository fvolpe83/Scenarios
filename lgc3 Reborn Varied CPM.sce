...
DifficultyTag=4
AuthorsTag=patys, mrg
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=LGC3 reborn varied, but with cpm-inspired accel values. 
GameVersion=1.0.8.0
