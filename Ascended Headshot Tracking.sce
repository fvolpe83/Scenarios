Name=Ascended Headshot Tracking
PlayerCharacters=Ascended Tracking
BotCharacters=long strafe head.bot
IsChallenge=true
Timelimit=90.0
PlayerProfile=Ascended Tracking
AddedBots=long strafe head.bot;long strafe head.bot;long strafe head.bot
PlayerMaxLives=0
BotMaxLives=0;0;0
PlayerTeam=1
BotTeams=0;0;0
...
GameTag=Tracking, Headshot, flick, target, pubg, COD, MW, Tracking, Tracing, Shroud, Dr.Disrespect, Faze, 
WeaponHeroTag=Headshot Tracking
DifficultyTag=3
AuthorsTag=ELGUAPOE x WetWork
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=true
Description=Track 3 targets at a variety of ranges, emphasis on headshot tracking. Practice landing the shots that matter.
GameVersion=2.0.1.0
