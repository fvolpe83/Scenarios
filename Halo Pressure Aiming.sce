Name=Halo Pressure Aiming
PlayerCharacters=Quaker;Spartan 2
BotCharacters=Quaker Bot Long Strafes.bot;Spartan.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Quaker
AddedBots=Quaker Bot Long Strafes.bot;Spartan.bot
PlayerMaxLives=0
BotMaxLives=0;0
PlayerTeam=1
BotTeams=2;2
...
GameTag=Halo PC
WeaponHeroTag=HCE Magnum, Battle Rifle, LG
DifficultyTag=3
AuthorsTag=Doedoes
...
BlockFCT=false
Description=Used For Those Situations When You Choke Shots Either Shooting Someone Else Or Against The One Shooting You 
GameVersion=2.0.0.2
...
Name=Quaker
MaxHealth=300.0
WeaponProfileNames=LG;CE Magnum;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
...
Name=Spartan 2
MaxHealth=400.0
WeaponProfileNames=Battle Rifle;CE Magnum;;;;;;
...
ChargeTimeToCap=1.0
ChargeMoveSpeedModifier=1.0
MuzzleVelocityMin=X=67000.000 Y=0.000 Z=0.000
MuzzleVelocityMax=X=67000.000 Y=0.000 Z=0.000
InheritOwnerVelocity=0.0
OriginOffset=X=0.000 Y=0.000 Z=0.000
MaxTravelTime=5.0
MaxHitscanRange=100000.0
