Name=VSS CML Track and Click
PlayerCharacters=VSS Player
BotCharacters=VSS Bot Mid Strafes.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=VSS Player
...
AbilityProfileNames=100test.abilwep;;;
HideWeapon=true
AerialFriction=0.0
StrafeSpeedMult=1.0
BackSpeedMult=1.0
