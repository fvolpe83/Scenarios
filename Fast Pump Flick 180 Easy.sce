Name=Fast Pump Flick 180 Easy
PlayerCharacters=Quaker;target_decay;PumpChallenger;TileFrenzy Challenger
BotCharacters=TileFrenzy Cube.bot;Pump1.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=PumpChallenger
AddedBots=Pump1.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
...
BlockFCT=false
Description=The Pump Flick 180 Easy
GameVersion=1.0.8.0
