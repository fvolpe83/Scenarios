...
BlockFCT=false
Description=10 bots with various dodge profiles and speeds. Similar to air, but the bots are on the ground and you are on highground.
GameVersion=2.0.1.0
...
MaxTargetDistance=2150.0
MinTargetDistance=2070.0
