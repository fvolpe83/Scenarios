...
GameTag=D2 Quickplay
WeaponHeroTag=Suros Regime
DifficultyTag=2
AuthorsTag=D2 Gambit
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Just track like you crutch on heavy. Dogshit kid.
GameVersion=1.0.8.0
...
EnemyBodyColor=X=0.771 Y=0.000 Z=0.000
EnemyHeadColor=X=0.251 Y=0.200 Z=0.165
