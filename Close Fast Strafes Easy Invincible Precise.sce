...
BlockFCT=false
Description=Low pressure hitscan tracking against a hard to hit target. Lower movement speed compared to the original. Target width halved compared to the original.
GameVersion=2.0.0.2
