Name=Flux Valorant Reflex Flick
PlayerCharacters=Flick Player
BotCharacters=Quaker Bot Decay.bot
IsChallenge=true
Timelimit=45.0
PlayerProfile=Flick Player
AddedBots=Quaker Bot Decay.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=2
BotTeams=1
...
BlockFCT=false
Description=500ms flick head shots between two heights.
GameVersion=2.0.1.2
