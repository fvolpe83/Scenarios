Name=Ascended Plasma
PlayerCharacters=Ascended Plasma
BotCharacters=Long Strafe Bot.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Ascended Plasma
...
WeaponHeroTag=Plasma gun, Nailgun
DifficultyTag=3
AuthorsTag=KovaaK
...
BlockFCT=false
Description=Practice leading plasma/nailgun style projectiles against long strafing bots at various angles.  Get extra points for moving while playing.
GameVersion=1.0.6
