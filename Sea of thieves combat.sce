Name=Sea of thieves combat
PlayerCharacters=Sea of thieves
BotCharacters=Bin.bot;Braindead.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Sea of thieves
AddedBots=Bin.bot;Braindead.bot
PlayerMaxLives=0
BotMaxLives=0;0
PlayerTeam=1
BotTeams=2;0
...
Name=Sea of thieves
MaxHealth=100.0
WeaponProfileNames=Eye of reach;Flintlock;Blunderbuss;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
