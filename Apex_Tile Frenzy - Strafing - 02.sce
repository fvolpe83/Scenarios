Name=Apex_Tile Frenzy - Strafing - 02
PlayerCharacters=Apex_Hit
BotCharacters=TileFrenzyStrafing Cube.bot;TileFrenzyStrafing Sphere.bot
IsChallenge=true
Timelimit=30.0
PlayerProfile=Apex_Hit
...
GameTag=Apex, Flick
WeaponHeroTag=1x, 2x, AR, LMG, SMG, Shotgun, Pistol
DifficultyTag=3
AuthorsTag=WagiQQ
...
Name=Apex_Hit
MaxHealth=100.0
WeaponProfileNames=_Hit_1x Scope, Pistol, SMG, Shotgun;_Hit_2x Scope;_Hit_AR, LMG, Sniper;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
...
[Weapon Profile]
Name=_Hit_1x Scope, Pistol, SMG, Shotgun
Type=Hitscan
ShotsPerClick=1
DamagePerShot=25.0
KnockbackFactor=4.0
