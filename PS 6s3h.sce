...
BlockFCT=false
Description=popcorn sparky except you use a 6 shot revolver and the bots take 3 hits to kill. Player vertical height was also adjusted. The scoring system factors damage.
GameVersion=2.0.2.0
