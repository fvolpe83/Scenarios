Name=Widowmaker Vertical Flicks HS Only
...
GameTag=Overwatch, Single-Shot
WeaponHeroTag=Widowmaker
DifficultyTag=3
AuthorsTag=GoCrazy, gli, ZCR
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=HEADSHOT ONLY. kill bouncing/arcing balls. Make sure "zoom sens auto-scale" is unchecked in weapon settings.
GameVersion=1.0.7.2
