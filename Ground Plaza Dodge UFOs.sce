Name=Ground Plaza Dodge UFOs
PlayerCharacters=A
BotCharacters=plaza rotation ufos.rot
IsChallenge=true
Timelimit=240.0
PlayerProfile=A
AddedBots=plaza rotation ufos.rot
PlayerMaxLives=0
BotMaxLives=6
PlayerTeam=1
BotTeams=2
...
Name=plaza rotation ufos
ProfileNames=Bot Profile;air1_UFO
