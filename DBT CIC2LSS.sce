...
BotCharacters=DBT Long Strafes.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=EGODEATH
AddedBots=DBT Long Strafes.bot;DBT Long Strafes.bot
PlayerMaxLives=0
BotMaxLives=0;0
PlayerTeam=2
BotTeams=1;1
...
BlockFCT=false
Description=Cata IC Long Strafes Small with spheres for Diabotical
GameVersion=2.0.2.0
