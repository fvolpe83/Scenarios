Name=Genji close range 
PlayerCharacters=Quaker;Shinji
BotCharacters=Quaker Bot Long Strafes.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Shinji
...
GameTag=Reflex, Overwatch
WeaponHeroTag=Shinji, Shinji Stars
DifficultyTag=4
AuthorsTag=KovaaK, Huddled, Emsssi
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=A remake of Close Long Strafes by Huddled, but You're Shinji
GameVersion=2.0.1.2
