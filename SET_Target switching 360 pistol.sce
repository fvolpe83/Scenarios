Name=SET_Target switching 360 pistol
PlayerCharacters=Quaker
BotCharacters=Quaker Bot Fast Strafes.bot;Quaker Bot.bot;Quaker Bot Close.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Quaker
AddedBots=Quaker Bot Fast Strafes.bot;Quaker Bot.bot;Quaker Bot.bot
PlayerMaxLives=0
BotMaxLives=0;0;0
PlayerTeam=1
BotTeams=2;2;2
...
GameTag=Valorant, OW, Flick
WeaponHeroTag=
DifficultyTag=3
AuthorsTag=SorryEveryTime
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Target switching and Flick. Test your aiming skill!
GameVersion=2.0.0.2
...
[Bot Profile]
Name=Quaker Bot
DodgeProfileNames=Long Strafes Close;Long Strafes
