Name=Ground Plaza Invincible Thin
PlayerCharacters=A
BotCharacters=Bot Profile.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=A
AddedBots=Bot Profile.bot
PlayerMaxLives=0
BotMaxLives=8
PlayerTeam=1
BotTeams=2
...
DifficultyTag=4
AuthorsTag=ZzfuckmasterzZ69, Boky
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Ground Plaza but invincible but only the 1st bot
GameVersion=2.0.1.0
