Name=Air 2 Smooth FN
PlayerCharacters=A;FortniteMain
BotCharacters=air 2 far long rotation.rot
IsChallenge=true
Timelimit=60.0
PlayerProfile=FortniteMain
AddedBots=air 2 far long rotation.rot
PlayerMaxLives=0
BotMaxLives=8
PlayerTeam=1
BotTeams=2
...
WeaponHeroTag=
DifficultyTag=4
AuthorsTag=sini, patys, Whisper
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Air 2 far long strafes only for one minute
GameVersion=2.0.2.0
...
Name=air 2 far long rotation
ProfileNames=air1_far_long
ProfileWeights=1.0
Randomized=false
