...
BlockFCT=false
Description=I don't take credit for anything, I can't make maps I just copied the values from other to make my own. I uploaded it so that my freind can use it 
GameVersion=2.0.1.2
...
AirJumpVelocity=0.0
MainBBType=Cylindrical
MainBBHeight=153.333328
MainBBRadius=66.666656
MainBBHasHead=false
