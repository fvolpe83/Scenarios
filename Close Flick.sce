...
BotCharacters=Quaker Bot Fast Strafes.bot;Quaker Bot Fast Strafes.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Character Profile
AddedBots=Quaker Bot Fast Strafes.bot;Quaker Bot Fast Strafes.bot
PlayerMaxLives=0
BotMaxLives=0;0
PlayerTeam=1
BotTeams=0;0
...
DodgeProfileNames=Close Short Strafes;Stop
...
TargetStrafeMinDelay=0.125
TargetStrafeMaxDelay=0.25
MinProfileChangeTime=0.15
MaxProfileChangeTime=0.15
MinCrouchTime=0.1
MaxCrouchTime=0.1
MinJumpTime=0.0
MaxJumpTime=0.0
