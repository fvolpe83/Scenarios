Name=Killing Bhoppers 180 Tracking Humanoid
...
GameTag=CS:GO, Valorant, Counter Strike, Overwatch, Fortnite
WeaponHeroTag=Tracking
DifficultyTag=2
AuthorsTag=@Killericia
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Tracking bhoppers and target switch aim
GameVersion=2.0.1.2
