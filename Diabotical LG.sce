Name=Diabotical LG
PlayerCharacters=Quakerz
BotCharacters=Dodgey.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Quakerz
...
BlockFCT=false
Description=Diabotical LG Duel
GameVersion=2.0.0.2
...
[Bot Profile]
Name=Dodgey
DodgeProfileNames=MidStrafes;MidStrafes2;MidStrafes +Back;MidStrafes2 +Forward
DodgeProfileWeights=8.0;2.4;1.0;2.0
