Name=Tamspeed 2bpes no mag faster
PlayerCharacters=Clicker
BotCharacters=Pasu Semi Dodge.bot
IsChallenge=true
Timelimit=80.0
PlayerProfile=Clicker
AddedBots=Pasu Semi Dodge.bot;Pasu Semi Dodge.bot
PlayerMaxLives=0
BotMaxLives=0;0
PlayerTeam=1
BotTeams=2;0
...
BlockFCT=false
Description=Hybrid between Microshot speed 2 bots, reflex flick - micro, and pasu
GameVersion=2.0.2.0
...
[Bot Profile]
Name=Pasu Semi Dodge
DodgeProfileNames=Pasu Semi Dodge
...
UseWeapons=true
CharacterProfile=Pasu Semi Dodge
