Name=D2 SMG Static Pressure Tracking
PlayerCharacters=Quaker
BotCharacters=Quaker Bot Easy.bot;Quaker Bot Hard.bot;Quaker Bot Medium.bot
IsChallenge=true
Timelimit=60.0
...
WeaponHeroTag=SMG
DifficultyTag=3
AuthorsTag=HazedNConfused
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=This is to simulate a live scenario where the target will be evading and firing while you are attempting to close the gap.Static tracking should be applied in this exercise. Try to keep your reticle fixed  with a few minor adjustments to the mouse so that the reticle is locked on the head of the target. Apply model aiming and shoot the head for a more efficient kill. To get a more exact and visual explanation please checkout my Youtube Channel at https://www.youtube.com/channel/UCeWR  or search HazedNConfused.
GameVersion=2.0.2.0
...
UseWeapons=true
CharacterProfile=Quaker enemy long strafe
...
Name=Quaker
MaxHealth=600.0
WeaponProfileNames=Destiny 2 SMG long strafe;;;;;;;
MinRespawnDelay=2.0
MaxRespawnDelay=2.0
StepUpHeight=75.0
...
[Character Profile]
Name=Quaker enemy long strafe
MaxHealth=1000.0
WeaponProfileNames=Destiny 2 SMG long strafe Enemy;;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
CrouchHeightModifier=0.5
...
[Weapon Profile]
Name=Destiny 2 SMG long strafe
Type=Hitscan
ShotsPerClick=4
DamagePerShot=4.0
KnockbackFactor=0.0
TimeBetweenShots=0.0267
Pierces=false
Category=FullyAuto
BurstShotCount=1
...
[Weapon Profile]
Name=Destiny 2 SMG long strafe Enemy
Type=Hitscan
ShotsPerClick=4
DamagePerShot=4.0
KnockbackFactor=1.0
