Name=Circlestrafe Tracking - McCree Recoil
PlayerCharacters=Stationary McCoy
BotCharacters=target.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Stationary McCoy
...
BlockFCT=true
Description="Aim Hero - Strafing" with McCree Revolver. Choose your shots carefully while firing as quickly as possible -- misses will decrease your score.
GameVersion=1.0.5
