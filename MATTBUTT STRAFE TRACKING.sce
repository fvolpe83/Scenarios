Name=MATTBUTT STRAFE TRACKING
PlayerCharacters=A
BotCharacters=Thin short strafe.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=A
AddedBots=Thin short strafe.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=2
...
BlockFCT=false
Description=SLOW EASY TRACKING VALORANT
GameVersion=2.0.2.0
...
UseWeapons=false
CharacterProfile=MATTBUTT VAL BOT strafing
...
[Character Profile]
Name=MATTBUTT VAL BOT strafing
MaxHealth=450.0
WeaponProfileNames=;;;;;;;
MinRespawnDelay=0.1
MaxRespawnDelay=0.1
...
ForwardSpeedBias=1.0
HealthRegainedonkill=0.0
HealthRegenPerSec=225.0
HealthRegenDelay=0.3
JumpSpeedPenaltyDuration=0.0
