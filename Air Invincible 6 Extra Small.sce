Name=Air Invincible 6 Extra Small
PlayerCharacters=A
...
WeaponHeroTag=
DifficultyTag=4
AuthorsTag=patys, DeA, Whisper, Sackboy_Clank5
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Invincible version of Air No UFO No SKYBOTS bot 6 for 60 seconds
GameVersion=2.0.2.0
