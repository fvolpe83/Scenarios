...
BotCharacters=Apex.bot;Apex 100.bot
IsChallenge=true
Timelimit=50.0
PlayerProfile=Apex 200
AddedBots=Apex.bot;Apex 100.bot;Apex.bot;Apex 100.bot
PlayerMaxLives=0
BotMaxLives=0;0;0;0
PlayerTeam=0
BotTeams=2;2;1;1
...
WeaponHeroTag=wingman peacekeeper r-99 spitfire
DifficultyTag=1
AuthorsTag=nolsen
...
BlockFCT=false
Description=dont forget to ads
GameVersion=1.0.7.2
