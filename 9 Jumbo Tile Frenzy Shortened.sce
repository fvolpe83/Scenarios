Name=9 Jumbo Tile Frenzy Shortened
PlayerCharacters=A_air_pistol_frozen
BotCharacters=target.bot;target.bot;target.bot;target.bot
IsChallenge=true
Timelimit=10.0
PlayerProfile=A_air_pistol_frozen
AddedBots=target.bot;target.bot;target.bot;target.bot;target.bot;target.bot;target.bot;target.bot;target.bot
PlayerMaxLives=0
...
BlockFCT=false
Description=9 Jumbo Tile Frenzy 10 Sec 
GameVersion=1.0.6.2
