...
BlockFCT=false
Description=Close quarter combat practice against a fast strafing bot. Keep moving for increased score.
GameVersion=1.0.8.0
...
AimingProfileNames=Bot Aim;Bot Aim;Bot Aim;Default;Default;Default;Default;Default
WeaponSwitchTime=3.0
UseWeapons=false
CharacterProfile=SimpQuaker
