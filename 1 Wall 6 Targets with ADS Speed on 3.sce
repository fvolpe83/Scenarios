Name=1 Wall 6 Targets with ADS Speed on 3
...
DifficultyTag=3
AuthorsTag=Fuglaa, e2008enzo
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=basically the same but you can use your ADS Speed with the weapon on 3
GameVersion=1.0.6.3
...
MaxHealth=100.0
WeaponProfileNames=pistol;Track Master 100;Alcove_Tracking_Weapon;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
