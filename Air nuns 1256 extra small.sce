Name=Air nuns 1256 extra small
PlayerCharacters=A
...
BlockFCT=false
Description=Air but there's no UFO and no SKYBOTS, only the long strafe bots
GameVersion=2.0.2.0
...
ProfileNames=air1_close_long;air1_far_long;air1F_close_long;air1F_far_long
