Name=Target Acquisition Flick Far 350ms
PlayerCharacters=Player
BotCharacters=target.bot;350ms.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Player
AddedBots=target.bot;350ms.bot
PlayerMaxLives=0
BotMaxLives=0;0
PlayerTeam=1
BotTeams=2;2
...
BlockFCT=true
Description=Farther away from the orginal -- Aim at Poke-Ball and wait for the other target to spawn. Kill both in one fluid motion, focus on consistency to train your baseline ability to acquire targets, rather than relying on your peak flicking speed.
GameVersion=2.0.1.2
...
Name=target_350ms
MaxHealth=1.0
WeaponProfileNames=explode350ms;;;;;;;
...
global
	...
	entity
		type PlayerSpawn
		Vector3 position 0.000000 0.000000 -3600.000000
		Bool8 teamB 0
		Bool8 modeCTF 0
		Bool8 modeFFA 0
		Bool8 modeTDM 0
