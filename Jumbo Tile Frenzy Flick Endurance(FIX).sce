Name=Jumbo Tile Frenzy Flick Endurance(FIX)
PlayerCharacters=TileFrenzy Challenger
BotCharacters=TileFrenzy Cube.bot;TileFrenzy Cube.bot;TileFrenzy Cube.bot;TileFrenzy Cube.bot
IsChallenge=true
Timelimit=15.0
...
BlockFCT=true
Description=Tile Frenzy Flick in Jumbo
GameVersion=1.0.7.2
