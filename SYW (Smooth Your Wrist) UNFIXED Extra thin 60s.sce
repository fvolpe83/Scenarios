Name=SYW (Smooth Your Wrist) UNFIXED Extra thin 60s
...
BlockFCT=false
Description=A pure test of smoothness. You MUST use ADS (forced 103OW FoV) to prevent cheese. The glass on the sides give you time to react to bot strafes. EDIT: Original Char (Frozen)
GameVersion=2.0.2.0
