Name=Midair Mix Overwatch-CLOSE
...
BlockFCT=false
Description=Closer range version of original with perfect accuracy guns. Also made hitboxes more narrow and speed to match tracer in game speed. Press the Launch ability to send bots flying in the air.  Kills with midair rockets award extra points. A modification of KovaaK's Midair Mix for Overwatch-specific weapons.
GameVersion=1.0.5
