Name=Dancing Tiles 3rd
PlayerCharacters=You 3rd
BotCharacters=Tiles.rot
IsChallenge=true
Timelimit=30.0
PlayerProfile=You 3rd
AddedBots=Tiles.rot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
...
GameTag=Flick and target switch
WeaponHeroTag=Pistol and Shotgun
DifficultyTag=2
AuthorsTag=Pingwen
...
BlockFCT=false
Description=2 targets switching from a high ground target and a moving ground target. Pistol the highground and shotgun the low ground
GameVersion=1.0.8.0
...
Name=Tiles
ProfileNames=target;TileFrenzyStrafing Cube
...
Name=You 3rd
MaxHealth=100.0
WeaponProfileNames=pistol;Shotgun;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
...
JumpSpeedPenaltyDuration=1.0
JumpSpeedPenaltyPercent=0.25
ThirdPersonCamera=true
TPSArmLength=400.0
TPSOffset=X=0.000 Y=100.000 Z=80.000
