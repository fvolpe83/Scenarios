Name=Charge Close Fast Strafes Shotgun Invincible
...
GameTag=Fortnite, Reflex, Quake, TF2
WeaponHeroTag=Shotgun, Pump
DifficultyTag=3
AuthorsTag=patys, KovaaK, Cody, vF KROADER
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Charge Shotgun practice against a hard to hit target. Invincible version with 1 spawn for better scoring and less restarting.
GameVersion=2.0.1.2
...
DodgeProfileNames=Close Short Strafes;Close Very Short Strafes;Close Long Strafes
