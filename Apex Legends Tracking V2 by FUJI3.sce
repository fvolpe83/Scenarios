Name=Apex Legends Tracking V2 by FUJI3
PlayerCharacters=Quaker
BotCharacters=Quaker Bot Long Strafes.bot;Quaker Bot Fast Strafes.bot
IsChallenge=true
Timelimit=120.0
PlayerProfile=Quaker
AddedBots=Quaker Bot Long Strafes.bot;Quaker Bot Fast Strafes.bot;Quaker Bot Long Strafes.bot
PlayerMaxLives=0
BotMaxLives=0;0;0
PlayerTeam=1
BotTeams=2;2;2
MapName=Flick_Audio_Medium.map
MapScale=10.0
...
Name=Quaker
MaxHealth=200.0
WeaponProfileNames=Wingman;R-99;Peacekeeper;;;;;
MinRespawnDelay=0.001
MaxRespawnDelay=0.001
StepUpHeight=75.0
CrouchHeightModifier=0.5
CrouchAnimationSpeed=2.0
CameraOffset=X=0.000 Y=0.000 Z=75.000
HeadshotOnly=false
