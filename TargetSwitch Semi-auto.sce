...
GameTag=Call of Duty, Battlefield, Overwatch, flick, Destiny
WeaponHeroTag=Semi-auto rifle
DifficultyTag=3
AuthorsTag=patys, DualMono
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Target switching scenarios (flick + track) 150 RPM semi-auto
GameVersion=2.0.1.2
