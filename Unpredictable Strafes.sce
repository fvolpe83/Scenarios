Name=Unpredictable Strafes
PlayerCharacters=A
BotCharacters=ape.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=A
AddedBots=ape.bot
...
DifficultyTag=5
AuthorsTag=razaplaza, zac
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Ground Plaza bot 9 vss edition
GameVersion=2.0.1.2
...
[Bot Profile]
Name=ape
DodgeProfileNames=ADAD;CsRandom1;MidStrafes;MidStrafes2;Short Strafes;Very Short Strafes + Jump
