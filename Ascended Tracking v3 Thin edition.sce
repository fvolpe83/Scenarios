Name=Ascended Tracking v3 Thin edition
...
WeaponHeroTag=
DifficultyTag=3
AuthorsTag=KovaaK,  Menace
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=true
Description=Thinner targets than the Original version. Try to get Accuracy up. Track 3 targets at a variety of ranges and angles.  The weapon you use is hitscan and does more damage if you are centered on your target.  Difference from v2 is that v3 allows you to ADS/zoom.
GameVersion=1.0.8.0
