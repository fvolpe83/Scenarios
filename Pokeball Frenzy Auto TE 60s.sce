Name=Pokeball Frenzy Auto TE 60s
PlayerCharacters=NoOffset
BotCharacters=Regenerating Pokeball.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=NoOffset
...
GameTag=Valorant, Counterstrike, CSGO, R6, Siege, Fortnite
WeaponHeroTag=Drill
DifficultyTag=3
AuthorsTag=?, sini
...
BlockFCT=true
Description=60s version of Pokeball Frenzy but with an autofire Drill against instantly regenerating targets if you don't drill the target for at least 40ms. No accuracy penalty artifically added, the regeneration punishes you for Parkinsons aim.
GameVersion=2.0.2.0
