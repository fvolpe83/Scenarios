Name=Midrange Fast Strafes Invincible Thin
...
BlockFCT=false
Description=Tracking a target at mid-range. The target mixes in a few dodging profiles making its fast strafes unpredictable. Made extra thin because why not.
GameVersion=2.0.1.1
