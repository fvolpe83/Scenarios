Name=1wall 6targets small FN AR
...
WeaponHeroTag=FN AR, FortniteMain
DifficultyTag=2
AuthorsTag=twitch.tv/Akuvo, ku, gli
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=true
Description=Changed ku and gli's map 1wall 6targets small to more closely match Fortnite's aim system (3rd person, ADS available, FN AR)
GameVersion=1.0.7.2
