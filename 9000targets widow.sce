Name=9000targets widow
PlayerCharacters=Windowmaker one shot
BotCharacters=target.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Windowmaker one shot
...
[Character Profile]
Name=Windowmaker one shot
MaxHealth=200.0
WeaponProfileNames=Sniper Rifle One Shot;;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
