...
WeaponHeroTag=Lightning Gun, Quaker
DifficultyTag=3
AuthorsTag=Lui Langfinger
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Use this to train smooth mouse movement when tracking targets. Try to be as smooth as possible. DONT do quick jerky movements. 
GameVersion=1.0.7.2
