...
DifficultyTag=5
AuthorsTag=razaplaza, patys
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=10 bots with various dodge profiles and speeds. Similar to air, but the bots are on the ground and you are on lowground.
GameVersion=2.0.1.0
...
MaxTargetDistance=2230.0
MinTargetDistance=2150.0
...
MaxTargetDistance=2380.0
MinTargetDistance=2230.0
ToggleLeftRight=true
ToggleForwardBack=false
MinLRTimeChange=0.1
MaxLRTimeChange=0.2
