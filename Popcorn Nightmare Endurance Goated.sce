Name=Popcorn Nightmare Endurance Goated
...
DifficultyTag=3
AuthorsTag=kindred, gli
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=POPCORN but the bots actually bounce, you can use health bars, no accuracy multiplier and a one-shot reload system to punish missing.
GameVersion=1.0.8.0
