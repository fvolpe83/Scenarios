Name=5 Target Automatic Tracking x WETWORK 
...
GameTag=pasu, tracking, flicking, auto, pubg, fortnite, warzone, COD, cod, bf, insurgency, overwatch, valorant, cs, 
WeaponHeroTag=auto, rifle, lmg, 
DifficultyTag=3
...
BlockFCT=false
Description=Automatic Pasu Tracking. Warmup with this before your games.
GameVersion=2.0.1.0
