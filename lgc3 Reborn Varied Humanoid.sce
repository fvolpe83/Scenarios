Name=lgc3 Reborn Varied Humanoid
...
GameTag=Reflex, Quake, lgc, Dodge
...
BlockFCT=false
Description=Remake of the original LGC3 mod from Quakeworld. LG duel in an open space. Boost your score by moving around, shorter strafes are incentivized by the scoring system. Bots are chosen at random from a bot rotation with different dodging profiles.
GameVersion=2.0.1.2
