Name=pasu reload 360 250%
PlayerCharacters=A_air_pistol_frozen
BotCharacters=test.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=A_air_pistol_frozen
AddedBots=test.bot;test.bot;test.bot;test.bot;test.bot;test.bot;test.bot;test.bot;test.bot
PlayerMaxLives=0
...
DifficultyTag=3
AuthorsTag=Fuglaa, Sackboy_Clank5, huekk
