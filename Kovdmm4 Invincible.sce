...
GameTag=Quake, QW
WeaponHeroTag=LG, Lightning Gun, RL, Rockets
DifficultyTag=3
AuthorsTag=KovaaK
...
BlockFCT=false
Description=Quake 1 style hitboxes and knockback (rockets send your target flying).  Classic tracking and projectile practice.
GameVersion=1.0.7.2
