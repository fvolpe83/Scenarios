Name=Bounce 180 Tracking Single Target
...
GameTag=Tracking, Overwatch, Fortnite, Destiny 2
WeaponHeroTag=Tracking
DifficultyTag=3
AuthorsTag=Huddled, yuan
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Single target Bounce 180 Tracking. Helps with consistent vertical tracking.
GameVersion=2.0.1.2
