Name=Zaey Flick 10ms - Real Speed - Current Maximum Limit
...
WeaponHeroTag=
DifficultyTag=5
AuthorsTag=Zaeyron, CrashSlayer
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=This is the Maximum Potential for Kovaak's Engine Currently. Don't expect to even get any score if you do this, it's not meant for that.
GameVersion=1.0.8.0
