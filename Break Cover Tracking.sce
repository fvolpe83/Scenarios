Name=Break Cover Tracking
PlayerCharacters=Aimer2
BotCharacters=BOT2.bot
IsChallenge=true
Timelimit=30.0
PlayerProfile=Aimer2
AddedBots=BOT2.bot;BOT2.bot
PlayerMaxLives=0
BotMaxLives=10;10
PlayerTeam=1
BotTeams=2;2
...
GameTag=Apex, Fortnite, OW, Tracking
WeaponHeroTag=
DifficultyTag=2
AuthorsTag=@Lac0caL
