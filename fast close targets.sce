Name=fast close targets
PlayerCharacters=3 player
BotCharacters=3 bot.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=3 player
AddedBots=3 bot.bot;3 bot.bot
PlayerMaxLives=0
BotMaxLives=0;0
PlayerTeam=1
BotTeams=2;2
...
BlockFCT=false
Description=tracking fast close targets
GameVersion=2.0.1.0
