...
BotCharacters=McCoy Bot.bot;McCoy Bot.bot
IsChallenge=true
Timelimit=60.0
...
GameTag=Apex Legends 1vs1
WeaponHeroTag=Wingman
DifficultyTag=3
AuthorsTag=twitch_ijustpewpew
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Good practice for 1vs1
GameVersion=1.0.8.0
