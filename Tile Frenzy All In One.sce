...
DifficultyTag=2
AuthorsTag=Sharqosity, e2008enzo
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Tile Frenzy but Hip Fire Sense and ADS Sense in one Game (1 is Hip Fire, 2 ADS Sense) !!! You need to put your ADS Sense into the Options-Menu from this game if you didnt already put it in as you were playing ascended tracking v2 !!!
GameVersion=1.0.6.3
