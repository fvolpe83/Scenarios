...
BotCharacters=Quaker Bot Easy.bot;Quaker Bot Hard.bot;Quaker Bot Medium.bot;Quaker Bot Easy.bot
IsChallenge=true
Timelimit=60.0
...
BlockFCT=false
Description=keep moving, dodge damage
GameVersion=1.0.6
...
MinRecenterTime=0.01
MaxRecenterTime=0.01
OptimalAimFOV=90.0
OuterAimPenalty=0.0
MaxError=0.0
ShootFOV=0.5
...
DodgeProfileNames=Long Strafes_maxlimit
