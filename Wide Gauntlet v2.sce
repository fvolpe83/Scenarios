...
GameTag=track, smooth, wide aiming long
WeaponHeroTag=
DifficultyTag=3
AuthorsTag=Brian
...
BlockFCT=false
Description=Track very wide targets that make long strafes, progressively getting harder. Challenge mode takes up to 2-3 minutes.
GameVersion=2.0.1.2
