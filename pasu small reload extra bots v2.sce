Name=pasu small reload extra bots v2
...
DifficultyTag=2
AuthorsTag=Fuglaa, Pasutazame
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=1w5p small targets, but accuracy doesn't affect scoring; instead, you have limited ammo that reloads on kill.
GameVersion=2.0.2.0
