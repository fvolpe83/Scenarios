...
WeaponHeroTag=LG
DifficultyTag=5
AuthorsTag=kindred, nocrno
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description="Air no UFO no SKYBOTS" with movement based scoring, some edited profiles, and slightly smaller bots.
GameVersion=1.0.8.0
