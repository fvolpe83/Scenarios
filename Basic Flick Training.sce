Name=Basic Flick Training
PlayerCharacters=SingleShot
BotCharacters=Stationary Ball.bot;Stationary Ball.bot;Stationary Ball.bot;Stationary Ball.bot
IsChallenge=true
Timelimit=30.0
PlayerProfile=SingleShot
AddedBots=Stationary Ball.bot;Stationary Ball.bot;Stationary Ball.bot;Stationary Ball.bot
PlayerMaxLives=0
BotMaxLives=0;0;0;0
PlayerTeam=1
BotTeams=2;2;2;2
...
BlockFCT=false
Description=Simplest flick training. Target is just stationary, so practice flicking to it from any angle you choose. 
GameVersion=1.0.7.2
...
Name=SingleShot
MaxHealth=100.0
WeaponProfileNames=Single Shot;;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
