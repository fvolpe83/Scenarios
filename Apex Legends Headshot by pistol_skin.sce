Name=Apex Legends Headshot by pistol_skin
PlayerCharacters=Health
...
DifficultyTag=5
AuthorsTag=pistol_skin
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=1 v 3 Headshot Hard
GameVersion=1.0.8.0
