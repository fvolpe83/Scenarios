...
BlockFCT=true
Description=ascended tracking but with movement scoring. Tend towards faster strafes as 0.5sec+ strafes will give you nearly no score. Not scored by damage efficiency
GameVersion=1.0.8.0
ScorePerDistance=0.00001
MBSEnable=true
MBSTime1=0.25
MBSTime2=0.49
MBSTime3=0.5
...
DodgeProfileNames=Long Strafes;Stop
DodgeProfileWeights=1.0;0.25
...
ChargeTimeToCap=1.0
ChargeMoveSpeedModifier=1.0
MuzzleVelocityMin=X=1000000.000 Y=-100.000 Z=-100.000
MuzzleVelocityMax=X=1000000.000 Y=100.000 Z=100.000
...
DelayAfterSpawn=0.0
BlockedByWorld=false
SpreadSSA=0.0,4.0,0.001,0.001
SpreadSCA=0.0,4.0,0.001,0.001
SpreadMSA=0.0,4.0,0.001,0.001
SpreadMCA=0.0,4.0,0.001,0.001
SpreadSSH=0.0,4.0,0.001,0.001
SpreadSCH=0.0,4.0,0.001,0.001
SpreadMSH=0.0,4.0,0.001,0.001
SpreadMCH=0.0,4.0,0.001,0.001
MaxRecoilUp=0.0
MinRecoilUp=0.0
MinRecoilHoriz=0.0
MaxRecoilHoriz=0.0
