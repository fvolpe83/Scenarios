Name=Reflex Poke-Micro++ Regenerating Goated
PlayerCharacters=Clickerz
BotCharacters=target_decay.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Clickerz
...
UseWeapons=true
CharacterProfile=[custom] Regenerating Pokeball
...
[Character Profile]
Name=[custom] Regenerating Pokeball
MaxHealth=1.0
WeaponProfileNames=;;;;;;;
