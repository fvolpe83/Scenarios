...
GameTag=Overwatch, apex, legends, click
WeaponHeroTag=mcree, manwing
DifficultyTag=2
AuthorsTag=Whisper, huekk
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=To help vertical tracking while clicking. Reload mechanism with no acc penalty on scoring, and the balls actually bounce.
GameVersion=2.0.1.2
...
MuzzleVelocityMin=X=50000.000 Y=0.000 Z=0.000
MuzzleVelocityMax=X=50000.000 Y=0.000 Z=0.000
