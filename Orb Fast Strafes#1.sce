Name=Orb Fast Strafes#1
PlayerCharacters=OrbMonk
BotCharacters=Watcher Bot Fast Strafes.bot;Watcher Bot Fast Strafes.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=OrbMonk
AddedBots=Watcher Bot Fast Strafes.bot;Watcher Bot Fast Strafes.bot
PlayerMaxLives=0
BotMaxLives=0;0
PlayerTeam=2
BotTeams=1;1
...
Name=OrbMonk
MaxHealth=200.0
WeaponProfileNames=Monk Orb;AK-47;AN-94 Abakan;Deag;LG;M4A1-S;pistol;Rocket Launcher
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=35.0
