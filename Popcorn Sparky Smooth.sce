...
DifficultyTag=5
AuthorsTag=kindred, gli, sini. Maddie
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Popcorn sparky but now the bots regen health. This is a nightmare, why would you do this to yourself.
GameVersion=2.0.2.0
