Name=DevTargetSwitch 1shot small 3clip
...
GameTag=ddtv,click timing,acquisition,target switch,targetswitch,pattargetswitch, R6 BEST GAME
WeaponHeroTag=target switch, elo gains
DifficultyTag=4
AuthorsTag=Toast of War, DevinDTV
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=false
BlockFCT=false
Description=Got your elo stolen? Hardstuck in pleb ranks? Need to be able to target switch? Well fear not because DevTargetSwitch 1shot has you covered! Steal elo like never before! Call 1-800-ELO-BACK to RSVP your chance to steal Vlad's elo!  *(DTS1s is not responsible for loss of elo, rank, time, or sanity during play sessions)*
GameVersion=2.0.1.1
...
MainBBRadius=40.0
MainBBHasHead=false
MainBBHeadRadius=37.5
MainBBHeadOffset=-22.5
MainBBHide=false
ProjBBType=Cylindrical
ProjBBHeight=230.0
ProjBBRadius=55.0
