Name=Nay's Ego Death - Ascended Tracking 90 Thin (Like REALLY Thin)
...
GameTag=Tracking, Thin, impossible, hard, nay, ego death,
WeaponHeroTag=
DifficultyTag=5
AuthorsTag=KovaaK (Edited by Yagnesh) (Made Impossible by youtube.com/nay2d2)
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=true
Description=Edit of Ascending Tracking 90, if you have suggestions my discord is Yagneeshh#7724. Good Luck with my impossible version >:) ~! gg's to anyone who manages like 50% on this though im sure one of you will 
GameVersion=1.0.7.1
