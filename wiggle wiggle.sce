...
BotCharacters=Wiggle wiggle.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Quaker
AddedBots=Wiggle wiggle.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=2
...
[Bot Profile]
Name=Wiggle wiggle
DodgeProfileNames=Wiggle Wiggle
...
CanCrouchInAir=true
CanJumpFromCrouch=false
EnemyBodyColor=X=0.076 Y=0.791 Z=0.815
EnemyHeadColor=X=1.000 Y=1.000 Z=1.000
TeamBodyColor=X=1.000 Y=0.888 Z=0.000
TeamHeadColor=X=1.000 Y=1.000 Z=1.000
BlockSelfDamage=false
...
MinJumpTime=0.3
MaxJumpTime=0.6
LeftStrafeTimeMult=0.2
RightStrafeTimeMult=0.2
