Name=Ascended R99 - Easy
PlayerCharacters=Ascended Tracking
BotCharacters=Apex Bot - White.bot
IsChallenge=true
Timelimit=90.0
PlayerProfile=Ascended Tracking
AddedBots=Apex Bot - White.bot;Apex Bot - White.bot;Apex Bot - White.bot
PlayerMaxLives=0
BotMaxLives=0;0;0
PlayerTeam=1
BotTeams=0;0;0
...
BlockFCT=true
Description=R99 Tracking Exercise Bot health = 150hp (Same as White armor)Any suggestions ask me on twitter @supatroopa_
GameVersion=1.0.7.2
