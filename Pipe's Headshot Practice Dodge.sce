Name=Pipe's Headshot Practice Dodge
PlayerCharacters=Aim Hero
BotCharacters=target.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Aim Hero
...
GameTag=CSGO, CS, Black Squad
WeaponHeroTag=AK47
DifficultyTag=3
AuthorsTag=Pipelokillo
BlockHitMarkers=true
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=true
Description=practice your headshots in aim hero strafing mode with a small target hitbox, hf!
GameVersion=2.0.0.1
