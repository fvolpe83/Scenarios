Name=Air no UFO no SKYBOTS 150 PERCENT 50% smaller
PlayerCharacters=A
...
WeaponHeroTag=
DifficultyTag=4
AuthorsTag=patys, KROADER,sdk
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Air but there's no UFO and no SKYBOTS and the bots are faster
GameVersion=2.0.1.0
