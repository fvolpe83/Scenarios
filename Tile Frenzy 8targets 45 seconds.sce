Name=Tile Frenzy 8targets 45 seconds
...
BlockFCT=true
Description=Eight targets spawn on a wall.  Great practice for flicking to many targets quickly.  Challenge mode has accuracy-based scoring.
GameVersion=1.0.8.0
