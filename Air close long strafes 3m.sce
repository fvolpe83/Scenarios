Name=Air close long strafes 3m
PlayerCharacters=A
BotCharacters=air close long rotation.rot
IsChallenge=true
Timelimit=180.0
PlayerProfile=A
AddedBots=air close long rotation.rot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=2
...
BlockFCT=false
Description=Multiple air 1 spawns for three minutes
GameVersion=2.0.2.0
