Name=Manwing Challenge Gallery
...
GameTag=Apex, Movement, Tracking
WeaponHeroTag=Wingman
DifficultyTag=3
AuthorsTag=DapperMode
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Practice strafing and shooting with the wingman. Targets also strafe and crouch. Score based on damage done and distance traveled. You lose points for falling off the shooting platform.
GameVersion=1.0.7.2
