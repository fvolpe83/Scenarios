Name=Bounce 360 Mccoy Small
PlayerCharacters=McCoy
BotCharacters=200hppigeon.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=McCoy
AddedBots=200hppigeon.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=2
...
WeaponHeroTag=Six shooter / Mccoy
DifficultyTag=2
AuthorsTag=Punk, Cody
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Practice tracking a head-sized target while clicking on it with McCoy's gun.
GameVersion=1.0.8.0
