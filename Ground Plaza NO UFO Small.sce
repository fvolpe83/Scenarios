Name=Ground Plaza NO UFO Small
PlayerCharacters=A
...
DifficultyTag=4
AuthorsTag=razaplaza, mrg, Ghokury
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Ground Plaza, but with no ufos and fixed spawns. Bots are 30% smaller.
GameVersion=1.0.8.0
