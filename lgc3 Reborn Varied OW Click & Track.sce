Name=lgc3 Reborn Varied OW Click & Track
...
GameTag=Overwatch, Reflex, Quake, lgc, Dodge, Apex
WeaponHeroTag=Soldier 76, Tracer, LG, Lightning Gun
DifficultyTag=5
AuthorsTag=patys, twitch.tv/Tommio
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=LGC3 with instant acceleration and added weapon pistol
GameVersion=1.0.8.0
