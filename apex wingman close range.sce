...
DifficultyTag=3
AuthorsTag=KovaaK, HuddledM,DingooYang
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Low pressure hitscan tracking against an hard to hit target.
GameVersion=2.0.0.2
...
DodgeProfileNames=ADAD;Short Strafes Jumping;Very Short Strafes + Jump
...
Name=Quaker
MaxHealth=300.0
WeaponProfileNames=;WING MAN;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
CrouchHeightModifier=0.5
CrouchAnimationSpeed=2.0
CameraOffset=X=0.000 Y=0.000 Z=125.000
HeadshotOnly=false
