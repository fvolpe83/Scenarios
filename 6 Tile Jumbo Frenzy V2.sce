...
GameTag=6 Jumbo Tile Frenzy v2.0
WeaponHeroTag=
DifficultyTag=3
AuthorsTag=Sharqosity/Tripzzie
BlockHitMarkers=true
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=true
Description=Upgraded Jumbo Tile Frenzy to a smaller version and faster response for the weapon.
GameVersion=1.0.7.2
