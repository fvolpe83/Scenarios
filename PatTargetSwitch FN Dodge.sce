...
GameTag=flick, fortnite, apex, close flicks, dodge, dodge flicks
WeaponHeroTag=Pistol
DifficultyTag=3
AuthorsTag=WillTheSheep
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=mimics close quarter pump shots while dodging - still can be applied to other games! headshot is one shot
GameVersion=1.0.8.0
...
TPSArmLength=615.0
TPSOffset=X=0.000 Y=200.000 Z=-50.000
