...
GameTag=Flick, Head, Csgo, headshot, small, hitbox, fun 
...
BlockFCT=false
Description=3 headshot sized targets that respawn instantly when they die. Kill as many as you can in 30 seconds!
GameVersion=1.0.7.2
