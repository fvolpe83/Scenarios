Name=lgc3 Reborn 150%
PlayerCharacters=QuakerP
BotCharacters=Quaker Bot.bot
IsChallenge=true
Timelimit=120.0
PlayerProfile=QuakerP
...
DifficultyTag=4
AuthorsTag=patys, opus
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Remake of the original LGC3 mod from Quakeworld. LG duel in an open space. Boost your score by moving around.
GameVersion=2.0.2.0
