...
GameTag=flick, r6, csgo, overwatch, ow, fn, fortnite
...
BlockFCT=true
Description=Reflex flick but with pasu targets. You have 2 shots to hit the target before reloading, so you are encouraged to flick to the target fast. 
GameVersion=2.0.0.2
...
DelayAfterUse=0.0
FullyAuto=true
WeaponProfile=selfdamage 1000 ms
