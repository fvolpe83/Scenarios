...
BlockFCT=true
Description=Train flicks with a slowly disappearing target (1s). Aim for 100% accuracy. Move your mouse in a straight line towards the target and then click. Slowly increase speed while maintaining 100% accuracy.
GameVersion=1.0.5
