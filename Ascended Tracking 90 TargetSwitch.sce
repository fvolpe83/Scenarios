Name=Ascended Tracking 90 TargetSwitch
PlayerCharacters=Ascended Tracking
BotCharacters=Long Strafe Bot 100.bot
IsChallenge=true
Timelimit=90.0
PlayerProfile=Ascended Tracking
AddedBots=Long Strafe Bot 100.bot;Long Strafe Bot 100.bot
PlayerMaxLives=0
BotMaxLives=0;0
PlayerTeam=1
BotTeams=2;2
...
UseWeapons=false
CharacterProfile=Long Strafer 100hp test
