...
DifficultyTag=4
AuthorsTag=Huddled,gladiu
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Bounce 180 tracking but harder
GameVersion=2.0.0.2
...
BlockedMovementPercent=0.95
BlockedMovementReactionMin=0.05
BlockedMovementReactionMax=0.075
