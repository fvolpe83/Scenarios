...
GameTag=Fortnite
WeaponHeroTag=Blue Tac, Blue SMG, Shotgun, SMG
DifficultyTag=3
AuthorsTag=Liglo
...
BlockFCT=false
Description=Fortnite Tac Flicks / SMG Swap 1x1
GameVersion=1.0.8.0
...
Name=Quaker
MaxHealth=500.0
WeaponProfileNames=;Blue Tac;Blue SMG;Gold Scar;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
