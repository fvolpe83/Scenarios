Name=PUBG Tracking- (Recoil) v3
PlayerCharacters=PUBG New-Recoil
BotCharacters=Pigeon new 1.bot;Pigeon Tank1.bot;Pigeon Slim1.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=PUBG New-Recoil
...
[Character Profile]
Name=PUBG New-Recoil
MaxHealth=200.0
WeaponProfileNames=PUBG AR-new;;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
...
SpreadSSA=1.0,3.0,-1.0,0.7
SpreadSCA=1.0,3.0,-1.0,0.9
SpreadMSA=1.0,3.0,-1.0,0.7
SpreadMCA=1.0,3.0,-1.0,0.9
SpreadSSH=1.0,3.0,-1.0,1.7
SpreadSCH=1.0,3.0,-1.0,1.0
SpreadMSH=1.0,3.0,-1.0,1.7
