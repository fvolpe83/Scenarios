...
GameTag=timing,ddtv,overwatch,fortnite,fn,ow,apex,cs,r6
WeaponHeroTag=
DifficultyTag=3
AuthorsTag=huddled, DevinDTV
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=An even simpler version of Bounce Timing.
GameVersion=1.0.7.2
