...
BlockFCT=false
Description=Reupload of mgli's novelty Halloween Air. Bots lose health over time but damage heals them. Scored on time remainig.
GameVersion=1.0.5
...
AbilityProfileNames=5dmg.abilmov;;;
HideWeapon=true
AerialFriction=0.0
StrafeSpeedMult=1.0
BackSpeedMult=1.0
...
JetpackMaxZVelocity=400.0
JetpackAirControlWithThrust=1.0
AbilityProfileNames=Blink.abilmov;5dmg.abilmov;;
HideWeapon=true
AerialFriction=0.0
StrafeSpeedMult=1.0
BackSpeedMult=1.0
