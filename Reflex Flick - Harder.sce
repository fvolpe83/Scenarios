...
GameTag=csgo, valorant, overwatch, r6s, Quake
WeaponHeroTag=
DifficultyTag=5
AuthorsTag=KovaaK x vinhero
BlockHitMarkers=true
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=true
Description=Flick to a short-lived target before it despawns. A test of reflex and flick accuracy. Single 100 size target with -- 350 ms lifetime. --
GameVersion=2.0.1.2
...
DelayAfterUse=0.0
FullyAuto=true
WeaponProfile=selfdamage 350 ms
