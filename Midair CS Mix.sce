...
AddedBots=Counter-Striker Bot Harmless.bot;Counter-Striker Bot Harmless.bot;Counter-Striker Bot Harmless.bot
PlayerMaxLives=0
BotMaxLives=0;0;0
PlayerTeam=1
BotTeams=2;2;2
...
MagazineMax=1
AmmoPerShot=1
ReloadTimeFromEmpty=0.22
ReloadTimeFromPartial=0.22
