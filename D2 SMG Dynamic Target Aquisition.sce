Name=D2 SMG Dynamic Target Aquisition
...
BlockFCT=true
Description= I created this exercise to help build speed and precision when acquiring a target from a resting position. To perform this exercise you will always start in the center which is the resting position and reset to it every time you finish shooting a target. One more thing, if the gun is getting in the way of seeing the target. You can choose to disable the guns visibility in the options menu under UI. To get a more exact and visual explanation please checkout my Youtube Channel at https://www.youtube.com/channel/UCeWR  or search HazedNConfused.
GameVersion=2.0.2.0
