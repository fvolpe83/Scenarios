...
GameTag=Track
WeaponHeroTag=TrackMaster100
DifficultyTag=4
AuthorsTag=Ku, unnamed
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Kill the 9 different kinds of Bots! The scenario ends when you kill the last boss "UFO"
GameVersion=1.0.7.2
