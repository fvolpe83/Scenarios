Name=Horizontal Flicks Reload
PlayerCharacters=Quaker;Shinji;Shinji small
BotCharacters=Shinji Bot.bot;Shinji small Bot.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Quaker
AddedBots=Shinji small Bot.bot;Shinji small Bot.bot;Shinji small Bot.bot;Shinji small Bot.bot;Shinji Bot.bot;Shinji Bot.bot;Shinji Bot.bot;Shinji Bot.bot
PlayerMaxLives=0
...
GameTag=CSGO, Overwatch, Battlefield
...
BlockFCT=false
Description=RECORD YOUR RUNS! Top 10 scores require video to score points.  Visit league.themeta.gg.  Horizontal flicking and clicktiming
GameVersion=2.0.1.2
