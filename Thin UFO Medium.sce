...
GameTag=Quake, Diabotical
WeaponHeroTag=
DifficultyTag=3
AuthorsTag=Whisper, HotRodRe
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Medium speed thin UFO. ** This is for practice only. The bot is invincible and scenario lasts 15 minutes. Don't worry about finishing, and instead practice good technique. **
GameVersion=2.0.2.0
