...
GameTag=track apex legends overwatch ow hyperscape, Thin, Long , Invincible, One Direction
WeaponHeroTag=track
DifficultyTag=3
AuthorsTag=Ku, huekk
...
BlockFCT=false
Description=Track a very thin INVINCIBLE target that makes long strafes in one direction. keep restarting until the bot goes in the direction you want!
GameVersion=2.0.1.2
