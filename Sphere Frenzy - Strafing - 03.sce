Name=Sphere Frenzy - Strafing - 03
PlayerCharacters=TileFrenzy Challenger 3;TileFrenzy Weapon Overrides;TileFrenzy Zooms 10sec
BotCharacters=TileFrenzyStrafing Sphere.bot
IsChallenge=true
Timelimit=30.0
PlayerProfile=TileFrenzy Challenger 3
AddedBots=TileFrenzyStrafing Sphere.bot;TileFrenzyStrafing Sphere.bot;TileFrenzyStrafing Sphere.bot
PlayerMaxLives=0
BotMaxLives=0;0;0
PlayerTeam=1
BotTeams=2;2;2
...
BlockFCT=true
Description=Tile Frenzy - Strafing - 03, but with spheres, cause cubes are too easy
GameVersion=2.0.2.0
