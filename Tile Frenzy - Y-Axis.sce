...
BlockFCT=true
Description=Flick between three cubes that respawn instantly upon death. Kill as many as you can within 30 seconds! Extra tall playfield.
GameVersion=1.0.6
