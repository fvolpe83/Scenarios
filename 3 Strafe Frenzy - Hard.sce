...
GameTag=CSGO, Quake, Overwatch, Valorant
WeaponHeroTag=
DifficultyTag=4
AuthorsTag=JathOsh
...
BlockFCT=false
Description=Flick between 3 moving targets. Even faster Bots.
GameVersion=2.0.0.2
