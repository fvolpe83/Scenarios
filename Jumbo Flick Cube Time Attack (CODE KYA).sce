Name=Jumbo Flick Cube Time Attack (CODE KYA)
PlayerCharacters=Clicker
BotCharacters=target_decay.bot;target_decay.bot
IsChallenge=true
Timelimit=10.0
PlayerProfile=Clicker
AddedBots=target_decay.bot;target_decay.bot;target_decay.bot
PlayerMaxLives=0
BotMaxLives=0;0;0
PlayerTeam=1
BotTeams=2;0;0
...
DifficultyTag=2
AuthorsTag=PlagueDoctor
BlockHitMarkers=true
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=true
Description=BATTLE AGAINST TIME JUMBO Flick practise with two decaying cubes
GameVersion=1.0.7.1
