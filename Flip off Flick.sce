Name=Flip off Flick
PlayerCharacters=LR_player_char
BotCharacters=LR_enemy.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=LR_player_char
AddedBots=LR_enemy.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=2
...
BlockFCT=false
Description=A scenario in which you flick a target that alternately dashes left and right.Dash intensity is random.Dash angle is random.Bots are immortal.Compensation is based on accuracy.
GameVersion=2.0.2.0
...
JetpackMaxZVelocity=400.0
JetpackAirControlWithThrust=0.25
AbilityProfileNames=LR_15000.abilmov;LR_20000.abilmov;LR_25000.abilmov;LR_30000.abilmov
HideWeapon=true
AerialFriction=0.0
StrafeSpeedMult=1.0
BackSpeedMult=1.0
...
global
	...
	entity
		type PlayerSpawn
		Vector3 position 0.000000 0.000000 -1.000000
		Bool8 teamB 0
