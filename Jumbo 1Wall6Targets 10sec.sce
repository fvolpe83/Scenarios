Name=Jumbo 1Wall6Targets 10sec
...
BlockFCT=true
Description=Six targets spawn on a wall.  Great practice for flicking to many targets quickly. Now with bigger Targets. 10 seconds challenge!
GameVersion=2.0.0.1
