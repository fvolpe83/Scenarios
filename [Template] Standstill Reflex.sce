Name=[Template] Standstill Reflex
PlayerCharacters=Template Static Player
BotCharacters=Template Reflex Target.bot
IsChallenge=false
Timelimit=30.0
PlayerProfile=Template Static Player
AddedBots=Template Reflex Target.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=2
...
BlockFCT=true
Description=A template for creating a standstill reflex scenario. A target despawns after 500 ms in this template. If you want to enable challenge mode, check the "Challenge" item in "Main Properties" of "Scenario Editor".
GameVersion=2.0.0.2
...
UseWeapons=false
CharacterProfile=Template Reflex Target
...
JetpackMaxZVelocity=400.0
JetpackAirControlWithThrust=0.25
AbilityProfileNames=Template Despawn 500 ms.abilmov;;;
HideWeapon=true
AerialFriction=0.0
StrafeSpeedMult=1.0
BackSpeedMult=1.0
