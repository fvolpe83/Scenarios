Name=patTargetSwitch - 3rd Person
PlayerCharacters=SBMain
BotCharacters=Quaker Bot Long Strafes.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=SBMain
...
GameTag=Fortnite, TPP, 3rd person, flick, track
WeaponHeroTag=Rifle
DifficultyTag=3
AuthorsTag=patys, SS
...
BlockFCT=false
Description=Target switching scenarios (flick + track) modified with 3rd person view
GameVersion=1.0.7.2
