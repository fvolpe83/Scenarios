Name=D2 SMG Close Fast Strafe Dynamic Tracking
...
BlockFCT=false
Description=The target in this exercise will perform random short strafes from left to right.This is to simulate a realistic scenario of a better than average opponent challenging you in close quarter combat. Apply model aiming and shoot the head for a more efficient kill. To get a more exact and visual explanation please checkout my Youtube Channel at https://www.youtube.com/channel/UCeWR  or search HazedNConfused.
GameVersion=2.0.2.0
