Name=1wall5targets_pasu v2 Reload
...
DifficultyTag=3
AuthorsTag=sini, rallex
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Pasu but actually 1 minute long, the previous pasu was affected by timescaling and that also affects the timer making the scenario 30% longer. Here we set the scaling to 1.0 and instead reduced bot dodge profile by 30%. 
GameVersion=2.0.2.0
...
TPSArmLength=300.0
TPSOffset=X=0.000 Y=150.000 Z=150.000
BrakingDeceleration=1433.599976
VerticalSpawnOffset=0.0
TerminalVelocity=0.0
CharacterModel=None
CharacterSkin=Default
...
MinLRTimeChange=0.07
MaxLRTimeChange=7.0
MinFBTimeChange=0.07
MaxFBTimeChange=7.0
