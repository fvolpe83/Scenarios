...
BlockFCT=false
Description=A nimble bot with various close range strafing profiles ~Dia/Adv <nebscqqnxd>
GameVersion=2.0.2.0
...
[Bot Profile]
Name=Quaker Evasive
DodgeProfileNames=Single Cycle 02;Single Cycle 03;Single Cycle 04;Single Cycle 05;Half Cycle Left 06;Half Cycle Right 06
DodgeProfileWeights=0.643;0.961;0.969;0.833;0.332;0.332
...
JetpackMaxZVelocity=400.0
JetpackAirControlWithThrust=0.25
AbilityProfileNames=1mc 2ct 4e-1ad 15e2mv.abilmov;1mc 3ct 3e-1ad 8e2mv.abilmov;1mc 4ct 1e-1ad 6e3mv.abilmov;
HideWeapon=true
AerialFriction=0.0
StrafeSpeedMult=1.0
BackSpeedMult=1.0
