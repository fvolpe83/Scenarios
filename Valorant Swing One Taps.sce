...
DifficultyTag=3
AuthorsTag=Weebkiller (Biddles small updates)
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Horizontal flicking/tracking and clicktiming
GameVersion=2.0.1.2
...
DodgeProfileNames=Long Strafes (Val)
