...
WeaponHeroTag=
DifficultyTag=5
AuthorsTag=nick, ku, DeA
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Air with dramatically smaller enemies, lower TTK, and no UFO.
GameVersion=2.0.0.2
...
AimingProfileNames=Bad_Against_Fast_Strafes;High Skill;Default;Default;Default;Default;Default;Default
