Name=Valorant Close Flicks
PlayerCharacters=Character Profile
BotCharacters=Quaker Bot mid Fast Strafes.bot;Quaker Bot mid+ Fast Strafes.bot;Quaker Bot mid++ Fast Strafes.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Character Profile
AddedBots=Quaker Bot mid Fast Strafes.bot;Quaker Bot mid+ Fast Strafes.bot;Quaker Bot mid++ Fast Strafes.bot
PlayerMaxLives=0
BotMaxLives=0;0;0
PlayerTeam=1
BotTeams=2;2;2
...
GameTag=Apex Legengs, Fortnite, Overwatch
...
BlockFCT=false
Description=Close range flick practice
GameVersion=2.0.1.1
...
[Bot Profile]
Name=Quaker Bot mid Fast Strafes
DodgeProfileNames=mid Short Strafes
...
MaxTargetDistance=600.0
MinTargetDistance=550.0
