...
WeaponHeroTag=
DifficultyTag=5
AuthorsTag=nocrno, Kindred
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description="Air no UFO no SKYBOTS" with movement based scoring and some edited profiles. And very tiny bots... (and less hp)
GameVersion=1.0.8.0
