Name=kinTargetSwitch No Reload SLOW MORE HEALTH
...
DifficultyTag=3
AuthorsTag=kindred, patys, El Bad
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=No reload version. Based on patTargetSwitch. Hold down fire and kill the bots to refill your ammo.
GameVersion=2.0.1.0
