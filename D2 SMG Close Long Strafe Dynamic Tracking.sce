Name=D2 SMG Close Long Strafe Dynamic Tracking
PlayerCharacters=Quaker;Quaker enemy
...
BlockFCT=false
Description=This exercise focuses on tracking a close range target moving in one direction for an extended period. Being that this exercise is dynamic focused, your movement will be limited, and there will be strict focus on your horizontal aim. Apply model aiming and shoot the head for a more efficient kill. To get a more exact and visual explanation please checkout my Youtube Channel at https://www.youtube.com/channel/UCeWR  or search HazedNConfused.
GameVersion=2.0.2.0
...
Name=Quaker
MaxHealth=1300.0
WeaponProfileNames=Destiny 2 SMG;;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
