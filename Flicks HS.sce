...
GameTag=Short and Mid Range Reaction Flicks HS
WeaponHeroTag=Pistol
DifficultyTag=3
AuthorsTag=GayVeeg V.2
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Reaction based short and mid range flicks. Test your flicks in a 30 second challenge! But with headshots this time
GameVersion=2.0.1.2
...
BlockSpawnFOV=0.0
BlockSpawnDistance=0.0
RespawnAnimationDuration=0.00001
AllowBufferedJumps=true
BounceOffWalls=false
LeanAngle=0.0
LeanDisplacement=0.0
