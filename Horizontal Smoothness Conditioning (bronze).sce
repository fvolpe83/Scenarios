Name=Horizontal Smoothness Conditioning (bronze)
PlayerCharacters=A
BotCharacters=air1F_far_short.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=A
AddedBots=air1F_far_short.bot
PlayerMaxLives=0
BotMaxLives=1
PlayerTeam=1
BotTeams=2
...
DifficultyTag=5
AuthorsTag=hanzo#3483
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=70% acuracy for  HSC bronze 70% accuracy for HSC silver 70% accuracy for HSC gold 50% accruacy for HSC plat50% accuracy for HSC diamond40% accuracy for HSC master30% accuracy for HSC grand master30% accuracy for HSC ascended hanzo#3483 on discord if you have any questions/suggestions
GameVersion=2.0.1.0
