Name=Horizontal Strafe
PlayerCharacters=player_char
BotCharacters=horizontal_rot.rot
IsChallenge=true
Timelimit=60.0
PlayerProfile=player_char
AddedBots=horizontal_rot.rot;horizontal_rot.rot;horizontal_rot.rot;horizontal_rot.rot;horizontal_rot.rot
PlayerMaxLives=0
BotMaxLives=0;0;0;0;0
PlayerTeam=1
BotTeams=2;2;2;2;2
MapName=horizontal_strafe.map
MapScale=8.0
