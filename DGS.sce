...
GameTag=CS Counter Strike
WeaponHeroTag=tracking click timing
DifficultyTag=3
AuthorsTag=@@ Veloce
...
BlockFCT=false
Description=practice your headshots
GameVersion=1.0.8.0
...
Name=McCoy lg
MaxHealth=250.0
WeaponProfileNames=AK-47;Deag;Railgun;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=30.0
...
MaxHealth=100.0
WeaponProfileNames=AK-47;Railgun;;USP-S;;;;
