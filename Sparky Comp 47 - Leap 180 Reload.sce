Name=Sparky Comp 47 - Leap 180 Reload
...
GameTag=Overwatch, Fortnite, Diabotical
WeaponHeroTag=Pistol
DifficultyTag=4
AuthorsTag=Cryoxic, Huddled
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Bounce 180 Medium, but the bots leap further horizontally, it's faster, and the gravity is higher, and there's reload without accuracy based scoring.
GameVersion=2.0.1.0
