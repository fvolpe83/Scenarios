...
BlockFCT=true
Description=Flick to a big target that lasts on screen for only 250 ms. Make sure to change your map scale and Time scale to 1 and 1.6 respectively. Useful for improving reaction time. If you want a greater challenge, try to increase the time scale. Thank you :)
GameVersion=2.0.2.0
