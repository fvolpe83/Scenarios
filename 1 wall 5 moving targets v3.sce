Name=1 wall 5 moving targets v3
...
BlockFCT=false
Description=3 targets spawn on a wall. 3 targets this time
GameVersion=2.0.0.2
...
MaxHealth=100.0
WeaponProfileNames=pistol;AK-47;Deag;M4A1-S;M4A4;Rifle;Sniper Rifle;BB Gun
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
