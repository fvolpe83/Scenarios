...
Name=Quaker
MaxHealth=70.0
WeaponProfileNames=Aek-971;m16;;MG;;;;
...
MuzzleVelocityMin=X=15.000 Y=0.000 Z=0.000
MuzzleVelocityMax=X=580.000 Y=0.000 Z=0.000
...
HeadshotMultiplier=2.07
MagazineMax=31
AmmoPerShot=1
ReloadTimeFromEmpty=2.3
ReloadTimeFromPartial=3.6
DamageFalloffStartDistance=12.5
DamageFalloffStopDistance=60.0
DamageAtMaxRange=18.0
DelayBeforeShot=0.0
...
MinRecoilUp=0.0
MinRecoilHoriz=0.0
MaxRecoilHoriz=0.045
FirstShotRecoilMult=2.55
...
GravityScale=1.0
HeadshotCapable=true
HeadshotMultiplier=2.17
MagazineMax=31
AmmoPerShot=1
ReloadTimeFromEmpty=0.5
ReloadTimeFromPartial=0.5
DamageFalloffStartDistance=12.0
