Name=Jumbo Tile Frenzy Endurance
...
GameTag=Jumbo Tile Frenzy Endurance
WeaponHeroTag=Pistol
DifficultyTag=1
AuthorsTag=Sharqosity(Time Attack added by soleskidder1)[Added endurance by RELOG]
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=1 Tile = .35 second gain, easy endurance scenario
GameVersion=1.0.6.2
