Name=Sparky Comp 59 - Arc Dodge Semi
...
GameTag=Hyperscape, Overwatch
WeaponHeroTag=LG, Lightning Gun
DifficultyTag=3
AuthorsTag=Sparky Fallen, Daan
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Arc Dodge clicking on an invincible target with a sixshooter. 
GameVersion=2.0.2.0
