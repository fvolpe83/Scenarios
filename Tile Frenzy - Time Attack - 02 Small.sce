Name=Tile Frenzy - Time Attack - 02 Small
...
BlockFCT=true
Description=Flick between three cubes that respawn instantly upon death. Every kill recovers +0.167 seconds. Maintain 6 kills per second to stop the clock. Survive for as long as possible!
GameVersion=1.0.6.2
