...
BlockFCT=false
Description=Small regenerating dots circle around you, 0.5s ttk, up to 3.33s to regen to full, starts regening 0.1s after going off target. Like LR, this version also has less regen, but the bots are also bigger, slower, and less evasive.
GameVersion=2.0.2.0
