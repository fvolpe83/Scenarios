Name=1 Wall 6 Targets Micro Medium
...
DifficultyTag=3
AuthorsTag=based on Reflex Flick and 1 Wall 6 Targets
BlockHitMarkers=true
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=true
Description=1 Wall 6 Targets farther away, and in a smaller area, great for improving flicks with your Fingertips/Wrist
GameVersion=2.0.2.0
