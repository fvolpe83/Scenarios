...
BlockFCT=false
Description=The long awaited sequel to the critically acclaimed tile frenzy scenario has finally arrived!!!! (But with aimbot enabled  ;))
GameVersion=1.0.7.2
