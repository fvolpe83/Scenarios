...
GameTag=Apex, Quake
WeaponHeroTag=Pistol, wingman, manwing
DifficultyTag=4
AuthorsTag=Richard
...
BlockFCT=true
Description=AscendedStrafes with pistoles and headshots
GameVersion=1.0.8.0
...
[Bot Profile]
Name=Bot Profile
DodgeProfileNames=Long Strafes Jumping;ADAD;Very Short Strafes + Jump
