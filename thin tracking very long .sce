...
GameTag=tracking,Overwatch,Apex Legends
WeaponHeroTag=
DifficultyTag=2
AuthorsTag=felix
...
BlockFCT=false
Description=Track very thin targets that make very very long strafes.Good for precision 
GameVersion=1.0.7.2
...
DodgeProfileNames=Long Strafes_veryf
