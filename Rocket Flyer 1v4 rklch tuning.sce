Name=Rocket Flyer 1v4 rklch tuning
PlayerCharacters=Rocket Flyer
BotCharacters=Random Bot Watcher.rot;Shinji Bot.bot;McCoy Bot.bot;Rocket Flyer Bot.bot;Sergeant Bot.bot;Racer Bot.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Rocket Flyer
AddedBots=Random Bot Watcher.rot;Random Bot Watcher.rot;Random Bot Watcher.rot;Random Bot Watcher.rot
PlayerMaxLives=0
BotMaxLives=0;0;0;0
PlayerTeam=1
BotTeams=2;2;2;2
...
BlockFCT=false
Description=You as Racer + random teammate vs 2 random enemies on a control center.
GameVersion=1.0.8.0
...
ProfileNames=Racer Bot;McCoy Bot;Shinji Bot;Sergeant Bot;Rocket Flyer Bot
