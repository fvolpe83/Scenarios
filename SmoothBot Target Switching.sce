Name=SmoothBot Target Switching
PlayerCharacters=Quaker
BotCharacters=SmoothBot.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Quaker
AddedBots=SmoothBot.bot;SmoothBot.bot;SmoothBot.bot;SmoothBot.bot;SmoothBot.bot
PlayerMaxLives=0
...
DifficultyTag=4
AuthorsTag=Xytaglyph, hhoyt
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Arm aiming and 360 degree tracking through the air + target switching
GameVersion=2.0.0.2
