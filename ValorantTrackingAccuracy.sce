Name=ValorantTrackingAccuracy
PlayerCharacters=Counter-Striker
BotCharacters=Counter-Striker Bot Harmless.bot;Counter-Striker Bot PEEKER Harmless.bot
IsChallenge=true
Timelimit=90.0
PlayerProfile=Counter-Striker
AddedBots=Counter-Striker Bot PEEKER Harmless.bot;Counter-Striker Bot PEEKER Harmless.bot
PlayerMaxLives=0
BotMaxLives=0;0
PlayerTeam=1
BotTeams=0;0
...
GameTag=Tracking and Accuracy
WeaponHeroTag=AK47, M4A1-S
DifficultyTag=2
AuthorsTag=KovaaK, Urbly
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=true
Description=2 targets dodge and crouch at a variety of ranges and angles.  Your weapon reloads 5 ammo on kill.
GameVersion=2.0.1.2
...
[Bot Profile]
Name=Counter-Striker Bot PEEKER Harmless
