...
BlockFCT=false
Description=VT = Verticality Training. PGTI + Teleports + some other modifications. Movement scoring mechanics enabled. 
GameVersion=2.0.1.2
