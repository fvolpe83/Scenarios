Name=Apex Tracking SMG
PlayerCharacters=Ascended Tracking
BotCharacters=apexparalympicsv3.bot;apexparalympicsv3.bot;apexparalympicsv3.bot
IsChallenge=true
Timelimit=90.0
PlayerProfile=Ascended Tracking
AddedBots=apexparalympicsv3.bot;apexparalympicsv3.bot;apexparalympicsv3.bot
PlayerMaxLives=0
BotMaxLives=0;0;0
PlayerTeam=1
BotTeams=0;0;0
...
BlockFCT=true
Description=Apex Tracking with smg
GameVersion=1.0.7.2
