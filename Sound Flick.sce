...
GameTag=Reflex, Quake, Rainbow Six, Call Of Duty
WeaponHeroTag=Pistol
DifficultyTag=4
AuthorsTag=KovaaK, Huddled, Copper Brain
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Requires sound on. Flick to targets that spawn in 12 o clock, 9 o clock, 6 o clock or 3 o clock
GameVersion=2.0.1.2
