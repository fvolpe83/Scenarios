Name=Overwatch tracking practice
...
GameTag=Overwatch, tracking practice
...
BlockFCT=false
Description=Target and player move the same way like players in Ow
GameVersion=2.0.0.2
...
DodgeProfileWeights=2.0;4.0;3.0
