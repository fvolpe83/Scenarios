Name=Yeet Tracking Invincible Thin
PlayerCharacters=A
BotCharacters=Circle Quaker.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=A
AddedBots=Circle Quaker.bot
PlayerMaxLives=0
BotMaxLives=5
PlayerTeam=1
BotTeams=2
...
WeaponHeroTag=LG
DifficultyTag=3
AuthorsTag=(original creator), freddie mercury's ball sweat
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=no idea if another similar scenario exists but I edited the original scenario because I liked the bot's movement
GameVersion=2.0.2.0
