...
BotCharacters=Pigeon2.bot;Quaker Bot Close.bot;BF Bot.bot;McCoy Bot.bot;Circle Quaker.bot;Counter-Striker Bot Harmless.bot;Counter-Striker Bot PEEKER.bot
IsChallenge=true
Timelimit=180.0
PlayerProfile=McCoy
AddedBots=Pigeon2.bot;Quaker Bot Close.bot;BF Bot.bot;McCoy Bot.bot;Circle Quaker.bot;Counter-Striker Bot Harmless.bot;Counter-Striker Bot PEEKER.bot
PlayerMaxLives=0
...
WeaponSwitchTime=3.0
UseWeapons=true
CharacterProfile=Frozen LG only
SeeThroughWalls=false
...
TeamHeadColor=X=1.000 Y=0.212 Z=0.020
BlockSelfDamage=false
InvinciblePlayer=false
InvincibleBots=false
BlockTeamDamage=false
