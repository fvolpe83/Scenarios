Name=RexStrafesCata 90%
PlayerCharacters=Quaker
BotCharacters=Quaker Bot Easy no wep.bot;Quaker Bot Medium no wep.bot;Quaker Bot Hard no wep.bot
IsChallenge=true
Timelimit=54.0
PlayerProfile=Quaker
AddedBots=Quaker Bot Hard no wep.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=2
BotTeams=1
...
GameTag=RexStrafesCata,Cata,Rex,Strafes,90%,RexStrafesCata 90%
WeaponHeroTag=LG, Lightning Gun
DifficultyTag=3
AuthorsTag=Rex, Cody, patys, Misty Shadows
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=RexStrafesCata at 90%. Bot doesn't shoot and is invincible. Changed to 90% by Misty.
GameVersion=2.0.2.0
