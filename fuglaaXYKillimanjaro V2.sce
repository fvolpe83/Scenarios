...
WeaponHeroTag=Track
DifficultyTag=5
AuthorsTag=fuglaa, Boky
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Track a tiny fast bot which teleports. Updated with better weapon and removed accuracy scoring.
GameVersion=2.0.1.2
