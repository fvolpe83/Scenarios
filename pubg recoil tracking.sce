...
GameTag=RoE, PubG, Battle Royale
WeaponHeroTag=Rifle
DifficultyTag=3
...
BlockFCT=false
Description=patTargetSwitch with a recoil variable meant to replicate that of guns from PubG and RoE.
GameVersion=1.0.8.0
...
MuzzleVelocityMin=X=88000.000 Y=0.000 Z=0.000
MuzzleVelocityMax=X=88000.000 Y=0.000 Z=0.000
