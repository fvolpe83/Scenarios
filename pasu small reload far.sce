...
GameTag=click timing,flick,ddtv,overwatch,fortnite,fn,ow,apex,cs,r6
...
BlockFCT=false
Description=You MUST use ADS (forced 103 OW FoV). This is to prevent cheese.
GameVersion=1.0.8.0
