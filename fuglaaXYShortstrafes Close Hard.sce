Name=fuglaaXYShortstrafes Close Hard
...
WeaponHeroTag=LG
DifficultyTag=4
AuthorsTag=fuglaa, Facts Machine
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=A mix of fuglaaXYStrafes Small and fuglaaXYShortstrafes Close, this one's much more difficult.
GameVersion=2.0.2.0
