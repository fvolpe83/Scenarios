...
GameTag=Rainbow Six Siege, Modern Warfare, Call of Duty
WeaponHeroTag=Alcove tracking weapon
DifficultyTag=2
AuthorsTag=Dr. Kroader, EvilDao
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Target Switching 360 Static but you must be moving. Couple people say target switching + dodge has no application in real games but I disagree. It is applicable in clutch situations.
GameVersion=2.0.1.0
ScorePerDistance=0.15
MBSEnable=false
MBSTime1=0.25
MBSTime2=0.5
MBSTime3=0.75
