Name=LGC3 Diabotical Hard
PlayerCharacters=Quaker Player
BotCharacters=Quaker Bot.bot
IsChallenge=true
Timelimit=120.0
PlayerProfile=Quaker Player
...
DifficultyTag=4
AuthorsTag=ins, Whisper
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=diabotical lg duels waiting room
GameVersion=2.0.1.2
...
CameraOffset=X=0.000 Y=0.000 Z=110.000
HeadshotOnly=false
