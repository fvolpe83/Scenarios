...
BlockFCT=true
Description=Wide angle close clicking practise, psalmflick strafing even smaller slower reload
GameVersion=2.0.2.0
...
IsFlyer=true
FlightObeysPitch=false
FlightVelocityUp=500.0
FlightVelocityDown=500.0
...
IncReloadLoopTime=0.5
IncReloadAmmoPerLoop=3
IncReloadEndTime=0.3
