Name=Tile Frenzy Target Switch Master
PlayerCharacters=TileFrenzy Challenger;TileFrenzy Weapon Overrides;TileFrenzy Zooms 10sec
BotCharacters=TileFrenzyStrafing Cube.bot;TileFrenzyStrafing Sphere.bot;Quaker Bot.bot
IsChallenge=true
Timelimit=30.0
...
MaxHealth=1.0
WeaponProfileNames=TileFrenzy Challenge;LG;;;;;;
