...
WeaponHeroTag=McCree
DifficultyTag=3
AuthorsTag=KovaaK, KROADER, Felicity
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=You as McCoy vs a single bot in a fixed rotation, separated by an invisible wall. Updated with firerate buff, and has reloading required to simulate ingame.
GameVersion=1.0.7.2
...
JetpackMaxZVelocity=600.0
JetpackAirControlWithThrust=0.25
AbilityProfileNames=Phase.abilmov;;;Melee.abilmelee
HideWeapon=false
AerialFriction=0.0
StrafeSpeedMult=1.0
BackSpeedMult=0.9
