Name=fuglaaxylongstrafes_far_10min
PlayerCharacters=A_air_pistol_frozen_50dmg
BotCharacters=air1F_far_long.bot;air1F_far_short.bot
IsChallenge=true
Timelimit=300.0
PlayerProfile=A_air_pistol_frozen_50dmg
...
BlockFCT=false
Description=Track the long strafing target vertically and horizontally. Too easy?? Try the hardmode on the workshop 
GameVersion=2.0.1.2
...
[Character Profile]
Name=A_air_pistol_frozen_50dmg
MaxHealth=100.0
WeaponProfileNames=LG 50dmg;;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
