Name=Tile Frenzy Endurance 6 targets
...
AddedBots=TileFrenzy Cube.bot;TileFrenzy Cube.bot;TileFrenzy Cube.bot;TileFrenzy Cube.bot;TileFrenzy Cube.bot;TileFrenzy Cube.bot
PlayerMaxLives=0
...
BlockFCT=true
Description=Keep shooting 6 targets as long as possible. Every kill add 0.15 seconds to time limit. 
GameVersion=1.0.7.2
