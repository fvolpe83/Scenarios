Name=1w5t pasu track invincible 100 shots
...
DifficultyTag=3
AuthorsTag=Fuglaa, Trevor
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=1w5t_pasu with one invincible bot. Edited so gun shoots 100 times per second. Same scoring standard as regular version.
GameVersion=2.0.1.2
