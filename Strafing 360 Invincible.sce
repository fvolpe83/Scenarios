...
PlayerTeam=1
BotTeams=2
MapName=boxernobounds1spawn.map
MapScale=3.0
...
BlockFCT=false
Description=Scenario designed to improve tracking while strafing. Base score is increased by distance traveled.
GameVersion=1.0.7.2
