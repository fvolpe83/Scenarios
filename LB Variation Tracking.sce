Name=LB Variation Tracking
PlayerCharacters=Character Profile
BotCharacters=Pigeon.bot;Pigeon.bot;Pigeon Jumper.bot
IsChallenge=true
Timelimit=51.0
PlayerProfile=Character Profile
AddedBots=Pigeon.bot;Pigeon.bot;Pigeon Jumper.bot;Pigeon Jumper.bot
PlayerMaxLives=0
BotMaxLives=0;0;0;0
PlayerTeam=1
BotTeams=2;2;0;0
...
WeaponSwitchTime=3.0
UseWeapons=true
CharacterProfile=Clay Pigeon big
