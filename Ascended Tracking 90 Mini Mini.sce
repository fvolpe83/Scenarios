Name=Ascended Tracking 90 Mini Mini
PlayerCharacters=Ascended Tracking
BotCharacters=Long Strafe Bot.bot
IsChallenge=true
Timelimit=90.0
PlayerProfile=Ascended Tracking
AddedBots=Long Strafe Bot.bot;Long Strafe Bot.bot;Long Strafe Bot.bot;Long Strafe Bot.bot;Long Strafe Bot.bot;Long Strafe Bot.bot;Long Strafe Bot.bot;Long Strafe Bot.bot;Long Strafe Bot.bot;Long Strafe Bot.bot
PlayerMaxLives=0
...
BlockFCT=true
Description=Track 10 targets at a variety of ranges and angles.  The weapon you use is hitscan and does more damage if you are centered on your target.
GameVersion=1.0.7.1
