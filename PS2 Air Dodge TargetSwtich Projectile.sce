Name=PS2 Air Dodge TargetSwtich Projectile
PlayerCharacters=A
...
GameTag=Track, Air, Tracking, Target Switching, Projectile, Death
...
BlockFCT=true
Description=This is the start of the Anti-Boosher Alliance
GameVersion=2.0.1.2
