...
GameTag=Tracking, Quake, Destiny, Apex, Fortnite, CSGO
WeaponHeroTag=LG, Lightning Gun, SMG, AR
DifficultyTag=3
AuthorsTag=Prysm
...
BlockFCT=false
Description=Shoot crouch-spamming and jumping bots with increased damage to the head.
GameVersion=1.0.8.0
...
CameraOffset=X=0.000 Y=0.000 Z=85.000
HeadshotOnly=false
