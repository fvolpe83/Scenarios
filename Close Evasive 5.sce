...
BlockFCT=false
Description=A nimble bot with various close range strafing profiles, ~Master/SAB <u1ckl9z1w1>
GameVersion=2.0.2.0
...
[Bot Profile]
Name=Quaker Evasive
DodgeProfileNames=TD300-700 LR0,15-0,25 PFT0,3-0,75;TD300-700 LR0,3-0,4 PFT0,6-1,2;TD300-700 LR0,45-0,55 PFT0,9-1,65
...
JetpackMaxZVelocity=400.0
JetpackAirControlWithThrust=0.25
AbilityProfileNames=1mc 2ct 4e-1ad 18e2mv.abilmov;1mc 3ct 3e-1ad 8e2mv.abilmov;1mc 4ct 1e-1ad 6e3mv.abilmov;
HideWeapon=true
AerialFriction=0.0
StrafeSpeedMult=1.0
BackSpeedMult=1.0
...
[Dodge Profile]
Name=TD300-700 LR0,15-0,25 PFT0,3-0,75
...
[Dodge Profile]
Name=TD300-700 LR0,3-0,4 PFT0,6-1,2
MaxTargetDistance=700.0
MinTargetDistance=300.0
ToggleLeftRight=true
ToggleForwardBack=false
...
[Dodge Profile]
Name=TD300-700 LR0,45-0,55 PFT0,9-1,65
MaxTargetDistance=700.0
MinTargetDistance=300.0
ToggleLeftRight=true
ToggleForwardBack=false
...
TargetStrafeMinDelay=0.125
TargetStrafeMaxDelay=0.25
MinProfileChangeTime=0.9
MaxProfileChangeTime=1.65
MinCrouchTime=0.3
MaxCrouchTime=0.6
MinJumpTime=0.3
MaxJumpTime=0.6
