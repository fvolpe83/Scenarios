Name=Close FS Shotgun Easy Dodge
PlayerCharacters=Quaker Shotgun
BotCharacters=Quaker Bot Fast Strafes.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Quaker Shotgun
...
BlockFCT=false
Description=Close quarter combat practice against a fast strafing bot. Keep moving for increased score. Shotgun weapon.
GameVersion=2.0.1.2
