...
PlayerCharacters=Sniper
BotCharacters=Sniping Target.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Sniper
AddedBots=Sniping Target.bot;Sniping Target.bot;Sniping Target.bot
PlayerMaxLives=0
BotMaxLives=0;0;0
PlayerTeam=1
BotTeams=2;2;2
...
WeaponHeroTag=Sniper, Sniper Rifle
DifficultyTag=3
AuthorsTag=Zorua
...
BlockFCT=false
Description=Sniper Shoots People
GameVersion=1.0.5
...
[Bot Profile]
Name=Sniping Target
DodgeProfileNames=Long Strafes;Long Strafes;Mimic
...
UseWeapons=false
CharacterProfile=BOT Pathetic
SeeThroughWalls=false

[Character Profile]
Name=Sniper
MaxHealth=125.0
WeaponProfileNames=Sniper Rifle (TF2);;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
