...
DifficultyTag=4
AuthorsTag=patys, Ghokury
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Remake of the original LGC3 mod from Quakeworld. LG duel in an open space. Boost your score by moving around, shorter strafes are incentivized by the scoring system. Bots are 30% smaller.
GameVersion=1.0.8.0
