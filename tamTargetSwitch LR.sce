...
GameTag=TamTS LR, tamTargetSwitch Less Regen
...
BlockFCT=false
Description=Small regenerating dots circle around you, 0.5s ttk, up to 2.5s to regen to full, starts regening 0.02s after going off target. LR = Less Regen
GameVersion=2.0.2.0
