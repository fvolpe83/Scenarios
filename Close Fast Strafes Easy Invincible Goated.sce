Name=Close Fast Strafes Easy Invincible Goated
...
DifficultyTag=2
AuthorsTag=KovaaK, patys, Huddled, Boky
...
BlockedMovementReactionMin=0.7
BlockedMovementReactionMax=1.0
WaypointLogic=Ignore
WaypointTurnRate=210.0
...
StrafeSwapMaxPause=0.0
BlockedMovementPercent=0.7
BlockedMovementReactionMin=0.17
