Name=Tile Frenzy Extra Small with ADS added NEW
...
GameTag=Jumbo Tile Frenzy Extra Small
WeaponHeroTag=Pistol / ADS
DifficultyTag=4
AuthorsTag=Friend, e2008enzo
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Same as normal, but with ADS Speed added
GameVersion=1.0.6.3
...
MaxHealth=100.0
WeaponProfileNames=pistol;Alcove_Tracking_Weapon;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
