...
BlockFCT=false
Description=Insane flick aim training which requires high accuracy and speed. Adapted from the infamous csgo training_aim_csgo2 classic aim training. Both duration and delay set below 0.250ms. TIPS- Focus on the middle of the screen and try to flick to targets using your peripheral vision.Train Hard!!!
GameVersion=2.0.0.2
