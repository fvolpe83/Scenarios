Name=Peacekeeper Close Fast Strafes
PlayerCharacters=Apex purple armor Peacekeeper
BotCharacters=Apex_bot_close.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Apex purple armor Peacekeeper
AddedBots=Apex_bot_close.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=2
...
BlockFCT=false
Description=Peacekeeper against a hard to hit target.
GameVersion=2.0.1.2
...
[Bot Profile]
Name=Apex_bot_close
DodgeProfileNames=Short Strafes Apex;Close Very Short Strafes;Circle Strafe
