Name=Narrow Strafe Flick Near
PlayerCharacters=player_char
BotCharacters=narrow_flick_bot.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=player_char
AddedBots=narrow_flick_bot.bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=2
MapName=narrow_strafe_flick.map
MapScale=10.0
...
[Bot Profile]
Name=narrow_flick_bot
DodgeProfileNames=narrow_flick_dodge
...
UseWeapons=false
CharacterProfile=narrow_flick_char
