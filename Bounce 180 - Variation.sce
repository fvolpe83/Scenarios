Name=Bounce 180 - Variation
PlayerCharacters=Character Profile1
BotCharacters=PigeonV.bot;PigeonV.bot;PigeonV1.bot;PigeonV1.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Character Profile1
AddedBots=PigeonV.bot;PigeonV.bot;PigeonV1.bot;PigeonV1.bot
PlayerMaxLives=0
BotMaxLives=0;0;0;0
PlayerTeam=1
BotTeams=0;0;0;0
...
GameTag=Overwatch, Fortnite, Tracking, Target Variation, Shotgun Flick, 180 Tracking
WeaponHeroTag=Pistol
DifficultyTag=3
AuthorsTag=DINKLEBERG
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Inconsistent moving bots to help player's tracking skills who struggle with close combat.  Enjoy
GameVersion=1.0.8.0
...
[Bot Profile]
Name=PigeonV
DodgeProfileNames=Long Strafes Jumping;Long Strafes
