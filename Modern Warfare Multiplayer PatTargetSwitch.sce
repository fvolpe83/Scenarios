Name=Modern Warfare Multiplayer PatTargetSwitch
PlayerCharacters=Quaker;SprintingQuaker
BotCharacters=Quaker Bot Long Strafes.bot;Sprinting Quaker Bot Long Strafes.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Quaker
AddedBots=Quaker Bot Long Strafes.bot;Quaker Bot Long Strafes.bot;Sprinting Quaker Bot Long Strafes.bot
PlayerMaxLives=0
BotMaxLives=0;0;0
PlayerTeam=1
BotTeams=2;2;2
...
GameTag=Call of Duty, Modern Warfare, Warzone Battlefield, Overwatch, flick, Rainbow 6 Siege
WeaponHeroTag=M4A1
DifficultyTag=4
AuthorsTag=Gochu Chomp
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=true
Description=Realistic recoil, health, ADS fov and Bot movement for Modern Warfare Multiplayer
GameVersion=2.0.1.0
...
[Bot Profile]
Name=Sprinting Quaker Bot Long Strafes
...
WeaponSwitchTime=3.0
UseWeapons=false
CharacterProfile=SprintingQuaker
SeeThroughWalls=false
NoDodging=false
NoAiming=false
AbilityUseTimer=0.1
