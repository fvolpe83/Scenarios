...
AddedBots=IAFortnite.bot;IAFortnite.bot;IAFortnite.bot;IAFortnite.bot
PlayerMaxLives=0
BotMaxLives=0;0;0;0
PlayerTeam=1
BotTeams=2;2;2;2
...
GameTag=Fortnite Tap Shooting
WeaponHeroTag=Pistol, Shotgun
DifficultyTag=3
AuthorsTag=Skyllers, KovaaK, Sonic
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=false
BlockFCT=false
Description=Tap Shooting, Shotgun accuracy, Fortnite moving target 
GameVersion=1.0.7.2
...
MaxHealth=100.0
WeaponProfileNames=pistol;LG;Shotgun;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
