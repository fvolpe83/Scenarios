...
DifficultyTag=3
AuthorsTag=DiabeticJr
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Edited "RexStrafeCata" and tried my best to match the ADS and movement as closely as I could to Apex Legends. Hopefully this will help. (:
GameVersion=2.0.1.0
...
CrouchAnimationSpeed=0.85
CameraOffset=X=0.000 Y=0.000 Z=65.000
HeadshotOnly=false
DamageKnockbackFactor=4.0
MovementType=Base
MaxSpeed=825.0
MaxCrouchSpeed=825.0
Acceleration=9000.0
