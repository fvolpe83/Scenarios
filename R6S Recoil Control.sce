...
BlockFCT=false
Description=Tile Frenzy but you are super far away so you move your mouse very little
GameVersion=2.0.2.0
...
MaxHealth=100.0
WeaponProfileNames=G8A1 (IQ);R4-C (ASH);F2 (TWITCH);SMG-11;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
