Name=MienTommy's Widowmaker Duel 360 Frenzy lvl 2
PlayerCharacters=Windowmaker
BotCharacters=Windowbot.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Windowmaker
AddedBots=Windowbot.bot;Windowbot.bot;Windowbot.bot;Windowbot.bot;Windowbot.bot;Windowbot.bot
PlayerMaxLives=0
...
Name=Windowmaker
MaxHealth=200.0
WeaponProfileNames=Spider Rifle;Spider Rifle Laser;Spider Rifle One Hit;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=30.0
