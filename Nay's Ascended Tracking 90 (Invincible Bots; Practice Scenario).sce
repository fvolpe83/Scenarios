Name=Nay's Ascended Tracking 90 (Invincible Bots; Practice Scenario)
...
WeaponHeroTag=
DifficultyTag=2
AuthorsTag=KovaaK, twitch.tv/nay2d2
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=true
Description=Track 3 targets at a variety of ranges and angles.  The weapon you use is hitscan and does more damage if you are centered on your target. smaller targets and invinsible, made for my own practice but I felt like I might as well upload it. THE REASON FOR THIS MODE IS SO YOU CAN PRACTICE DIFFERENT LENGTHS, EACH RESET THE CHARACTER WILL MOVE LOCATIONS, RIGHT? CHOOSE THE SPOT YOU WANT TO PRACTICE! Enjoy. Tracking game mode. 
GameVersion=1.0.8.0
