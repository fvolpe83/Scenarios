Name=Chugg - Flick (Extreme)
PlayerCharacters=A_air_pistol_frozen slower;TwelveFive
BotCharacters=DecayBot(12).bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=A_air_pistol_frozen slower
AddedBots=DecayBot(12).bot
PlayerMaxLives=0
BotMaxLives=0
PlayerTeam=1
BotTeams=0
...
BlockFCT=false
Description=Tough but possible - I recommend Freeplay Timescale practice to build the skills to compete in Challenge Mode
GameVersion=1.0.8.0
