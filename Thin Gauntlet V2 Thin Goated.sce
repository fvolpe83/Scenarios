Name=Thin Gauntlet V2 Thin Goated
PlayerCharacters=A
...
BlockFCT=false
Description=Track even thinner targets that make long strafes, progressively getting harder. Challenge mode takes up to 2-3 minutes.
GameVersion=2.0.1.2
