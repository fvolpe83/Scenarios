...
WeaponHeroTag=Hanzo, Bow and Arrow, Projectile, Hansel
DifficultyTag=1
AuthorsTag=Taunty, Huddled
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=As Hansel, try to take down five different watcher bots as quickly as you can within the time limit.
GameVersion=1.0.6.3
