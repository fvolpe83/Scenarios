Name=Ground Plaza FS NO UFOs Thin
PlayerCharacters=A
...
BlockFCT=false
Description=Only the 4 fast strafes bots from Ground Plaza but thinner. This has no UFOS, fixed spawns and no 99 prefix in the scoring.
GameVersion=1.0.8.0
