Name=Thin Various Strafes Invincible
PlayerCharacters=A
...
WeaponHeroTag=
DifficultyTag=4
AuthorsTag=Ku, Secondo
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Track a thin target that make long strafes, short strafes and randomly stops for a brief moment to throw your aim off when you try to predict the bots movement
GameVersion=1.0.7.2
...
DodgeProfileNames=Long Strafes_very;Close Very Short Strafes;Stop
DodgeProfileWeights=1.1;1.2;1.0
