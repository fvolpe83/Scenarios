...
GameTag=Tracking, Goated, v2, v3, Neoninja, Target Switch, Flick, AIMER7, Frenzy
WeaponHeroTag=ALCOVE TRACKING WEAPON 4 LIFE
DifficultyTag=1
AuthorsTag=KovaaK
...
BlockFCT=true
Description=The weapon you use is hitscan and does more damage if you are centered on your target. No acc% multiplier so just go ham fam
GameVersion=1.0.8.0
...
MaxHealth=500.0
WeaponProfileNames=;Free Kroader;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
