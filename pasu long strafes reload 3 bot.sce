Name=pasu long strafes reload 3 bot
...
BlockFCT=false
Description=Pasu Reload but with 3 bots that always long strafe. Intended for training medium-wide angles and precise reading.
GameVersion=2.0.1.0
