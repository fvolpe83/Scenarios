Name=Thompson Flood PRO
PlayerCharacters=Gamer
BotCharacters=GamerBot.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Gamer
...
GameTag=enemy territory
WeaponHeroTag=fun, fun
DifficultyTag=3
AuthorsTag=apa3, stral had no hand in the creation of this scenario
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=improved by apa3
GameVersion=1.0.5
...
Name=Gamer
MaxHealth=300.0
WeaponProfileNames=Thompson;ThompsonWeak;;;;;;
MinRespawnDelay=0.6
MaxRespawnDelay=1.1
StepUpHeight=70.0
