...
BotCharacters=target.bot;250ms.bot;300ms.bot;350ms.bot
IsChallenge=true
Timelimit=30.0
...
BlockFCT=true
Description=targets spawn on a wall.  Great practice for flicking to many targets quickly.  Challenge mode has accuracy-based scoring.
GameVersion=2.0.2.0
