Name=Ascended Tracking 90 thin v2
PlayerCharacters=Ascended Tracking
BotCharacters=Long Strafe Bot.bot;Long Strafe Bot.bot
IsChallenge=true
Timelimit=60.0
...
BlockFCT=false
Description=If you have any questions please don't hesitate to add my discord rem1x#9958
GameVersion=1.0.7
