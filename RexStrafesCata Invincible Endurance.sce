Name=RexStrafesCata Invincible Endurance
...
GameTag=Reflex, Quake,Endurance
WeaponHeroTag=LG, Lightning Gun
DifficultyTag=3
AuthorsTag=Rex, Cody, patys, edited by tyme
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=RexStrafesCata Invincible but it's 5 minutes have fun i hope your arm hurts 
GameVersion=1.0.7.2
