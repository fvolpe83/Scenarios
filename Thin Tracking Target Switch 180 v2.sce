Name=Thin Tracking Target Switch 180 v2
PlayerCharacters=Ascended Tracking;Tracking Target Switch Master
BotCharacters=Thin very long strafe.bot;Long Strafe Bot.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Tracking Target Switch Master
AddedBots=Thin very long strafe.bot;Thin very long strafe.bot;Thin very long strafe.bot;Thin very long strafe.bot
PlayerMaxLives=0
BotMaxLives=0;0;0;0
PlayerTeam=1
BotTeams=2;2;2;0
...
GameTag=Tracking, csgo, r6, valorant, val, thin, switch, targetswitch, hard
WeaponHeroTag=hitscan
DifficultyTag=3
AuthorsTag=KaBOOM
...
BlockFCT=true
Description=Track 4 thin targets that die quickly and switch between them.
GameVersion=2.0.1.2
...
MaxHealth=500.0
WeaponProfileNames=;2xdmg ADSable Hitscan Cone;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
...
[Character Profile]
Name=Tracking Target Switch Master
MaxHealth=500.0
...
[Weapon Profile]
Name=2xdmg ADSable Hitscan Cone
Type=Hitscan
ShotsPerClick=10
DamagePerShot=2.0
KnockbackFactor=0.0
