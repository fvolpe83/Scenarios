Name=4targets1wall small low fov 
...
GameTag=CSGO, Counter-Strike
WeaponHeroTag=Pistol
DifficultyTag=2
AuthorsTag=Sharqosity, ADAX
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=CSGO oriented low fov fast aiming (Used tile frenzy mini as base.)
GameVersion=1.0.8.0
