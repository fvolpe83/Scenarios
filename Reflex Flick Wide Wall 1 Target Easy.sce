Name=Reflex Flick Wide Wall 1 Target Easy
...
GameTag=reflex flick wide wall 1 target easy
WeaponHeroTag=
DifficultyTag=3
AuthorsTag=actuallyPham
BlockHitMarkers=true
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=true
Description=Flick to a short-lived target before it despawns. A test of reflex and flick accuracy. Single 200 size target with 500 ms lifetime. Wider wall to emphasize horizontal precision.
GameVersion=2.0.1.2
