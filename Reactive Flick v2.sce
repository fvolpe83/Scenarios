...
DifficultyTag=3
AuthorsTag=Riptide, pleasewait
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=false
BlockFCT=true
Description=MCA reactive flick created by pleasewait only targets are half the size for precision training
GameVersion=2.0.2.0
