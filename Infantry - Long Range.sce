Name=Infantry - Long Range
PlayerCharacters=FortniteInfantry
BotCharacters=FN Strafe.bot
IsChallenge=true
Timelimit=90.0
PlayerProfile=FortniteInfantry
AddedBots=FN Strafe.bot;FN Strafe.bot;FN Strafe.bot;FN Strafe.bot;FN Strafe.bot;FN Strafe.bot
PlayerMaxLives=0
...
GameTag=Call of Duty, Battlefield, Overwatch, Fortnite, Infantry Rifle, AR, Apex Legends, Wingman
WeaponHeroTag=Rifle
DifficultyTag=4
AuthorsTag=patys (edit by Yagnesh)
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=patTargetSwitch edit made for NLInsane, mainly used to improve aim with Fortnite's Infantry Rifle and Apex's Wingman. Go for Headshots!
GameVersion=1.0.8.0
...
[Character Profile]
Name=FortniteInfantry
MaxHealth=100.0
WeaponProfileNames=Infantry Rifle;;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=16.0
