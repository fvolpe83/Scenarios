Name=Midrange Long Strafes Invincible Semi Auto
PlayerCharacters=Krueger
BotCharacters=Long Strafe Bot.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Krueger
...
GameTag=Quake, Reflex, Modern Warfare
WeaponHeroTag=Semi Auto
DifficultyTag=4
AuthorsTag=Scattered
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Made this to help my aim with Semi Auto weapons in Modern Warfare.
GameVersion=1.0.8.0
