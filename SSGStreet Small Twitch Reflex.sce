Name=SSGStreet Small Twitch Reflex
...
DifficultyTag=3
AuthorsTag=Sharqosity, KROADER
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Tile Frenzy but you are super far away so you move your mouse very little - Now even smaller :nokroader:
GameVersion=1.0.7.2
