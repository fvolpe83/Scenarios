Name=OW Long Strafes Pistol edition
...
WeaponHeroTag=Tracking, LG, Pistol
DifficultyTag=5
AuthorsTag=xeLe, Kuro
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Practice tracking (+ pistol now ) on a target that spams ADAD, crouch and jump. Just updated the map, I add a pistol with less rng strafes.
GameVersion=2.0.1.2
...
MainBBRadius=25.0
MainBBHasHead=true
MainBBHeadRadius=14.5
MainBBHeadOffset=-14.5
MainBBHide=false
ProjBBType=Cylindrical
ProjBBHeight=128.888885
ProjBBRadius=20.0
ProjBBHasHead=true
ProjBBHeadRadius=14.5
ProjBBHeadOffset=-14.5
ProjBBHide=true
HasJetpack=false
JetpackActivationDelay=0.5
JetpackFullFuelTime=1000.0
...
MinJumpTime=0.3
MaxJumpTime=0.6
LeftStrafeTimeMult=0.85
RightStrafeTimeMult=0.85
StrafeSwapMinPause=0.0
StrafeSwapMaxPause=0.0
BlockedMovementPercent=0.5
BlockedMovementReactionMin=0.125
