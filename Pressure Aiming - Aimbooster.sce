Name=Pressure Aiming - Aimbooster
PlayerCharacters=Balloon Shooter
BotCharacters=Balloon.bot
IsChallenge=true
Timelimit=10.0
PlayerProfile=Balloon Shooter
AddedBots=Balloon.bot;Balloon.bot;Balloon.bot;Balloon.bot;Balloon.bot
PlayerMaxLives=0
...
GameTag="Flick" and "Pressure" and "Aimbooster"
WeaponHeroTag=
DifficultyTag=3
AuthorsTag=Envert
...
MaxHealth=2.0
WeaponProfileNames=Pressure BB Gun;;;;;;;
MinRespawnDelay=0.3
MaxRespawnDelay=0.5
StepUpHeight=0.0
