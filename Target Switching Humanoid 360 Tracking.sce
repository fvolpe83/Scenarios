Name=Target Switching Humanoid 360 Tracking
...
GameTag=Battlefield, Call Of Duty, Tracking, Relaa, Neoninja, Swap aim, Apex Legends
...
BlockFCT=false
Description=Scenario to train target switching and tracking to any fps game
GameVersion=2.0.1.2
