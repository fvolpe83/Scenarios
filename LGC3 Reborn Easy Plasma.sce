...
BlockFCT=false
Description=Remake of the original LGC3 mod from Quakeworld. LG duel in an open space. Boost your score by moving around, shorter strafes are incentivized by the scoring system.
GameVersion=1.0.8.0
...
WeaponProfileWeights=1.0;0.25;2.0;0.5;1.0;1.0;1.0;1.0
...
MuzzleVelocityMin=X=8125.000 Y=0.000 Z=0.000
MuzzleVelocityMax=X=8125.000 Y=0.000 Z=0.000
