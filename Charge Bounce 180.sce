Name=Charge Bounce 180
PlayerCharacters=A_air_charge_frozen
BotCharacters=Pigeon.bot;Pigeon.bot;Pigeon.bot;Pigeon.bot;Pigeon.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=A_air_charge_frozen
...
UseWeapons=false
CharacterProfile=Charge Clay Pigeon
