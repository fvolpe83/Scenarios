Name=CATA IC Long Strafes Recoil
...
GameTag=Pubg
WeaponHeroTag=AKM,LG, Lightning Gun
DifficultyTag=2
AuthorsTag=Vavoryd
...
BlockFCT=false
Description=Low pressure Projectile tracking with recoil against an easy to hit target.
GameVersion=1.0.8.0
...
Name=Quaker
MaxHealth=300.0
WeaponProfileNames=AKM;M4R;R99;AKM-Vert;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
