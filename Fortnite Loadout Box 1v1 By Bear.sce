Name=Fortnite Loadout Box 1v1 By Bear
...
DifficultyTag=3
AuthorsTag=Player1, edited by Bear
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Box 1v1 for Fortnite, try to be accurate and win every close range trading
GameVersion=2.0.2.0
...
TPSArmLength=350.0
TPSOffset=X=0.000 Y=90.000 Z=-110.000
