Name=1wall 6targets microscopic
PlayerCharacters=A_air_pistol_frozen
BotCharacters=target x.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=A_air_pistol_frozen
AddedBots=target x.bot;target x.bot;target x.bot;target x.bot;target x.bot;target x.bot
PlayerMaxLives=0
...
DifficultyTag=4
AuthorsTag=Ku, gli, pasu
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=1 wall 6 targets extra small but the targets are half size.
GameVersion=2.0.0.2
