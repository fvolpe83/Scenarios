...
GameTag=Quake 3, QuakeLive
WeaponHeroTag=LG, Lightning Gun, Rocket Launcher, RL
DifficultyTag=3
AuthorsTag=KovaaK
...
BlockFCT=false
Description=1on1 combat with a Quake style bot.  Invulnerable player, but taking damage reduces your end score.
GameVersion=1.0.5
