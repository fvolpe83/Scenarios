Name=R6S_MovingTarget_v0-0-2
PlayerCharacters=PUBG memer
BotCharacters=Counter-Striker Bot_kaizou.bot;Counter-Striker Bot_kaizou2.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=PUBG memer
AddedBots=Counter-Striker Bot_kaizou.bot;Counter-Striker Bot_kaizou.bot;Counter-Striker Bot_kaizou.bot;Counter-Striker Bot_kaizou2.bot
PlayerMaxLives=0
BotMaxLives=0;0;0;0
PlayerTeam=1
BotTeams=2;2;2;2
