...
BlockFCT=false
Description=Got your elo stolen? Hardstuck in pleb ranks? Need to be able to target switch? Well fear not becaues DevTargetSwitch 1shot has you covered! Steal elo like never before! Call 1-800-ELO-BACK to RSVP your chance to steal Vlad's elo!  *(DTS1s is not responsible for loss of elo, rank, time, or sanity during play sessions)*
GameVersion=1.0.8.0
