Name=Moving Tracking - Stationary - 02
...
BlockFCT=true
Description=Move sidewise while shooting the stationary target. Keep switching directions, once the bar next to your crosshair is full to get more points. Also go for headshots to drastically increase your overall score.
GameVersion=2.0.0.2
