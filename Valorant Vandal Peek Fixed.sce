Name=Valorant Vandal Peek Fixed
...
DifficultyTag=2
AuthorsTag=(edited by T1c Tac), gli, Zaeyron
BlockHitMarkers=true
BlockHitSounds=true
BlockMissSounds=true
BlockFCT=true
Description=Vandal first bullets recoil simulation. Edited to fix height disparity and issues with weapon damage model and rate of fire.
GameVersion=2.0.0.2
