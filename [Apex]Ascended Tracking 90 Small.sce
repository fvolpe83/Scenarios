Name=[Apex]Ascended Tracking 90 Small
PlayerCharacters=Apex
BotCharacters=Apex Long Strafer.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Apex
AddedBots=Apex Long Strafer.bot;Apex Long Strafer.bot
PlayerMaxLives=0
BotMaxLives=0;0
PlayerTeam=1
BotTeams=2;2
...
UseWeapons=true
CharacterProfile=Apex Long Strafer
...
Name=Apex
MaxHealth=200.0
WeaponProfileNames=R99;wingman;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=1.0
StepUpHeight=75.0
