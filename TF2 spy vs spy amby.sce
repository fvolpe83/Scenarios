Name=TF2 spy vs spy amby
PlayerCharacters=Spy
BotCharacters=Weeb.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Spy
AddedBots=Weeb.bot
...
GameTag=TF2, amby duel
WeaponHeroTag=Spy
DifficultyTag=3
AuthorsTag=potassium power
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=practice amby head shots. Changing the map is welcome
GameVersion=2.0.0.2
...
[Bot Profile]
Name=Weeb
DodgeProfileNames=Mimic;Long Strafes Jumping
...
ShowLaser=true
LaserRGB=X=0.847 Y=0.012 Z=0.018
LaserAlpha=1.0
...
TeamHeadColor=X=0.000 Y=0.361 Z=0.807
...
DamageFalloffStopDistance=45.0
