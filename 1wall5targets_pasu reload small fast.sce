Name=1wall5targets_pasu reload small fast
...
DifficultyTag=2
AuthorsTag=Fuglaa, Pasutazame, Ghokury
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=1w5p small targets, but accuracy doesn't affect scoring; instead, you have limited ammo that reloads on kill. Full time scale.
GameVersion=1.0.8.0
