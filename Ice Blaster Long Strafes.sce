Name=Ice Blaster Long Strafes
PlayerCharacters=Climatologist
BotCharacters=Watcher Bot Long Strafes.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Climatologist
...
WeaponHeroTag=Climatologist, Mei, Projectile
DifficultyTag=2
AuthorsTag=Kovaak, sirsleepy
BlockHitMarkers=false
BlockHitSounds=false
BlockMissSounds=true
BlockFCT=false
Description=Deliver icy death against an easy to hit target.
GameVersion=1.0.7.2
...
Name=Climatologist
MaxHealth=250.0
WeaponProfileNames=EndoBlaster;;;;;;;
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=35.0
