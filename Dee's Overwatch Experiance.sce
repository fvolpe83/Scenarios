Name=Dee's Overwatch Experiance
PlayerCharacters=Ultimater
BotCharacters=Ball.bot;Dodgey.bot;Pigeon Jumper.bot;Pigeon Jumper.bot
IsChallenge=true
Timelimit=60.0
PlayerProfile=Ultimater
AddedBots=Ball.bot;Dodgey.bot;Pigeon Jumper.bot;Pigeon Jumper.bot
PlayerMaxLives=0
BotMaxLives=0;0;0;0
PlayerTeam=2
BotTeams=1;0;0;0
...
GameTag=Tracking, Flicking, Overwatch
WeaponHeroTag=LG,Pistol, Six Shooter, Bow, Rocket, Rifle, Sniper
DifficultyTag=3
AuthorsTag=Dee
...
BlockFCT=false
Description=Track the jumping targets with the weapons at hand, make them pay for what they've done.
GameVersion=1.0.6.2
...
UseWeapons=false
CharacterProfile=Sphere Frenzy
...
Name=Ultimater
MaxHealth=100.0
WeaponProfileNames=LG;pistol;Six Shooter;Bow & Arrow;Rocket Launcher no Knockback;Sniper Rifle;Rifle;Creenorecoil
MinRespawnDelay=1.0
MaxRespawnDelay=5.0
StepUpHeight=75.0
